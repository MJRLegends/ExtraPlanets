...
public class RenderTier10Rocket extends Render<EntityTier10Rocket> {
	...
	private void updateModel() {
		if (this.rocketModel == null) {
			...
			this.rocketModel = (ItemModelRocketT10) FMLClientHandler.instance().getClient().getRenderItem().getItemModelMesher().getModelManager().getModel(modelResourceLocation);
		}
	}
