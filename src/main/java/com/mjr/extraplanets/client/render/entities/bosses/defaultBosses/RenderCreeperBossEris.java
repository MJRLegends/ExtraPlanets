...
public class RenderCreeperBossEris extends RenderLiving
{
	...
	public RenderCreeperBossEris()
	{
		super(new ModelCreeperBossEris(), 1.0F);
	}
	...
	protected int func_27006_a(EntityCreeperBossEris par1EntityCreeper, int par2, float par3)
	{
		if (par1EntityCreeper.headsRemaining == 1)
		{
			if (par2 == 1)
			{
				...
				this.bindTexture(RenderCreeperBossEris.powerTexture);
	...
	{
		return this.func_27006_a((EntityCreeperBossEris) par1EntityLivingBase, par2, par3);
	}
