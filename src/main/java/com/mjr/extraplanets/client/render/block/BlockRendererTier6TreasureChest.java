...
public class BlockRendererTier6TreasureChest implements ISimpleBlockRenderingHandler
{
	final int renderID;

	public BlockRendererTier6TreasureChest(int var1)
	{
		this.renderID = var1;
	}
	...
	private final TileEntityT6TreasureChest chest = new TileEntityT6TreasureChest();
