...
public class BlockRendererTier4TreasureChest implements ISimpleBlockRenderingHandler {
	final int renderID;

	public BlockRendererTier4TreasureChest(int var1) {
		this.renderID = var1;
	}
	...
	private final TileEntityT4TreasureChest chest = new TileEntityT4TreasureChest();

	public void renderChest(Block par1Block, int par2, float par3) {
		if (par1Block == ExtraPlanets_Blocks.treasureChestTier4) {
