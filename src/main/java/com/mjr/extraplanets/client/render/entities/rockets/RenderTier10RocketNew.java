...
public class RenderTier10RocketNew extends Render<EntityTier10Rocket> {
	...
	private void updateModel() {
		if (this.rocketModel == null) {
			this.rocketModel = (ItemModelRocketT10New) ModelUtilities.getModelFromRegistry(Constants.TEXTURE_PREFIX, "rocket_t10_new");
		}
	}

	@Override
	protected ResourceLocation getEntityTexture(EntityTier10Rocket entity) {
	...
	@Override
	public boolean shouldRender(EntityTier10Rocket rocket, ICamera camera, double camX, double camY, double camZ) {
