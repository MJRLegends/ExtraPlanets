...
import com.mjr.extraplanets.client.model.monsters.ModelEvolvedBlaze;
...
public class RenderEvolvedBlaze extends RenderLiving {
	...
	public RenderEvolvedBlaze() {
		super(new ModelEvolvedBlaze(), 0.5F);
	 ...
	 */
	public void doRender(EntityEvolvedBlaze p_76986_1_, double p_76986_2_, double p_76986_4_, double p_76986_6_, float p_76986_8_, float p_76986_9_) {
	 ...
	 */
	protected ResourceLocation getEntityTexture(EntityEvolvedBlaze p_110775_1_) {
	...
	public void doRender(EntityLiving p_76986_1_, double p_76986_2_, double p_76986_4_, double p_76986_6_, float p_76986_8_, float p_76986_9_) {
		this.doRender((EntityEvolvedBlaze) p_76986_1_, p_76986_2_, p_76986_4_, p_76986_6_, p_76986_8_, p_76986_9_);
	}
	...
	protected ResourceLocation getEntityTexture(Entity p_110775_1_) {
		return this.getEntityTexture((EntityEvolvedBlaze) p_110775_1_);
	}
