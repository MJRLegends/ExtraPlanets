...
public class TileEntityT4TreasureChestRenderer extends TileEntitySpecialRenderer
{
	...
	private static final ResourceLocation treasureLargeChestTexture = new ResourceLocation(Constants.ASSET_PREFIX, "textures/model/treasureT4large.png");
	...
	public void renderGCTileEntityTreasureChestAt(TileEntityT4TreasureChest par1GCTileEntityTreasureChest, double par2, double par4, double par6, float par8)
	{
		...
		else
		{
			...
			{
				((T4TreasureChest) var10).unifyAdjacentChests(par1GCTileEntityTreasureChest.getWorldObj(), par1GCTileEntityTreasureChest.xCoord, par1GCTileEntityTreasureChest.yCoord, par1GCTileEntityTreasureChest.zCoord);
				var9 = par1GCTileEntityTreasureChest.getBlockMetadata();
			}
		...
		if (par1GCTileEntityTreasureChest.adjacentChestZNeg == null && par1GCTileEntityTreasureChest.adjacentChestXNeg == null)
		{
			...
			if (par1GCTileEntityTreasureChest.adjacentChestXPos == null && par1GCTileEntityTreasureChest.adjacentChestZPos == null)
			{
				...
				this.bindTexture(TileEntityT4TreasureChestRenderer.treasureChestTexture);
			}
			else
			{
				var14b = this.largeChestModel;
				this.bindTexture(TileEntityT4TreasureChestRenderer.treasureLargeChestTexture);
			}
	...
	{
		this.renderGCTileEntityTreasureChestAt((TileEntityT4TreasureChest) par1TileEntity, par2, par4, par6, par8);
	}
}