...
import com.mjr.extraplanets.client.model.ModelEvolvedWitch;
...
public class RenderEvolvedWitch extends RenderLiving
{
	...
	{
		super(new ModelEvolvedWitch(0.0F), 0.5F);
	 ...
	 */
	protected ResourceLocation getEntityTexture(EntityEvolvedWitch p_110775_1_)
	{
	 ...
	 */
	protected void preRenderCallback(EntityEvolvedWitch p_77041_1_, float p_77041_2_)
	{
		float f1 = 0.9375F;
		GL11.glScalef(f1, f1, f1);
	}
	...
	{
		this.preRenderCallback((EntityEvolvedWitch)p_77041_1_, p_77041_2_);
	}
	...
	{
		return this.getEntityTexture((EntityEvolvedWitch)p_110775_1_);
	}
