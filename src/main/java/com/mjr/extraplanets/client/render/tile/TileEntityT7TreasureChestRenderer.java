...
public class TileEntityT7TreasureChestRenderer extends TileEntitySpecialRenderer<TileEntityT7TreasureChest>
{
    private static final ResourceLocation treasureChestTexture = new ResourceLocation(GalacticraftCore.ASSET_PREFIX, "textures/model/treasureT7.png");
     ...
     */
    @Override
    public void renderTileEntityAt(TileEntityT7TreasureChest chest, double par2, double par4, double par6, float partialTickTime, int par9)
    {
        int var9;
