...
public class TileEntityT7TreasureChestRenderer extends TileEntitySpecialRenderer {
	...
	public void renderGCTileEntityTreasureChestAt(TileEntityT7TreasureChest par1GCTileEntityTreasureChest, double par2, double par4, double par6, float par8) {
		...
		if (!par1GCTileEntityTreasureChest.hasWorldObj()) {
			...
			if (var10 != null && var9 == 0) {
				((T7TreasureChest) var10).unifyAdjacentChests(par1GCTileEntityTreasureChest.getWorldObj(), par1GCTileEntityTreasureChest.xCoord, par1GCTileEntityTreasureChest.yCoord, par1GCTileEntityTreasureChest.zCoord);
				var9 = par1GCTileEntityTreasureChest.getBlockMetadata();
			}
		...
		if (par1GCTileEntityTreasureChest.adjacentChestZNeg == null && par1GCTileEntityTreasureChest.adjacentChestXNeg == null) {
			...
			if (par1GCTileEntityTreasureChest.adjacentChestXPos == null && par1GCTileEntityTreasureChest.adjacentChestZPos == null) {
				...
				this.bindTexture(TileEntityT7TreasureChestRenderer.treasureChestTexture);
			} else {
				var14b = this.largeChestModel;
				this.bindTexture(TileEntityT7TreasureChestRenderer.treasureLargeChestTexture);
			}
	...
	public void renderTileEntityAt(TileEntity par1TileEntity, double par2, double par4, double par6, float par8) {
		this.renderGCTileEntityTreasureChestAt((TileEntityT7TreasureChest) par1TileEntity, par2, par4, par6, par8);
	}
}