...
public class RenderCreeperBossSaturn extends RenderLiving
{
	...
	public RenderCreeperBossSaturn()
	{
		super(new ModelCreeperBossSaturn(), 1.0F);
	}
	...
	protected int func_27006_a(EntityCreeperBossSaturn par1EntityCreeper, int par2, float par3)
	{
		if (par1EntityCreeper.headsRemaining == 1)
		{
			if (par2 == 1)
			{
				...
				this.bindTexture(RenderCreeperBossSaturn.powerTexture);
	...
	{
		return this.func_27006_a((EntityCreeperBossSaturn) par1EntityLivingBase, par2, par3);
	}
