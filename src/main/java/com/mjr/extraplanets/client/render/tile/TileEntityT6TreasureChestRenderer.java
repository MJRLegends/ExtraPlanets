...
public class TileEntityT6TreasureChestRenderer extends TileEntitySpecialRenderer
{
	...
	private static final ResourceLocation treasureLargeChestTexture = new ResourceLocation(Constants.ASSET_PREFIX, "textures/model/treasureT6large.png");
	...
	public void renderGCTileEntityTreasureChestAt(TileEntityT6TreasureChest par1GCTileEntityTreasureChest, double par2, double par4, double par6, float par8)
	{
		...
		else
		{
			...
			{
				((T6TreasureChest) var10).unifyAdjacentChests(par1GCTileEntityTreasureChest.getWorldObj(), par1GCTileEntityTreasureChest.xCoord, par1GCTileEntityTreasureChest.yCoord, par1GCTileEntityTreasureChest.zCoord);
				var9 = par1GCTileEntityTreasureChest.getBlockMetadata();
			}
		...
		if (par1GCTileEntityTreasureChest.adjacentChestZNeg == null && par1GCTileEntityTreasureChest.adjacentChestXNeg == null)
		{
			...
			if (par1GCTileEntityTreasureChest.adjacentChestXPos == null && par1GCTileEntityTreasureChest.adjacentChestZPos == null)
			{
				...
				this.bindTexture(TileEntityT6TreasureChestRenderer.treasureChestTexture);
			}
			else
			{
				var14b = this.largeChestModel;
				this.bindTexture(TileEntityT6TreasureChestRenderer.treasureLargeChestTexture);
			}
	...
	{
		this.renderGCTileEntityTreasureChestAt((TileEntityT6TreasureChest) par1TileEntity, par2, par4, par6, par8);
	}
}