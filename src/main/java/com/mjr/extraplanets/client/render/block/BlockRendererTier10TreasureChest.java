...
public class BlockRendererTier10TreasureChest implements ISimpleBlockRenderingHandler {
	final int renderID;

	public BlockRendererTier10TreasureChest(int var1) {
		this.renderID = var1;
	}
	...
	private final TileEntityT10TreasureChest chest = new TileEntityT10TreasureChest();

	public void renderChest(Block par1Block, int par2, float par3) {
		if (par1Block == ExtraPlanets_Blocks.treasureChestTier10) {
