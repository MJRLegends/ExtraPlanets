...
public class RenderTier7Rocket extends Render<EntityTier7Rocket> {
	...
	private void updateModel() {
		if (this.rocketModel == null) {
			...
			this.rocketModel = (ItemModelRocketT7) FMLClientHandler.instance().getClient().getRenderItem().getItemModelMesher().getModelManager().getModel(modelResourceLocation);
		}
	}
