...
public class RenderTier9RocketNew extends Render<EntityTier9Rocket> {
	...
	private void updateModel() {
		if (this.rocketModel == null) {
			this.rocketModel = (ItemModelRocketT9New) ModelUtilities.getModelFromRegistry(Constants.TEXTURE_PREFIX, "rocket_t9_new");
		}
	}

	@Override
	protected ResourceLocation getEntityTexture(EntityTier9Rocket entity) {
	...
	@Override
	public boolean shouldRender(EntityTier9Rocket rocket, ICamera camera, double camX, double camY, double camZ) {
