...
import com.mjr.extraplanets.client.model.bosses.defaultBosses.ModelCreeperBossVenus;
import com.mjr.extraplanets.entities.bosses.defaultBosses.EntityCreeperBossVenus;

public class RenderCreeperBossVenus extends RenderLiving {
	...
	public RenderCreeperBossVenus() {
		super(new ModelCreeperBossVenus(), 1.0F);
	}
	...
	protected int func_27006_a(EntityCreeperBossVenus par1EntityCreeper, int par2, float par3) {
		if (par1EntityCreeper.headsRemaining == 1) {
			if (par2 == 1) {
				final float var4 = par1EntityCreeper.ticksExisted + par3;
				this.bindTexture(RenderCreeperBossVenus.powerTexture);
	...
	protected int shouldRenderPass(EntityLivingBase par1EntityLivingBase, int par2, float par3) {
		return this.func_27006_a((EntityCreeperBossVenus) par1EntityLivingBase, par2, par3);
	}
