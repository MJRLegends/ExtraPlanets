...
import com.mjr.extraplanets.client.model.monsters.ModelEvolvedMiniEnderman;
...
public class RenderEvolvedMiniEnderman extends RenderLiving {
	...
	private ModelEvolvedMiniEnderman endermanModel;
	private Random rnd = new Random();

	public RenderEvolvedMiniEnderman() {
		super(new ModelEvolvedMiniEnderman(), 0.5F);
		this.endermanModel = (ModelEvolvedMiniEnderman) super.mainModel;
	 ...
	 */
	public void doRender(EntityEvolvedMiniEnderman p_76986_1_, double p_76986_2_, double p_76986_4_, double p_76986_6_, float p_76986_8_, float p_76986_9_) {
	 ...
	 */
	protected ResourceLocation getEntityTexture(EntityEvolvedMiniEnderman p_110775_1_) {
		return endermanTextures;
	}

	protected void renderEquippedItems(EntityEvolvedMiniEnderman p_77029_1_, float p_77029_2_) {
	 ...
	 */
	protected int shouldRenderPass(EntityEvolvedMiniEnderman p_77032_1_, int p_77032_2_, float p_77032_3_) {
		if (p_77032_2_ != 0) {
			return -1;
		} else {
	...
	public void doRender(EntityLiving p_76986_1_, double p_76986_2_, double p_76986_4_, double p_76986_6_, float p_76986_8_, float p_76986_9_) {
		this.doRender((EntityEvolvedMiniEnderman) p_76986_1_, p_76986_2_, p_76986_4_, p_76986_6_, p_76986_8_, p_76986_9_);
	}
	...
	protected int shouldRenderPass(EntityLivingBase p_77032_1_, int p_77032_2_, float p_77032_3_) {
		return this.shouldRenderPass((EntityEvolvedMiniEnderman) p_77032_1_, p_77032_2_, p_77032_3_);
	}

	@Override
	protected void renderEquippedItems(EntityLivingBase p_77029_1_, float p_77029_2_) {
		this.renderEquippedItems((EntityEvolvedMiniEnderman) p_77029_1_, p_77029_2_);
	}
	...
	protected ResourceLocation getEntityTexture(Entity p_110775_1_) {
		return this.getEntityTexture((EntityEvolvedMiniEnderman) p_110775_1_);
	}
