...
import com.mjr.extraplanets.client.model.monsters.ModelEvolvedGiantSpider;
...
public class RenderEvolvedGiantSpider extends RenderLiving {
	...
	public RenderEvolvedGiantSpider() {
		super(new ModelEvolvedGiantSpider(), 1.0F);
		this.setRenderPassModel(new ModelEvolvedGiantSpider());
	}

	protected ResourceLocation func_110779_a(EntitySpider par1EntityArrow) {
		return RenderEvolvedGiantSpider.spiderTexture;
	}
	...
	protected int shouldRenderPass(EntityLivingBase par1EntityLiving, int par2, float par3) {
		...
		if (helmetSlot != null && helmetSlot.getItem() instanceof ItemSensorGlasses && minecraft.currentScreen == null) {
			if (par2 == 1) {
				...
				this.bindTexture(RenderEvolvedGiantSpider.powerTexture);
