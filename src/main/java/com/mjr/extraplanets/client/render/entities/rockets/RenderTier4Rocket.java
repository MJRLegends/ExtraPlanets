...
public class RenderTier4Rocket extends Render<EntityTier4Rocket> {
	...
	private void updateModel() {
		if (this.rocketModel == null) {
			...
			this.rocketModel = (ItemModelRocketT4) FMLClientHandler.instance().getClient().getRenderItem().getItemModelMesher().getModelManager().getModel(modelResourceLocation);
		}
	}
