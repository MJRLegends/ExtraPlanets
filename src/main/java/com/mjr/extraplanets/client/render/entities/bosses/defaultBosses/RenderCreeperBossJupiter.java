...
public class RenderCreeperBossJupiter extends RenderLiving<EntityCreeperBossJupiter> {
	...
	@Override
	public void doRender(EntityCreeperBossJupiter par1EntityLiving, double x, double y, double z, float entityYaw, float partialTicks) {
		super.doRender(par1EntityLiving, x, y, z, entityYaw, partialTicks);
	}

	@Override
	protected void preRenderCallback(EntityCreeperBossJupiter par1EntityLiving, float partialTickTime) {
	...
	@Override
	protected int getColorMultiplier(EntityCreeperBossJupiter par1EntityLivingBase, float lightBrightness, float partialTickTime) {
