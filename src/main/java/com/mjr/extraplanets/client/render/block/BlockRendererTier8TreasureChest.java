...
public class BlockRendererTier8TreasureChest implements ISimpleBlockRenderingHandler
{
	final int renderID;

	public BlockRendererTier8TreasureChest(int var1)
	{
		this.renderID = var1;
	}
	...
	private final TileEntityT8TreasureChest chest = new TileEntityT8TreasureChest();

	public void renderChest(Block par1Block, int par2, float par3)
	{
		if (par1Block == ExtraPlanets_Blocks.treasureChestTier8)
		{
