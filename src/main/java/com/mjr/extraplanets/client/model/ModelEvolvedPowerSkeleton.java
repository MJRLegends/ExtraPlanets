...
public class ModelEvolvedPowerSkeleton extends ModelZombie
{
	...
	public ModelEvolvedPowerSkeleton(float p_i1156_1_)
	{
	...
	{
		this.aimedBow = ((EntityEvolvedPowerSkeleton)p_78086_1_).getSkeletonType() == 1;
