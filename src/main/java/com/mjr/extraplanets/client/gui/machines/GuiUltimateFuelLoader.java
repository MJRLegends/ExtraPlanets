...
public class GuiUltimateFuelLoader extends GuiContainerGC {
	...
	private final TileEntityUltimateFuelLoader tileEntity;
	...
	public GuiUltimateFuelLoader(InventoryPlayer inventoryPlayer, TileEntityUltimateFuelLoader tileEntity) {
		super(new ContainerUltimateFuelLoader(inventoryPlayer, tileEntity));
	...
	protected void drawGuiContainerForegroundLayer(int mouseX, int mouseY) {
		this.fontRendererObj.drawString(this.tileEntity.getName(), 40, 10, 4210752);
