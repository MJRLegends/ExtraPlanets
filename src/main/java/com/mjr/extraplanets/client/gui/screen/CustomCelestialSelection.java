			...
			if (this.viewState != EnumView.PROFILE) {
				...
				if (this.selectedBody != null) {
					...
					for (int barY = 0; barY < 25; ++barY) {
						this.drawTexturedModalRect(xOffset, yOffset + barY * this.fontRendererObj.FONT_HEIGHT + 4, 93 + widthSizeOffset, this.fontRendererObj.FONT_HEIGHT + 10, 159, 106, 93, this.fontRendererObj.FONT_HEIGHT, false, false);
					}
					for (int barx = 0; barx < 1; ++barx) {
						this.drawTexturedModalRect(xOffset + barx, yOffset * this.fontRendererObj.FONT_HEIGHT + 20, 93 + widthSizeOffset, this.fontRendererObj.FONT_HEIGHT / 2, 159, 106, 1, this.fontRendererObj.FONT_HEIGHT, false, false);
					}
					if (!(this.selectedBody instanceof Star)) {
						...
						if (temp instanceof WorldProviderSpace) {
							...
							this.drawString(this.fontRendererObj, TranslateUtilities.translate("gui.celestial_body_gravity.name") + ": " + (this.selectedBody.getReachable() ? gravity : TranslateUtilities.translate("gui.type_unknown.name")),
							...
							this.drawString(this.fontRendererObj, TranslateUtilities.translate("gui.celestial_body_wind_level.name") + ": "
							...
							this.drawString(this.fontRendererObj, TranslateUtilities.translate("gui.celestial_body_corrosive_atmosphere.name") + ": "
