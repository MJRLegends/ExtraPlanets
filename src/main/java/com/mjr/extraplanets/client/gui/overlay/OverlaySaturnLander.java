...
public class OverlaySaturnLander extends Overlay {
	...
	public static void renderLanderOverlay() {
		...
		if (OverlaySaturnLander.minecraft.player.getRidingEntity().motionY < -2.0) {
			OverlaySaturnLander.minecraft.fontRenderer.drawString(TranslateUtilities.translate("gui.warning"), width / 4 - OverlaySaturnLander.minecraft.fontRenderer.getStringWidth(TranslateUtilities.translate("gui.warning")) / 2, height / 8 - 20,
