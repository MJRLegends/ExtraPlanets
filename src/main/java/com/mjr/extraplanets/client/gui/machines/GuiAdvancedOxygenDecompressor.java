...
public class GuiAdvancedOxygenDecompressor extends GuiContainerGC {
	...
	public GuiAdvancedOxygenDecompressor(InventoryPlayer inventoryPlayer, TileEntityAdvancedOxygenDecompressor tileEntity) {
		super(new ContainerAdvancedOxygenDecompressor(inventoryPlayer, tileEntity, MCUtilities.getClient().player));
