...
public class GuiAdvancedOxygenDecompressor extends GuiContainerGC {
	...
	public GuiAdvancedOxygenDecompressor(InventoryPlayer par1InventoryPlayer, TileEntityAdvancedOxygenDecompressor par2TileEntityAirDistributor) {
		super(new ContainerAdvancedOxygenDecompressor(par1InventoryPlayer, par2TileEntityAirDistributor));
	...
	protected void drawGuiContainerForegroundLayer(int par1, int par2) {
		...
		status = GCCoreUtil.translate("gui.maxOutput.desc") + ": " + TileEntityAdvancedOxygenDecompressor.OUTPUT_PER_TICK * 20 + GCCoreUtil.translate("gui.perSecond");
