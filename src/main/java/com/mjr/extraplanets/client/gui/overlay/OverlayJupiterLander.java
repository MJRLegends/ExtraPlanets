...
public class OverlayJupiterLander extends Overlay {
	...
	public static void renderLanderOverlay() {
		...
		if (OverlayJupiterLander.minecraft.thePlayer.ridingEntity.motionY != 0.0D) {
			String string = TranslateUtilities.translate("gui.lander.velocity") + ": " + Math.round(((EntityJupiterLander) OverlayJupiterLander.minecraft.thePlayer.ridingEntity).motionY * 1000) / 100.0D + " "
