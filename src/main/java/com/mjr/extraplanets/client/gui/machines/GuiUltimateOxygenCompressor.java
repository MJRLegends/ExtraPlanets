...
public class GuiUltimateOxygenCompressor extends GuiContainerGC {
	...
	public GuiUltimateOxygenCompressor(InventoryPlayer par1InventoryPlayer, TileEntityUltimateOxygenCompressor par2TileEntityAirDistributor) {
		super(new ContainerUltimateOxygenCompressor(par1InventoryPlayer, par2TileEntityAirDistributor));
	...
	protected void drawGuiContainerForegroundLayer(int par1, int par2) {
		...
		status = GCCoreUtil.translate("gui.oxygenUse.desc") + ": " + TileEntityUltimateOxygenCompressor.TANK_TRANSFER_SPEED * 20 + GCCoreUtil.translate("gui.perSecond");
