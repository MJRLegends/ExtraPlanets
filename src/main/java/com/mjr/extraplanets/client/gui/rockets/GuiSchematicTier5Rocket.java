...
public class GuiSchematicTier5Rocket extends GuiPositionedContainer implements ISchematicResultPage {
	...
	public GuiSchematicTier5Rocket(InventoryPlayer par1InventoryPlayer, BlockPos pos) {
		super(new ContainerSchematicTier5Rocket(par1InventoryPlayer, pos), pos);
		this.ySize = 238;
	}
	...
	protected void drawGuiContainerForegroundLayer(int par1, int par2) {
		this.fontRendererObj.drawString(TranslateUtilities.translate("schematic.rocket.t5.name"), 7, -20 + 27, 4210752);
