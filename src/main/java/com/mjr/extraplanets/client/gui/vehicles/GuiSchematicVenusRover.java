...
public class GuiSchematicVenusRover extends GuiContainerGC implements ISchematicResultPage {
	...
	protected void drawGuiContainerForegroundLayer(int par1, int par2) {
		this.fontRenderer.drawString(TranslateUtilities.translate("schematic.venus.rover.name"), 7, -20 + 27, 4210752);
		this.fontRenderer.drawString(TranslateUtilities.translate("container.inventory"), 8, 202 - 104 + 2 + 27, 4210752);
	}
