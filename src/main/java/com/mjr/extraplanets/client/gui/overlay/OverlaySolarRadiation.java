...
public class OverlaySolarRadiation extends Overlay {
	...
	public static void renderSolarRadiationIndicator(int radiationLevel, boolean right, boolean top) {
		...
		OverlaySolarRadiation.minecraft.fontRenderer.drawString(value, minLeftX + addX - OverlaySolarRadiation.minecraft.fontRenderer.getStringWidth(value),
				(int) bottomY - radiationLevelScaled - OverlaySolarRadiation.minecraft.fontRenderer.FONT_HEIGHT / 2 + addY, ColorUtil.to32BitColor(255, 255, 10, 10));
