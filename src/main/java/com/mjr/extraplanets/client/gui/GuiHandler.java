...
public class GuiHandler implements IGuiHandler {
	...
	public Object getServerGuiElement(int ID, EntityPlayer player, World world, int x, int y, int z) {
		...
		if (tile != null) {
			...
			// return new ContainerAdvancedRefinery(player.inventory,
			// (TileEntityAdvancedRefinery) tile);
			// } else if (tile instanceof TileEntitySolar) {
			// return new ContainerSolar(player.inventory, (TileEntitySolar)
			// tile);
			// }
		}
		return null;
	...
	private Object getClientGuiElement(int ID, EntityPlayer player, World world, BlockPos position) {
		...
		// if (tile != null) {
		// if (tile instanceof TileEntityAdvancedRefinery) {
		// return new GuiAdvancedRefinery(player.inventory,
		// (TileEntityAdvancedRefinery) world.getTileEntity(position));
		// } else if (tile instanceof TileEntitySolar) {
