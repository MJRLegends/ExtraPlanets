...
public class GuiSchematicTier10ElectricRocket extends GuiPositionedContainer implements ISchematicResultPage {
	...
	protected void drawGuiContainerForegroundLayer(int par1, int par2) {
		this.fontRendererObj.drawString(TranslateUtilities.translate("schematic.rocket.electric.t10.name"), 7, -20 + 27, 4210752);
	...
	protected void drawGuiContainerBackgroundLayer(float par1, int par2, int par3) {
		...
		this.mc.renderEngine.bindTexture(GuiSchematicTier10ElectricRocket.rocketBenchTexture);
