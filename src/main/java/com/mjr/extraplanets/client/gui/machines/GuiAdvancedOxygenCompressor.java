...
public class GuiAdvancedOxygenCompressor extends GuiContainerGC {
	...
	public GuiAdvancedOxygenCompressor(InventoryPlayer inventoryPlayer, TileEntityAdvancedOxygenCompressor par2TileEntityAirDistributor) {
		super(new ContainerAdvancedOxygenCompressor(inventoryPlayer, par2TileEntityAirDistributor, MCUtilities.getClient().player));
	...
	public void initGui() {
		...
		oxygenDesc.add(EnumColor.YELLOW + TranslateUtilities.translate("gui.oxygen_storage.desc.1") + ": " + ((int) Math.floor(this.compressor.getOxygenStored()) + " / " + (int) Math.floor(this.compressor.getMaxOxygenStored())));
		...
		electricityDesc.add(EnumColor.YELLOW + TranslateUtilities.translate("gui.energy_storage.desc.1") + ((int) Math.floor(this.compressor.getEnergyStoredGC()) + " / " + (int) Math.floor(this.compressor.getMaxEnergyStoredGC())));
	...
	protected void drawGuiContainerForegroundLayer(int par1, int par2) {
		...
		status = TranslateUtilities.translate("gui.oxygen_use.desc") + ": " + TileEntityAdvancedOxygenCompressor.TANK_TRANSFER_SPEED * 20 + TranslateUtilities.translate("gui.per_second");
