...
public class GuiAdvancedOxygenCompressor extends GuiContainerGC {
	...
	public GuiAdvancedOxygenCompressor(InventoryPlayer par1InventoryPlayer, TileEntityAdvancedOxygenCompressor par2TileEntityAirDistributor) {
		super(new ContainerAdvancedOxygenCompressor(par1InventoryPlayer, par2TileEntityAirDistributor));
	...
	protected void drawGuiContainerForegroundLayer(int par1, int par2) {
		...
		status = GCCoreUtil.translate("gui.oxygenUse.desc") + ": " + TileEntityAdvancedOxygenCompressor.TANK_TRANSFER_SPEED * 20 + GCCoreUtil.translate("gui.perSecond");
