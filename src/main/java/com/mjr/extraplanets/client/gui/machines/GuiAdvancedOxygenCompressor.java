...
public class GuiAdvancedOxygenCompressor extends GuiContainerGC {
	...
	private final TileEntityAdvancedOxygenCompressor tileEntity;
	...
	public GuiAdvancedOxygenCompressor(InventoryPlayer inventoryPlayer, TileEntityAdvancedOxygenCompressor tileEntity) {
		super(new ContainerAdvancedOxygenCompressor(inventoryPlayer, tileEntity, MCUtilities.getClient().player));
