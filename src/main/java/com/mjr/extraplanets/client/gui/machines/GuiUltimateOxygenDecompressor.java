...
public class GuiUltimateOxygenDecompressor extends GuiContainerGC {
	...
	public GuiUltimateOxygenDecompressor(InventoryPlayer par1InventoryPlayer, TileEntityUltimateOxygenDecompressor par2TileEntityAirDistributor) {
		super(new ContainerUltimateOxygenDecompressor(par1InventoryPlayer, par2TileEntityAirDistributor));
	...
	protected void drawGuiContainerForegroundLayer(int par1, int par2) {
		...
		status = GCCoreUtil.translate("gui.maxOutput.desc") + ": " + TileEntityUltimateOxygenDecompressor.OUTPUT_PER_TICK * 20 + GCCoreUtil.translate("gui.perSecond");
