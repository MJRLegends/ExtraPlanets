...
public class GuiSolar extends GuiContainerGC {
	...
	protected void actionPerformed(GuiButton par1GuiButton) {
		...
		case 0:
			GalacticraftCore.packetPipeline.sendToServer(new PacketSimple(EnumSimplePacket.S_UPDATE_DISABLEABLE_BUTTON, this.mc.theWorld.provider.getDimensionType().getId(), new Object[] { this.solarPanel.getPos(), 0 }));
			break;
		}
	}
