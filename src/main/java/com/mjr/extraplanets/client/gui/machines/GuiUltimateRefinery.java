...
public class GuiUltimateRefinery extends GuiContainerGC {
	...
	public GuiUltimateRefinery(InventoryPlayer par1InventoryPlayer, TileEntityUltimateRefinery tileEntity) {
		super(new ContainerUltimateRefinery(par1InventoryPlayer, tileEntity, MCUtilities.getClient().thePlayer));
	...
	protected void actionPerformed(GuiButton par1GuiButton) {
		...
		case 0:
			GalacticraftCore.packetPipeline.sendToServer(new PacketSimple(EnumSimplePacket.S_UPDATE_DISABLEABLE_BUTTON, this.mc.theWorld.provider.getDimensionType().getId(), new Object[] { this.tileEntity.getPos(), 0 }));
			break;
		}
	}
	...
	protected void drawGuiContainerForegroundLayer(int par1, int par2) {
		...
		this.fontRendererObj.drawString(TranslateUtilities.translate("gui.message.status.name") + ": ", 60, 45 + 23 + yOffset, 4210752);
