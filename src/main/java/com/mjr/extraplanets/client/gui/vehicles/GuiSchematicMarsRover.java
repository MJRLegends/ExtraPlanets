...
{
    private static final ResourceLocation marsRoverBenchTexture = new ResourceLocation(GalacticraftCore.ASSET_PREFIX, "textures/gui/marsRoverbench.png");

    private int pageIndex;

    public GuiSchematicMarsRover(InventoryPlayer par1InventoryPlayer)
    {
        super(new ContainerSchematicMarsRover(par1InventoryPlayer, 0, 0, 0));
        this.ySize = 221;
    }
    ...
    {
        this.fontRendererObj.drawString(GCCoreUtil.translate("schematic.marsRover.name"), 7, -20 + 27, 4210752);
