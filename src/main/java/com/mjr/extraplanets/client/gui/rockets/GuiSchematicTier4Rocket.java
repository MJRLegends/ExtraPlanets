...
public class GuiSchematicTier4Rocket extends GuiPositionedContainer implements ISchematicResultPage {
	private static final ResourceLocation rocketBenchTexture = new ResourceLocation(Constants.ASSET_PREFIX, "textures/gui/rocketbench_tier4.png");

	private int pageIndex;

	public GuiSchematicTier4Rocket(InventoryPlayer inventoryPlayer, BlockPos pos) {
		super(new ContainerSchematicTier4Rocket(inventoryPlayer, pos), pos);
		this.ySize = 238;
	}
	...
	protected void drawGuiContainerForegroundLayer(int par1, int par2) {
		this.fontRenderer.drawString(TranslateUtilities.translate("schematic.rocket.t4.name"), 7, -20 + 27, 4210752);
