...
public class GuiSchematicTier4Rocket extends GuiContainerGC implements ISchematicResultPage
{
	...
	{
		this.fontRendererObj.drawString(GCCoreUtil.translate("schematic.rocket.t4.name"), 7, -20 + 27, 4210752);
