...
public class GuiSchematicTier4Rocket extends GuiPositionedContainer implements ISchematicResultPage {
	...
	public GuiSchematicTier4Rocket(InventoryPlayer par1InventoryPlayer, BlockPos pos) {
		super(new ContainerSchematicTier4Rocket(par1InventoryPlayer, pos), pos);
		this.ySize = 238;
	}
	...
	protected void drawGuiContainerForegroundLayer(int par1, int par2) {
		this.fontRendererObj.drawString(TranslateUtilities.translate("schematic.rocket.t4.name"), 7, -20 + 27, 4210752);
