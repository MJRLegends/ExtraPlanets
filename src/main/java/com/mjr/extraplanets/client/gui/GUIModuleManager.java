...
public class GUIModuleManager extends GuiContainerGC {
	...
	protected void drawGuiContainerForegroundLayer(int par1, int par2) {
		this.fontRendererObj.drawString(TranslateUtilities.translate("gui.module_manager.name"), xOffset + 8, 5, 4210752);

		this.fontRendererObj.drawString(TranslateUtilities.translate("gui.modules_helmet.name"), xOffset + 8, 20, 4210752);
		int x = 0;
		int y = 0;
		...
		this.fontRendererObj.drawString(TranslateUtilities.translate("gui.modules_chest.name"), xOffset + 8, 50, 4210752);
		x = 0;
		y = 0;
		...
		this.fontRendererObj.drawString(TranslateUtilities.translate("gui.modules_leggings.name"), xOffset + 8, 80, 4210752);
		x = 0;
		y = 0;
		...
		this.fontRendererObj.drawString(TranslateUtilities.translate("gui.modules_boots.name"), xOffset + 8, 110, 4210752);
		x = 0;
		y = 0;
		...
		this.fontRendererObj.drawString(TranslateUtilities.translate("gui.module_list.name"), xOffset + -75, 5, 4210752);
		int moduleNumber = 0;
		x = 0;
		y = 0;
		...
		this.fontRendererObj.drawString(TranslateUtilities.translate("gui.module_cost.name"), xOffset + -110, 5, 4210752);
		y = 0;
		for (ItemStack stack : this.selectedInstallModule.getRequirements()) {
			...
			this.fontRendererObj.drawString("" + stack.stackSize + " x ", xOffset + -115, 22 + y, 4210752);
			y += 18;
		}
	}
