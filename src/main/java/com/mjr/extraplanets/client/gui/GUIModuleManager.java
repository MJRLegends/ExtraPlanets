...
public class GUIModuleManager extends GuiContainerGC {
	...
	protected void drawGuiContainerForegroundLayer(int par1, int par2) {
		this.fontRendererObj.drawString(TranslateUtilities.translate("gui.module_manager.name"), xOffset + 8, 5, ColorUtil.to32BitColor(255, 0, 0, 0));

		this.fontRendererObj.drawString(TranslateUtilities.translate("gui.modules_helmet.name"), xOffset + 8, 20, ColorUtil.to32BitColor(255, 0, 0, 0));
		int x = 0;
		int y = 0;
		...
		this.fontRendererObj.drawString(TranslateUtilities.translate("gui.modules_chest.name"), xOffset + 8, 50, ColorUtil.to32BitColor(255, 0, 0, 0));
		x = 0;
		y = 0;
		...
		this.fontRendererObj.drawString(TranslateUtilities.translate("gui.modules_leggings.name"), xOffset + 8, 80, ColorUtil.to32BitColor(255, 0, 0, 0));
		x = 0;
		y = 0;
		...
		this.fontRendererObj.drawString(TranslateUtilities.translate("gui.modules_boots.name"), xOffset + 8, 110, ColorUtil.to32BitColor(255, 0, 0, 0));
		x = 0;
		y = 0;
		...
		this.fontRendererObj.drawString(TranslateUtilities.translate("gui.module_list.name"), xOffset + -75, 5, ColorUtil.to32BitColor(255, 0, 0, 0));
		int moduleNumber = 0;
		x = 0;
		y = 0;
		...
		this.fontRendererObj.drawString(TranslateUtilities.translate("gui.module_cost.name"), xOffset + -110, 5, ColorUtil.to32BitColor(255, 0, 0, 0));
		this.fontRendererObj.drawString(TranslateUtilities.translate("gui.module.description.name"), 165, 30, ColorUtil.to32BitColor(255, 0, 0, 0));
		this.fontRendererObj.drawString(TranslateUtilities.translate("gui.module.name.name"), 165, 5, ColorUtil.to32BitColor(255, 0, 0, 0));
		y = 0;
		...
		if (this.selectedInstallModule != null) {
			for (ItemStack stack : this.selectedInstallModule.getRequirements()) {
				...
				this.fontRendererObj.drawString("" + stack.stackSize + " x ", xOffset + -115, 22 + y, ColorUtil.to32BitColor(255, 0, 0, 0));
				y += 18;
			}

			this.fontRendererObj.drawString(TranslateUtilities.translate("gui.module." + this.selectedInstallModule.getName() + ".name"), 165, 15, 4210752);
