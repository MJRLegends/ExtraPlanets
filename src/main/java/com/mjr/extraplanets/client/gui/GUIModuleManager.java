...
public class GUIModuleManager extends GuiContainerGC {
	...
	protected void drawGuiContainerForegroundLayer(int par1, int par2) {
		...
		this.fontRendererObj.drawString(TranslateUtilities.translate("gui.module.description.name"), 165, 40, ColorUtil.to32BitColor(255, 0, 0, 0));
		...
		if (this.selectedInstallModule != null) {
			...
			text = TranslateUtilities.translate("gui.module." + this.selectedInstallModule.getDescription());
			int charsPerLine = 20;
