...
public class GuiVehicleChanger extends GuiContainerGC {
	...
	protected void actionPerformed(GuiButton par1GuiButton) {
		...
		case 0:
			GalacticraftCore.packetPipeline.sendToServer(new PacketSimple(EnumSimplePacket.S_UPDATE_DISABLEABLE_BUTTON, new Object[] { this.vehicleChanger.xCoord, this.vehicleChanger.yCoord, this.vehicleChanger.zCoord, 0 }));
			break;
		}
	}
	...
	public void initGui() {
		...
		electricityDesc.add(EnumColor.YELLOW + GCCoreUtil.translate("gui.energyStorage.desc.1") + ((int) Math.floor(this.vehicleChanger.getEnergyStoredGC()) + " / " + (int) Math.floor(this.vehicleChanger.getMaxEnergyStoredGC())));
		...
		this.buttonList.add(this.buttonloadpower = new GuiButton(0, this.width / 2 + 2, this.height / 2 - 49, 76, 20, GCCoreUtil.translate("gui.button.loadpower.name")));
	}
