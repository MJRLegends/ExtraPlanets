...
public class OverlayGeneralLander extends Overlay {
	...
	public static void renderLanderOverlay() {
		...
		if (OverlayGeneralLander.minecraft.player.getRidingEntity().motionY != 0.0D) {
			String string = GCCoreUtil.translate("gui.lander.velocity") + ": " + Math.round(((EntityGeneralLander) OverlayGeneralLander.minecraft.player.getRidingEntity()).motionY * 1000) / 100.0D + " "
