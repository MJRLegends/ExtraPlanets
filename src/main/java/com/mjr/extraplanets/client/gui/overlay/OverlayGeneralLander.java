...
public class OverlayGeneralLander extends Overlay {
	...
	public static void renderLanderOverlay() {
		...
		if (OverlayGeneralLander.minecraft.player.getRidingEntity().motionY < -2.0) {
			OverlayGeneralLander.minecraft.fontRenderer.drawString(GCCoreUtil.translate("gui.warning"), width / 4 - OverlayGeneralLander.minecraft.fontRenderer.getStringWidth(GCCoreUtil.translate("gui.warning")) / 2, height / 8 - 20,
