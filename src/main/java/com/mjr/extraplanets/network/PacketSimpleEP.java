		...
		case C_OPEN_PARACHEST_GUI:
			...
			case 0:
				if (playerBaseClient.getRidingEntity() instanceof EntityVehicleBase) {
					...
					MCUtilities.getClient().displayGuiScreen(new GuiPoweredVehicleBase(playerBaseClient.inventory, (EntityPoweredVehicleBase) playerBaseClient.getRidingEntity(), ((EntityPoweredVehicleBase) playerBaseClient.getRidingEntity()).getType()));
					playerBaseClient.openContainer.windowId = (Integer) this.data.get(0);
				}
				break;
			}
