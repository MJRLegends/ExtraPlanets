...
public class Tier8Rocket extends Item implements IHoldableItem {
	public Tier8Rocket(String name) {
		super();
		this.setMaxDamage(0);
	...
	public boolean onItemUse(ItemStack itemStack, EntityPlayer player, World world, BlockPos pos, EnumFacing side, float hitX, float hitY, float hitZ) {
		...
		if (world.isRemote && player instanceof EntityPlayerSP) {
			...
			if (padFound) {
				...
				final EntityTier8Rocket spaceship = new EntityTier8Rocket(world, centerX, centerY, centerZ, EnumRocketType.values()[itemStack.getItemDamage()]);
	...
	public String getUnlocalizedName(ItemStack itemStack) {
		return super.getUnlocalizedName(itemStack) + ".t8Rocket";
	}
