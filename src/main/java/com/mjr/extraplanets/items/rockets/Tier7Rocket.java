...
public class Tier7Rocket extends Item implements IHoldableItem {
	...
	public boolean onItemUse(ItemStack itemStack, EntityPlayer player, World world, BlockPos pos, EnumFacing side, float hitX, float hitY, float hitZ) {
		...
		if (world.isRemote && player instanceof EntityPlayerSP) {
			...
			if (padFound) {
				...
				final EntityTier7Rocket spaceship = new EntityTier7Rocket(world, centerX, centerY, centerZ, EnumRocketType.values()[itemStack.getItemDamage()]);
	...
	public String getUnlocalizedName(ItemStack itemStack) {
		return super.getUnlocalizedName(itemStack) + ".t7Rocket";
	}
