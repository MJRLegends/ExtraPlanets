...
public class Tier7Rocket extends Item implements IHoldableItem {
	public Tier7Rocket(String assetName) {
		super();
		this.setMaxDamage(0);
	...
	public boolean onItemUse(ItemStack par1ItemStack, EntityPlayer par2EntityPlayer, World par3World, int par4, int par5, int par6, int par7, float par8, float par9, float par10) {
		...
		if (par3World.isRemote) {
			...
			if (padFound) {
				...
				EntityTier7Rocket rocket = new EntityTier7Rocket(par3World, centerX, centerY, centerZ, EnumRocketType.values()[par1ItemStack.getItemDamage()]);
	...
	public String getUnlocalizedName(ItemStack par1ItemStack) {
		return super.getUnlocalizedName(par1ItemStack) + ".t7Rocket";
	}
