...
public class Tier10NoseCone extends Item
{
	...
	public void registerIcons(IIconRegister iconRegister)
	{
		...
		this.icons[0] = iconRegister.registerIcon(Constants.TEXTURE_PREFIX + "tier10NoseCone");
		this.icons[1] = iconRegister.registerIcon(Constants.TEXTURE_PREFIX + "tier10NoseCone.0");
	}
