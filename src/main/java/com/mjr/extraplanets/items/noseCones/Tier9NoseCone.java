...
public class Tier9NoseCone extends Item
{
	...
	public void registerIcons(IIconRegister iconRegister)
	{
		...
		this.icons[0] = iconRegister.registerIcon(Constants.TEXTURE_PREFIX + "tier9NoseCone");
		this.icons[1] = iconRegister.registerIcon(Constants.TEXTURE_PREFIX + "tier9NoseCone.0");
	}
