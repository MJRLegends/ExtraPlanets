	...
	public ItemStack onItemUseFinish(ItemStack stack, World worldIn, EntityLivingBase entityLiving) {
		if (stack.getItem() == ExtraPlanets_Items.ANTI_RADIATION) {
			...
			if (!worldIn.isRemote) {
				...
				entityplayer.addChatMessage(new TextComponentString("" + TextFormatting.AQUA + TextFormatting.BOLD + entityplayer.getName() + TextFormatting.GOLD + ", Your Radiation Level has been reduced by 50%"));
				entityplayer.addChatMessage(new TextComponentString("" + TextFormatting.AQUA + TextFormatting.BOLD + entityplayer.getName() + TextFormatting.DARK_AQUA + ", Your Current Radiation Level is: " + (int) stats.getRadiationLevel() + "%"));
			}
