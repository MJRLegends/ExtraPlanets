...
public class JupiterStoneItemSlab extends ItemSlab {
	...
	public JupiterStoneItemSlab(Block block) {
		super(block, ((BlockSlab) (ExtraPlanets_SlabsStairsBlocks.jupiterStoneBlockHalfSlab)), ((BlockSlab) (ExtraPlanets_SlabsStairsBlocks.jupiterStoneBlockDoubleSlab)), false);
		this.setMaxDamage(0);
