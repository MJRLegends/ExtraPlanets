...
public class VenusDungeonBrickStoneItemSlab extends ItemSlab {
	public VenusDungeonBrickStoneItemSlab(Block block) {
		super(block, ((BlockSlab) (ExtraPlanets_SlabsStairsBlocks.venusDungeonBrickStoneBlockHalfSlab)), ((BlockSlab) (ExtraPlanets_SlabsStairsBlocks.venusDungeonBrickStoneBlockDoubleSlab)), false);
		this.setMaxDamage(0);
