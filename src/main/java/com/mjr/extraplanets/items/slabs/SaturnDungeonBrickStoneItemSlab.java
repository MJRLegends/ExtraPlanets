...
public class SaturnDungeonBrickStoneItemSlab extends ItemSlab{
	public SaturnDungeonBrickStoneItemSlab(Block block) {
		super(block, ((BlockSlab) (ExtraPlanets_SlabsStairsBlocks.saturnDungeonBrickStoneBlockHalfSlab)),
				((BlockSlab) (ExtraPlanets_SlabsStairsBlocks.saturnDungeonBrickStoneBlockDoubleSlab)), false);
		this.setMaxDamage(0);
