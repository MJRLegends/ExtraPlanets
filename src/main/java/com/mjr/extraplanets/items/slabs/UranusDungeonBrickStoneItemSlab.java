...
public class UranusDungeonBrickStoneItemSlab extends ItemSlab{
	public UranusDungeonBrickStoneItemSlab(Block block) {
		super(block, ((BlockSlab) (ExtraPlanets_SlabsStairsBlocks.uranusDungeonBrickStoneBlockHalfSlab)),
				((BlockSlab) (ExtraPlanets_SlabsStairsBlocks.uranusDungeonBrickStoneBlockDoubleSlab)), false);
		this.setMaxDamage(0);
