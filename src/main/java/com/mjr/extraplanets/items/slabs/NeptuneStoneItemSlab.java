...
public class NeptuneStoneItemSlab extends ItemSlab {
	...
	public NeptuneStoneItemSlab(Block block) {
		super(block, ((BlockSlab) (ExtraPlanets_SlabsStairsBlocks.neptuneStoneBlockHalfSlab)), ((BlockSlab) (ExtraPlanets_SlabsStairsBlocks.neptuneStoneBlockDoubleSlab)), false);
		this.setMaxDamage(0);
