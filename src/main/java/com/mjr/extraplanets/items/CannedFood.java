...
public class CannedFood extends Item {
    ...
    protected IIcon[] icons = new IIcon[CannedFood.names.length];

    public CannedFood(String assetName)
    {
        super();
        this.setMaxDamage(0);
    ...
    public void registerIcons(IIconRegister iconRegister)
    {
        ...
        for (final String name : CannedFood.names)
        {
    ...
    public String getUnlocalizedName(ItemStack itemStack)
    {
        ...
        return this.getUnlocalizedName() + "." + CannedFood.names[itemStack.getItemDamage()];
    }
    ...
    {
        for (int i = 0; i < CannedFood.names.length; i++)
        {
    ...
    public void addInformation(ItemStack par1ItemStack, EntityPlayer par2EntityPlayer, List par3List, boolean par4)
    {
        ...
        {
            par3List.add(EnumColor.BRIGHT_GREEN + GCCoreUtil.translate(this.getUnlocalizedName() + "." + CannedFood.names[par1ItemStack.getItemDamage()] + ".name"));
        }
    }
