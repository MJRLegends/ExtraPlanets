...
public class ItemTier5Items extends Item {
	public static final String[] names = { "tier5engine", "tier5booster", "tier5Fin", "tier5HeavyDutyPlate", "compressedPalladium", "ingotPalladium", "compressedNickel", "ingotNickel" };
