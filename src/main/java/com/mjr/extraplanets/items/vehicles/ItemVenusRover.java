...
public class ItemVenusRover extends Item implements IHoldableItem {
	...
	public ActionResult<ItemStack> onItemRightClick(World world, EntityPlayer playerIn, EnumHand hand) {
		...
		if (var24 == null) {
			...
			final List<?> var28 = world.getEntitiesWithinAABBExcludingEntity(playerIn, playerIn.getEntityBoundingBox().expand(var25.x * var21, var25.y * var21, var25.z * var21).expand(var27, var27, var27));
			int var29;
			...
			if (var26) {
				...
				if (var24.typeOfHit == RayTraceResult.Type.BLOCK) {
					...
					final EntityVenusRover var35 = new EntityVenusRover(world, var29 + 0.5F, var33 + 1.0F, var34 + 0.5F, itemStackIn.getItemDamage());
