...
public class ExtraPlanets_Tools {
	...
	private static void initializeTools() {
		if (Config.MERCURY && Config.ITEMS_MERCURY) {
			...
			MERCURY_SWORD = new BasicSword(MERCURY_MATERIAL, "mercury_sword", 5.0).setCreativeTab(ExtraPlanets.ToolsTab);
		}
		if (Config.MERCURY && Config.ITEMS_CARBON) {
			...
			CARBON_SWORD = new BasicSword(CARBON_MATERIAL, "carbon_sword", 5.5).setCreativeTab(ExtraPlanets.ToolsTab);
		}
		if (Config.CERES && Config.ITEMS_URANIUM) {
			...
			URANIUM_SWORD = new BasicSword(URANIUM_MATERIAL, "uranium_sword", 4.5).setCreativeTab(ExtraPlanets.ToolsTab);
		}
		if (Config.JUPITER) {
			if (Config.ITEMS_PALLADIUM) {
				...
				PALLADIUM_SWORD = new BasicSword(PALLADIUM_MATERIAL, "palladium_sword", 6.0).setCreativeTab(ExtraPlanets.ToolsTab);
			}
			if (Config.ITEMS_GEM_RED) {
				...
				RED_GEM_SWORD = new BasicSword(RED_GEM_MATERIAL, "red_gem_sword", 6.5).setCreativeTab(ExtraPlanets.ToolsTab);
			}
		}
		...
		if (Config.URANUS) {
			if (Config.ITEMS_PALLADIUM) {
				...
				CRYSTAL_SWORD = new BasicSword(CRYSTAL_MATERIAL, "crystal_sword", 7.0).setCreativeTab(ExtraPlanets.ToolsTab);
			}
			if (Config.ITEMS_GEM_WHITE) {
				...
				WHITE_GEM_SWORD = new BasicSword(WHITE_GEM_MATERIAL, "white_gem_sword", 6.5).setCreativeTab(ExtraPlanets.ToolsTab);
			}
		}
		if (Config.NEPTUNE) {
			if (Config.ITEMS_GEM_BLUE) {
				...
				BLUE_GEM_SWORD = new BasicSword(BLUE_GEM_MATERIAL, "blue_gem_sword", 7.0).setCreativeTab(ExtraPlanets.ToolsTab);
			}
			if (Config.ITEMS_ZINC) {
				...
				ZINC_SWORD = new BasicSword(ZINC_MATERIAL, "zinc_sword", 7.5).setCreativeTab(ExtraPlanets.ToolsTab);
			}
		}
		if (Config.PLUTO && Config.ITEMS_TUNGSTEN) {
			...
			TUNGSTEN_SWORD = new BasicSword(TUNGSTEN_MATERIAL, "tungsten_sword", 8.0).setCreativeTab(ExtraPlanets.ToolsTab);
		}
		if (Config.KEPLER22B && Config.ITEMS_KEPLER22B && Config.KEPLER_SOLAR_SYSTEMS) {
			...
			BLUE_DIAMOND_SWORD = new BasicSword(BLUE_DIAMOND_MATERIAL, "blue_diamond_sword", 9.0).setCreativeTab(ExtraPlanets.ToolsTab);
			...
			RED_DIAMOND_SWORD = new BasicSword(RED_DIAMOND_MATERIAL, "red_diamond_sword", 9.0).setCreativeTab(ExtraPlanets.ToolsTab);
			...
			PURPLE_DIAMOND_SWORD = new BasicSword(PURPLE_DIAMOND_MATERIAL, "purple_diamond_sword", 9.0).setCreativeTab(ExtraPlanets.ToolsTab);
			...
			YELLOW_DIAMOND_SWORD = new BasicSword(YELLOW_DIAMOND_MATERIAL, "yellow_diamond_sword", 9.0).setCreativeTab(ExtraPlanets.ToolsTab);
			...
			GREEN_DIAMOND_SWORD = new BasicSword(GREEN_DIAMOND_MATERIAL, "green_diamond_sword", 9.0).setCreativeTab(ExtraPlanets.ToolsTab);
		}
	}
