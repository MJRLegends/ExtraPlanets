...
public class ItemKeyT5 extends Item implements IKeyItem
{
    public static String[] keyTypes = new String[] { "T5" };
	...
	for (final String name : ItemKeyT5.keyTypes)
	{
    ...
    {
	for (int i = 0; i < ItemKeyT5.keyTypes.length; i++)
	{
