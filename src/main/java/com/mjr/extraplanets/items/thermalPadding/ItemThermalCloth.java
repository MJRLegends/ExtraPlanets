...
public class ItemThermalCloth  extends Item implements IItemThermal
{
    ...
    {
        for (int i = 0; i < ItemThermalCloth.names.length / 2; i++)
        {
    ...
    public String getUnlocalizedName(ItemStack par1ItemStack)
    {
        ...
        {
            return "item." + ItemThermalCloth.names[par1ItemStack.getItemDamage()];
        }
