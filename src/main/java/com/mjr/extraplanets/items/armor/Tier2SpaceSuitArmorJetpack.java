...
public class Tier2SpaceSuitArmorJetpack extends JetpackArmorBase implements IPressureSuit, IRadiationSuit, IBreathableArmor {
	public String name;

	public Tier2SpaceSuitArmorJetpack(String name, ArmorMaterial material, EntityEquipmentSlot placement) {
	...
	public String getArmorTexture(ItemStack stack, Entity entity, EntityEquipmentSlot slot, String type) {
		if (stack.getItem() == ExtraPlanets_Armor.TIER_2_SPACE_SUIT_JETPACK_CHEST) {
