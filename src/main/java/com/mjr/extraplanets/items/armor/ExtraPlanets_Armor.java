...
public class ExtraPlanets_Armor {
	...
	private static void initializeArmor() {
		...
		if (Config.PRESSURE || Config.RADIATION) {
			...
			TIER_2_SPACE_SUIT_JETPACK_CHEST = new Tier2SpaceSuitArmorJetpack("tier1_space_suit", TIER_2_SPACE_SUIT_ARMOR_MATERIAL, EntityEquipmentSlot.CHEST).setUnlocalizedName("tier2_space_suit_jetpack_chest");
			...
			TIER_3_SPACE_SUIT_JETPACK_CHEST = new Tier3SpaceSuitArmorJetpack("tier1_space_suit", TIER_3_SPACE_SUIT_ARMOR_MATERIAL, EntityEquipmentSlot.CHEST).setUnlocalizedName("tier3_space_suit_jetpack_chest");
			...
			TIER_4_SPACE_SUIT_JETPACK_CHEST = new Tier4SpaceSuitArmorJetpack("tier1_space_suit", TIER_4_SPACE_SUIT_ARMOR_MATERIAL, EntityEquipmentSlot.CHEST).setUnlocalizedName("tier4_space_suit_jetpack_chest");
	...
	private static void registerArmor() {
		if(Config.MERCURY) {
			if (Config.ITEMS_MERCURY) {
				ExtraPlanets_Items.registerItem(MERCURY_HELMET, MERCURY_HELMET.getUnlocalizedName().substring(5));
				ExtraPlanets_Items.registerItem(MERCURY_CHEST, MERCURY_CHEST.getUnlocalizedName().substring(5));
				ExtraPlanets_Items.registerItem(MERCURY_LEGINGS, MERCURY_LEGINGS.getUnlocalizedName().substring(5));
				ExtraPlanets_Items.registerItem(MERCURY_BOOTS, MERCURY_BOOTS.getUnlocalizedName().substring(5));
			}
			if (Config.ITEMS_CARBON) {
				ExtraPlanets_Items.registerItem(CARBON_HELMET, CARBON_HELMET.getUnlocalizedName().substring(5));
				ExtraPlanets_Items.registerItem(CARBON_CHEST, CARBON_CHEST.getUnlocalizedName().substring(5));
				ExtraPlanets_Items.registerItem(CARBON_LEGINGS, CARBON_LEGINGS.getUnlocalizedName().substring(5));
				ExtraPlanets_Items.registerItem(CARBON_BOOTS, CARBON_BOOTS.getUnlocalizedName().substring(5));
			}
		}
		if (Config.ITEMS_URANIUM && Config.CERES) {
			ExtraPlanets_Items.registerItem(URANIUM_HELMET, URANIUM_HELMET.getUnlocalizedName().substring(5));
			ExtraPlanets_Items.registerItem(URANIUM_CHEST, URANIUM_CHEST.getUnlocalizedName().substring(5));
			ExtraPlanets_Items.registerItem(URANIUM_LEGINGS, URANIUM_LEGINGS.getUnlocalizedName().substring(5));
			ExtraPlanets_Items.registerItem(URANIUM_BOOTS, URANIUM_BOOTS.getUnlocalizedName().substring(5));
		}
		if (Config.JUPITER) {
			if (Config.ITEMS_PALLADIUM) {
				ExtraPlanets_Items.registerItem(PALLASIUM_HELMET, PALLASIUM_HELMET.getUnlocalizedName().substring(5));
				ExtraPlanets_Items.registerItem(PALLASIUM_CHEST, PALLASIUM_CHEST.getUnlocalizedName().substring(5));
				ExtraPlanets_Items.registerItem(PALLASIUM_LEGINGS, PALLASIUM_LEGINGS.getUnlocalizedName().substring(5));
				ExtraPlanets_Items.registerItem(PALLASIUM_BOOTS, PALLASIUM_BOOTS.getUnlocalizedName().substring(5));
			}
			if (Config.ITEMS_GEM_RED) {
				ExtraPlanets_Items.registerItem(RED_GEM_HELMET, RED_GEM_HELMET.getUnlocalizedName().substring(5));
				ExtraPlanets_Items.registerItem(RED_GEM_CHEST, RED_GEM_CHEST.getUnlocalizedName().substring(5));
				ExtraPlanets_Items.registerItem(RED_GEM_LEGINGS, RED_GEM_LEGINGS.getUnlocalizedName().substring(5));
				ExtraPlanets_Items.registerItem(RED_GEM_BOOTS, RED_GEM_BOOTS.getUnlocalizedName().substring(5));
			}
		}
		if (Config.ITEMS_MAGNESIUM && Config.SATURN) {
			ExtraPlanets_Items.registerItem(MAGNESIUM_HELMET, MAGNESIUM_HELMET.getUnlocalizedName().substring(5));
			ExtraPlanets_Items.registerItem(MAGNESIUM_CHEST, MAGNESIUM_CHEST.getUnlocalizedName().substring(5));
			ExtraPlanets_Items.registerItem(MAGNESIUM_LEGINGS, MAGNESIUM_LEGINGS.getUnlocalizedName().substring(5));
			ExtraPlanets_Items.registerItem(MAGNESIUM_BOOTS, MAGNESIUM_BOOTS.getUnlocalizedName().substring(5));
		}
		if (Config.URANUS) {
			if (Config.ITEMS_CRYSTAL) {
				ExtraPlanets_Items.registerItem(CRYSTAL_HELMET, CRYSTAL_HELMET.getUnlocalizedName().substring(5));
				ExtraPlanets_Items.registerItem(CRYSTAL_CHEST, CRYSTAL_CHEST.getUnlocalizedName().substring(5));
				ExtraPlanets_Items.registerItem(CRYSTAL_LEGINGS, CRYSTAL_LEGINGS.getUnlocalizedName().substring(5));
				ExtraPlanets_Items.registerItem(CRYSTAL_BOOTS, CRYSTAL_BOOTS.getUnlocalizedName().substring(5));
			}
			if (Config.ITEMS_GEM_WHITE) {
				ExtraPlanets_Items.registerItem(WHITE_GEM_HELMET, WHITE_GEM_HELMET.getUnlocalizedName().substring(5));
				ExtraPlanets_Items.registerItem(WHITE_GEM_CHEST, WHITE_GEM_CHEST.getUnlocalizedName().substring(5));
				ExtraPlanets_Items.registerItem(WHITE_GEM_LEGINGS, WHITE_GEM_LEGINGS.getUnlocalizedName().substring(5));
				ExtraPlanets_Items.registerItem(WHITE_GEM_BOOTS, WHITE_GEM_BOOTS.getUnlocalizedName().substring(5));
			}
		}
		if (Config.NEPTUNE) {
			if (Config.ITEMS_ZINC) {
				ExtraPlanets_Items.registerItem(ZINC_HELMET, ZINC_HELMET.getUnlocalizedName().substring(5));
				ExtraPlanets_Items.registerItem(ZINC_CHEST, ZINC_CHEST.getUnlocalizedName().substring(5));
				ExtraPlanets_Items.registerItem(ZINC_LEGINGS, ZINC_LEGINGS.getUnlocalizedName().substring(5));
				ExtraPlanets_Items.registerItem(ZINC_BOOTS, ZINC_BOOTS.getUnlocalizedName().substring(5));
			}
			if (Config.ITEMS_GEM_BLUE) {
				ExtraPlanets_Items.registerItem(BLUE_GEM_HELMET, BLUE_GEM_HELMET.getUnlocalizedName().substring(5));
				ExtraPlanets_Items.registerItem(BLUE_GEM_CHEST, BLUE_GEM_CHEST.getUnlocalizedName().substring(5));
				ExtraPlanets_Items.registerItem(BLUE_GEM_LEGINGS, BLUE_GEM_LEGINGS.getUnlocalizedName().substring(5));
				ExtraPlanets_Items.registerItem(BLUE_GEM_BOOTS, BLUE_GEM_BOOTS.getUnlocalizedName().substring(5));
			}
		}
		if (Config.ITEMS_TUNGSTEN && Config.PLUTO) {
			ExtraPlanets_Items.registerItem(TUNGSTEN_HELMET, TUNGSTEN_HELMET.getUnlocalizedName().substring(5));
			ExtraPlanets_Items.registerItem(TUNGSTEN_CHEST, TUNGSTEN_CHEST.getUnlocalizedName().substring(5));
			ExtraPlanets_Items.registerItem(TUNGSTEN_LEGINGS, TUNGSTEN_LEGINGS.getUnlocalizedName().substring(5));
			ExtraPlanets_Items.registerItem(TUNGSTEN_BOOTS, TUNGSTEN_BOOTS.getUnlocalizedName().substring(5));
		}
		if (Config.KEPLER22B && Config.ITEMS_KEPLER22B && Config.KEPLER_SOLAR_SYSTEMS) {
			ExtraPlanets_Items.registerItem(BLUE_DIAMOND_HELMET, BLUE_DIAMOND_HELMET.getUnlocalizedName().substring(5));
			ExtraPlanets_Items.registerItem(BLUE_DIAMOND_CHEST, BLUE_DIAMOND_CHEST.getUnlocalizedName().substring(5));
			ExtraPlanets_Items.registerItem(BLUE_DIAMOND_LEGINGS, BLUE_DIAMOND_LEGINGS.getUnlocalizedName().substring(5));
			ExtraPlanets_Items.registerItem(BLUE_DIAMOND_BOOTS, BLUE_DIAMOND_BOOTS.getUnlocalizedName().substring(5));

			ExtraPlanets_Items.registerItem(RED_DIAMOND_HELMET, RED_DIAMOND_HELMET.getUnlocalizedName().substring(5));
			ExtraPlanets_Items.registerItem(RED_DIAMOND_CHEST, RED_DIAMOND_CHEST.getUnlocalizedName().substring(5));
			ExtraPlanets_Items.registerItem(RED_DIAMOND_LEGINGS, RED_DIAMOND_LEGINGS.getUnlocalizedName().substring(5));
			ExtraPlanets_Items.registerItem(RED_DIAMOND_BOOTS, RED_DIAMOND_BOOTS.getUnlocalizedName().substring(5));

			ExtraPlanets_Items.registerItem(PURPLE_DIAMOND_HELMET, PURPLE_DIAMOND_HELMET.getUnlocalizedName().substring(5));
			ExtraPlanets_Items.registerItem(PURPLE_DIAMOND_CHEST, PURPLE_DIAMOND_CHEST.getUnlocalizedName().substring(5));
			ExtraPlanets_Items.registerItem(PURPLE_DIAMOND_LEGINGS, PURPLE_DIAMOND_LEGINGS.getUnlocalizedName().substring(5));
			ExtraPlanets_Items.registerItem(PURPLE_DIAMOND_BOOTS, PURPLE_DIAMOND_BOOTS.getUnlocalizedName().substring(5));

			ExtraPlanets_Items.registerItem(YELLOW_DIAMOND_HELMET, YELLOW_DIAMOND_HELMET.getUnlocalizedName().substring(5));
			ExtraPlanets_Items.registerItem(YELLOW_DIAMOND_CHEST, YELLOW_DIAMOND_CHEST.getUnlocalizedName().substring(5));
			ExtraPlanets_Items.registerItem(YELLOW_DIAMOND_LEGINGS, YELLOW_DIAMOND_LEGINGS.getUnlocalizedName().substring(5));
			ExtraPlanets_Items.registerItem(YELLOW_DIAMOND_BOOTS, YELLOW_DIAMOND_BOOTS.getUnlocalizedName().substring(5));

			ExtraPlanets_Items.registerItem(GREEN_DIAMOND_HELMET, GREEN_DIAMOND_HELMET.getUnlocalizedName().substring(5));
			ExtraPlanets_Items.registerItem(GREEN_DIAMOND_CHEST, GREEN_DIAMOND_CHEST.getUnlocalizedName().substring(5));
			ExtraPlanets_Items.registerItem(GREEN_DIAMOND_LEGINGS, GREEN_DIAMOND_LEGINGS.getUnlocalizedName().substring(5));
			ExtraPlanets_Items.registerItem(GREEN_DIAMOND_BOOTS, GREEN_DIAMOND_BOOTS.getUnlocalizedName().substring(5));
		}
		if (Config.PRESSURE || Config.RADIATION) {
			ExtraPlanets_Items.registerItem(TIER_0_SPACE_SUIT_HELMET, TIER_0_SPACE_SUIT_HELMET.getUnlocalizedName().substring(5));
			ExtraPlanets_Items.registerItem(TIER_0_SPACE_SUIT_CHEST, TIER_0_SPACE_SUIT_CHEST.getUnlocalizedName().substring(5));
			ExtraPlanets_Items.registerItem(TIER_0_SPACE_SUIT_LEGINGS, TIER_0_SPACE_SUIT_LEGINGS.getUnlocalizedName().substring(5));
			ExtraPlanets_Items.registerItem(TIER_0_SPACE_SUIT_BOOTS, TIER_0_SPACE_SUIT_BOOTS.getUnlocalizedName().substring(5));
