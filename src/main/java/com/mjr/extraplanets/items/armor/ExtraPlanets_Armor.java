...
<<<<<<< HEAD
	...
	private static ArmorMaterial CRYSTAL_ARMOR_MATERIAL = EnumHelper.addArmorMaterial("Crystal_Armor", "Test", 40, new int[] { 3, 8, 6, 3 }, 10);

	private static ArmorMaterial MERCURY_ARMOR_MATERIAL = EnumHelper.addArmorMaterial("Mercury_Armor", "Test", 15, new int[] { 3, 8, 6, 3 }, 13);
	private static ArmorMaterial URANIUM_ARMOR_MATERIAL = EnumHelper.addArmorMaterial("Uranium_Armor", "Test", 20, new int[] { 3, 8, 6, 3 }, 13);
	private static ArmorMaterial ZINC_ARMOR_MATERIAL = EnumHelper.addArmorMaterial("Zinc_Armor", "Test", 45, new int[] { 3, 8, 6, 3 }, 9);
	private static ArmorMaterial TUNGSTEN_ARMOR_MATERIAL = EnumHelper.addArmorMaterial("Tungsten_Armor", "Test", 50, new int[] { 3, 8, 6, 3 }, 7);

	private static ArmorMaterial RED_GEM_ARMOR_MATERIAL = EnumHelper.addArmorMaterial("Red_Gem_Armor", "Test", 28, new int[] { 3, 8, 6, 3 }, 7);
	private static ArmorMaterial WHITE_GEM_ARMOR_MATERIAL = EnumHelper.addArmorMaterial("White_Gem_Armor", "Test", 40, new int[] { 3, 8, 6, 3 }, 7);
	private static ArmorMaterial BLUE_GEM_ARMOR_MATERIAL = EnumHelper.addArmorMaterial("Blue_Gem_Armor", "Test", 45, new int[] { 3, 8, 6, 3 }, 7);

	private static ArmorMaterial BLUE_DIAMOND_ARMOR_MATERIAL = EnumHelper.addArmorMaterial("Blue_Diamond_Armor", "Test", 28, new int[] { 3, 8, 6, 3 }, 7);
	private static ArmorMaterial RED_DIAMOND_ARMOR_MATERIAL = EnumHelper.addArmorMaterial("Red_Diamond_Armor", "Test", 28, new int[] { 3, 8, 6, 3 }, 7);
	private static ArmorMaterial PURPLE_DIAMOND_ARMOR_MATERIAL = EnumHelper.addArmorMaterial("Purple_Diamond_Armor", "Test", 28, new int[] { 3, 8, 6, 3 }, 7);
	private static ArmorMaterial YELLOW_DIAMOND_ARMOR_MATERIAL = EnumHelper.addArmorMaterial("Yellow_Diamond_Armor", "Test", 28, new int[] { 3, 8, 6, 3 }, 7);
	private static ArmorMaterial GREEM_DIAMOND_ARMOR_MATERIAL = EnumHelper.addArmorMaterial("Green_Diamond_Armor", "Test", 28, new int[] { 3, 8, 6, 3 }, 7);

	private static ArmorMaterial TIER_0_SPACE_SUIT_ARMOR_MATERIAL = EnumHelper.addArmorMaterial("Tier1_SpaceSuit_Armor", "Test", 28, new int[] { 2, 4, 2, 2 }, 0);
	private static ArmorMaterial TIER_1_SPACE_SUIT_ARMOR_MATERIAL = EnumHelper.addArmorMaterial("Tier1_SpaceSuit_Armor", "Test", 28, new int[] { 3, 8, 6, 3 }, 0);
	private static ArmorMaterial TIER_2_SPACE_SUIT_ARMOR_MATERIAL = EnumHelper.addArmorMaterial("Tier2_SpaceSuit_Armor", "Test", 28, new int[] { 3, 8, 6, 3 }, 0);
	private static ArmorMaterial TIER_3_SPACE_SUIT_ARMOR_MATERIAL = EnumHelper.addArmorMaterial("Tier3_SpaceSuit_Armor", "Test", 28, new int[] { 3, 8, 6, 3 }, 0);
	private static ArmorMaterial TIER_4_SPACE_SUIT_ARMOR_MATERIAL = EnumHelper.addArmorMaterial("Tier4_SpaceSuit_Armor", "Test", 28, new int[] { 3, 8, 6, 3 }, 0);
	...
	private static void initializeArmor() {
		...
		if (Config.ITEMS_URANIUM && Config.CERES) {
			...
			URANIUM_CHEST = new UraniumArmor("uranium", URANIUM_ARMOR_MATERIAL, 1).setUnlocalizedName("uranium_chest");
			URANIUM_LEGINGS = new UraniumArmor("uranium", URANIUM_ARMOR_MATERIAL, 2).setUnlocalizedName("uranium_legings");
			URANIUM_BOOTS = new UraniumArmor("uranium", URANIUM_ARMOR_MATERIAL, 3).setUnlocalizedName("uranium_boots");
		}
		if (Config.JUPITER) {
			if (Config.ITEMS_PALLADIUM) {
				PALLASIUM_HELMET = new PalladiumArmor("palladium", PALLADIUM_ARMOR_MATERIAL, 0).setUnlocalizedName("palladium_helmet");
				PALLASIUM_CHEST = new PalladiumArmor("palladium", PALLADIUM_ARMOR_MATERIAL, 1).setUnlocalizedName("palladium_chest");
				PALLASIUM_LEGINGS = new PalladiumArmor("palladium", PALLADIUM_ARMOR_MATERIAL, 2).setUnlocalizedName("palladium_legings");
				PALLASIUM_BOOTS = new PalladiumArmor("palladium", PALLADIUM_ARMOR_MATERIAL, 3).setUnlocalizedName("palladium_boots");
			}
			if (Config.ITEMS_GEM_RED) {
				RED_GEM_HELMET = new RedGemArmor("red_gem", RED_GEM_ARMOR_MATERIAL, 0).setUnlocalizedName("red_gem_helmet");
				RED_GEM_CHEST = new RedGemArmor("red_gem", RED_GEM_ARMOR_MATERIAL, 1).setUnlocalizedName("red_gem_chest");
				RED_GEM_LEGINGS = new RedGemArmor("red_gem", RED_GEM_ARMOR_MATERIAL, 2).setUnlocalizedName("red_gem_legings");
				RED_GEM_BOOTS = new RedGemArmor("red_gem", RED_GEM_ARMOR_MATERIAL, 3).setUnlocalizedName("red_gem_boots");
			}
		}
		if (Config.ITEMS_MAGNESIUM && Config.SATURN) {
			MAGNESIUM_HELMET = new MagnesiumArmor("magnesium", MAGNESIUM_ARMOR_MATERIAL, 0).setUnlocalizedName("magnesium_helmet");
			MAGNESIUM_CHEST = new MagnesiumArmor("magnesium", MAGNESIUM_ARMOR_MATERIAL, 1).setUnlocalizedName("magnesium_chest");
		...
		if (Config.ITEMS_CRYSTAL && Config.URANUS) {
			...
			if (Config.ITEMS_GEM_WHITE) {
				...
				WHITE_GEM_LEGINGS = new WhiteGemArmor("white_gem", WHITE_GEM_ARMOR_MATERIAL, 2).setUnlocalizedName("white_gem_legings");
		...
		if (Config.ITEMS_ZINC && Config.NEPTUNE) {
			...
			if (Config.ITEMS_GEM_BLUE) {
				...
				BLUE_GEM_LEGINGS = new BlueGemArmor("blue_gem", BLUE_GEM_ARMOR_MATERIAL, 2).setUnlocalizedName("blue_gem_legings");
				BLUE_GEM_BOOTS = new BlueGemArmor("blue_gem", BLUE_GEM_ARMOR_MATERIAL, 3).setUnlocalizedName("blue_gem_boots");
			}
		}
		if (Config.ITEMS_TUNGSTEN && Config.PLUTO) {
			TUNGSTEN_HELMET = new TungstenArmor("tungsten", TUNGSTEN_ARMOR_MATERIAL, 0).setUnlocalizedName("tungsten_helmet");
			TUNGSTEN_CHEST = new TungstenArmor("tungsten", TUNGSTEN_ARMOR_MATERIAL, 1).setUnlocalizedName("tungsten_chest");
			TUNGSTEN_LEGINGS = new TungstenArmor("tungsten", TUNGSTEN_ARMOR_MATERIAL, 2).setUnlocalizedName("tungsten_legings");
			TUNGSTEN_BOOTS = new TungstenArmor("tungsten", TUNGSTEN_ARMOR_MATERIAL, 3).setUnlocalizedName("tungsten_boots");
		}
		if (Config.KEPLER22B && Config.ITEMS_KEPLER22B && Config.KEPLER_SOLAR_SYSTEMS) {
			BLUE_DIAMOND_HELMET = new BlueDiamondArmor("blue_diamond", BLUE_DIAMOND_ARMOR_MATERIAL, 0).setUnlocalizedName("blue_diamond_helmet");
			BLUE_DIAMOND_CHEST = new BlueDiamondArmor("blue_diamond", BLUE_DIAMOND_ARMOR_MATERIAL, 1).setUnlocalizedName("blue_diamond_chest");
			BLUE_DIAMOND_LEGINGS = new BlueDiamondArmor("blue_diamond", BLUE_DIAMOND_ARMOR_MATERIAL, 2).setUnlocalizedName("blue_diamond_legings");
			BLUE_DIAMOND_BOOTS = new BlueDiamondArmor("blue_diamond", BLUE_DIAMOND_ARMOR_MATERIAL, 3).setUnlocalizedName("blue_diamond_boots");

			RED_DIAMOND_HELMET = new RedDiamondArmor("red_diamond", RED_DIAMOND_ARMOR_MATERIAL, 0).setUnlocalizedName("red_diamond_helmet");
			RED_DIAMOND_CHEST = new RedDiamondArmor("red_diamond", RED_DIAMOND_ARMOR_MATERIAL, 1).setUnlocalizedName("red_diamond_chest");
			RED_DIAMOND_LEGINGS = new RedDiamondArmor("red_diamond", RED_DIAMOND_ARMOR_MATERIAL, 2).setUnlocalizedName("red_diamond_legings");
			RED_DIAMOND_BOOTS = new RedDiamondArmor("red_diamond", RED_DIAMOND_ARMOR_MATERIAL, 3).setUnlocalizedName("red_diamond_boots");

			PURPLE_DIAMOND_HELMET = new PurpleDiamondArmor("purple_diamond", PURPLE_DIAMOND_ARMOR_MATERIAL, 0).setUnlocalizedName("purple_diamond_helmet");
			PURPLE_DIAMOND_CHEST = new PurpleDiamondArmor("purple_diamond", PURPLE_DIAMOND_ARMOR_MATERIAL, 1).setUnlocalizedName("purple_diamond_chest");
			PURPLE_DIAMOND_LEGINGS = new PurpleDiamondArmor("purple_diamond", PURPLE_DIAMOND_ARMOR_MATERIAL, 2).setUnlocalizedName("purple_diamond_legings");
			PURPLE_DIAMOND_BOOTS = new PurpleDiamondArmor("purple_diamond", PURPLE_DIAMOND_ARMOR_MATERIAL, 3).setUnlocalizedName("purple_diamond_boots");

			YELLOW_DIAMOND_HELMET = new YellowDiamondArmor("yellow_diamond", YELLOW_DIAMOND_ARMOR_MATERIAL, 0).setUnlocalizedName("yellow_diamond_helmet");
			YELLOW_DIAMOND_CHEST = new YellowDiamondArmor("yellow_diamond", YELLOW_DIAMOND_ARMOR_MATERIAL, 1).setUnlocalizedName("yellow_diamond_chest");
			YELLOW_DIAMOND_LEGINGS = new YellowDiamondArmor("yellow_diamond", YELLOW_DIAMOND_ARMOR_MATERIAL, 2).setUnlocalizedName("yellow_diamond_legings");
			YELLOW_DIAMOND_BOOTS = new YellowDiamondArmor("yellow_diamond", YELLOW_DIAMOND_ARMOR_MATERIAL, 3).setUnlocalizedName("yellow_diamond_boots");

			GREEN_DIAMOND_HELMET = new GreenDiamondArmor("green_diamond", GREEM_DIAMOND_ARMOR_MATERIAL, 0).setUnlocalizedName("green_diamond_helmet");
			GREEN_DIAMOND_CHEST = new GreenDiamondArmor("green_diamond", GREEM_DIAMOND_ARMOR_MATERIAL, 1).setUnlocalizedName("green_diamond_chest");
			GREEN_DIAMOND_LEGINGS = new GreenDiamondArmor("green_diamond", GREEM_DIAMOND_ARMOR_MATERIAL, 2).setUnlocalizedName("green_diamond_legings");
			GREEN_DIAMOND_BOOTS = new GreenDiamondArmor("green_diamond", GREEM_DIAMOND_ARMOR_MATERIAL, 3).setUnlocalizedName("green_diamond_boots");
		}
		if (Config.PRESSURE || Config.RADIATION) {
			TIER_0_SPACE_SUIT_HELMET = new Tier0SpaceSuitArmor("tier0_space_suit", TIER_0_SPACE_SUIT_ARMOR_MATERIAL, 0).setUnlocalizedName("tier0_space_suit_helmet");
			...
			TIER_1_SPACE_SUIT_LEGINGS = new Tier1SpaceSuitArmor("tier1_space_suit", TIER_1_SPACE_SUIT_ARMOR_MATERIAL, 2).setUnlocalizedName("tier1_space_suit_legings");
			TIER_1_SPACE_SUIT_BOOTS = new Tier1SpaceSuitArmor("tier1_space_suit", TIER_1_SPACE_SUIT_ARMOR_MATERIAL, 3).setUnlocalizedName("tier1_space_suit_boots");
			TIER_1_SPACE_SUIT_GRAVITY_BOOTS = new Tier1SpaceSuitArmor("tier1_space_suit", TIER_1_SPACE_SUIT_ARMOR_MATERIAL, 3).setUnlocalizedName("tier1_space_suit_gravity_boots");
	...
	private static void registerArmor() {
		...
		if (Config.PRESSURE || Config.RADIATION) {
			...
			RegisterUtilities.registerItem(TIER_2_SPACE_SUIT_JETPACK_CHEST, TIER_2_SPACE_SUIT_JETPACK_CHEST.getUnlocalizedName().substring(5));
			...
			RegisterUtilities.registerItem(TIER_3_SPACE_SUIT_JETPACK_CHEST, TIER_3_SPACE_SUIT_JETPACK_CHEST.getUnlocalizedName().substring(5));
			...
			RegisterUtilities.registerItem(TIER_4_SPACE_SUIT_JETPACK_CHEST, TIER_4_SPACE_SUIT_JETPACK_CHEST.getUnlocalizedName().substring(5));
