...
public class ItemKeyT4Uranus extends Item implements IKeyItem
{
	...
	{
		return "item." + "key." + ItemKeyT4Uranus.keyTypes[itemStack.getItemDamage()];
	}
	...
	public void registerIcons(IIconRegister iconRegister)
	{
		...
		for (final String name : ItemKeyT4Uranus.keyTypes)
		{
	...
	{
		for (int i = 0; i < ItemKeyT4Uranus.keyTypes.length; i++)
		{
