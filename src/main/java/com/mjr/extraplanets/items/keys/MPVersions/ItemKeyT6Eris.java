...
public class ItemKeyT6Eris extends Item implements IKeyItem
{
	...
	{
		return "item." + "key." + ItemKeyT6Eris.keyTypes[itemStack.getItemDamage()];
	}
	...
	public void registerIcons(IIconRegister iconRegister)
	{
		...
		for (final String name : ItemKeyT6Eris.keyTypes)
		{
	...
	{
		for (int i = 0; i < ItemKeyT6Eris.keyTypes.length; i++)
		{
