...
public class EntityEvolvedMiniEnderman extends EntityMob implements IEntityBreathable
{
	...
	public EntityEvolvedMiniEnderman(World p_i1734_1_)
	{
		super(p_i1734_1_);
		...
		if (!this.worldObj.isRemote && this.worldObj.getGameRules().getGameRuleBooleanValue("mobGriefing"))
		{
			...
			if (this.func_146080_bZ().getMaterial() == Material.air)
			{
				if (this.rand.nextInt(20) == 0)
				{
					...
					if (EntityEvolvedMiniEnderman.getCarriable(block))
					{
