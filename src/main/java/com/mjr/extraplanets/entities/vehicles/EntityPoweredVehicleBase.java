...
public abstract class EntityPoweredVehicleBase extends Entity implements IInventoryDefaults, IPacketReceiver, IPoweredDockable, IControllableEntity, IEntityFullSync {
	...
	public boolean interactFirst(EntityPlayer playerIn) {
		if (this.worldObj.isRemote) {
			if (this.riddenByEntity == null) {
				PlayerUtilties.sendMessage(playerIn,
				...
				PlayerUtilties.sendMessage(playerIn, GameSettings.getKeyDisplayString(com.mjr.extraplanets.client.handlers.KeyHandlerClient.openPowerGUI.getKeyCode()) + "       - " + TranslateUtilities.translate("gui.powered.inv.name"));
			}
