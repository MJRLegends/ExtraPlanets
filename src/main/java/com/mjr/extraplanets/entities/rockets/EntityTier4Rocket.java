...
public class EntityTier4Rocket extends EntityTieredRocket
{
	...
	public EntityTier4Rocket(World par1World, double par2, double par4, double par6, boolean reversed, EnumRocketType rocketType, ItemStack[] inv)
	{
	...
	public void onUpdate()
	{
		...
		if (this.launchPhase == EnumLaunchPhase.LAUNCHED.ordinal() && this.hasValidFuel())
		{
			if (!this.landing)
			{
				...
				if (d != 0.0)
				{
					this.motionY = -d * 3.0D * Math.cos((this.rotationPitch - 180) / 57.2957795D);
				}
			}
			else
			{
	...
	public void onTeleport(EntityPlayerMP player)
	{
		...
		if (playerBase != null)
		{
			...
			stats.rocketItem = ExtraPlanetsItems.tier4Rocket;
	...
	public List<ItemStack> getItemsDropped(List<ItemStack> droppedItems)
	{
		...
		ItemStack rocket = new ItemStack(ExtraPlanetsItems.tier4Rocket, 1, this.rocketType.getIndex());
