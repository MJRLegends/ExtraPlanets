...
public class EntityTier8Rocket extends EntityTieredRocket
{
	...
	public EntityTier8Rocket(World par1World, double par2, double par4, double par6, boolean reversed, EnumRocketType rocketType, ItemStack[] inv)
	{
	...
	public void onUpdate()
	{
		...
		if (this.launchPhase == EnumLaunchPhase.LAUNCHED.ordinal() && this.hasValidFuel())
		{
			if (!this.landing)
			{
				...
				if (d != 0.0)
				{
					this.motionY = -d * 4.5D * Math.cos((this.rotationPitch - 180) / 57.2957795D);
				}
			}
			else
			{
	...
	public void onTeleport(EntityPlayerMP player)
	{
		...
		if (playerBase != null)
		{
			...
			stats.rocketItem = ExtraPlanetsItems.tier8Rocket;
	...
	public List<ItemStack> getItemsDropped(List<ItemStack> droppedItems)
	{
		...
		ItemStack rocket = new ItemStack(ExtraPlanetsItems.tier8Rocket, 1, this.rocketType.getIndex());
