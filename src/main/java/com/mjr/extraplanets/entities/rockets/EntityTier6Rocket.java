...
public class EntityTier6Rocket extends EntityTieredRocket {
	...
	public EntityTier6Rocket(World world, double x, double y, double z, IRocketType.EnumRocketType type, ItemStack[] inv) {
	...
	public ItemStack getPickedResult(MovingObjectPosition target) {
		return new ItemStack(ExtraPlanets_Items.tier6Rocket, 1, this.rocketType.getIndex());
	}
	...
	public void onTeleport(EntityPlayerMP player) {
		...
		if (playerBase != null) {
            ...
            stats.setRocketItem(ExtraPlanets_Items.tier6Rocket);
	...
	public List<ItemStack> getItemsDropped(List<ItemStack> droppedItems) {
		...
		ItemStack rocket = new ItemStack(ExtraPlanets_Items.tier6Rocket, 1, this.rocketType.getIndex());
