...
public class EntityCreeperBossSaturn extends EntityBossBase implements IEntityBreathable, IRangedAttackMob {
	...
	protected void onDeathUpdate() {
		...
		if (!this.worldObj.isRemote) {
			if (this.deathTicks == 1) {
				GalacticraftCore.packetPipeline.sendToAllAround(new PacketSimple(EnumSimplePacket.C_PLAY_SOUND_BOSS_DEATH, GCCoreUtil.getDimensionID(this.worldObj), new Object[] { getSoundPitch() - 0.1F }),
						new TargetPoint(GCCoreUtil.getDimensionID(this.worldObj), this.posX, this.posY, this.posZ, 40.0D));
			}
		}
	}
	...
	public ItemStack getGuaranteedLoot(Random rand) {
		List<ItemStack> itemStackList = GalacticraftRegistry.getDungeonLoot(6);
