...
public class EntityEvolvedIceSlimeBoss extends EntityMob implements IEntityBreathable, IBossDisplayData, IBoss {
	...
	public EntityEvolvedIceSlimeBoss(World p_i1742_1_) {
		super(p_i1742_1_);
		int i = 10;
		// int i = 5;
		this.yOffset = 0.0F;
