...
public class WorldGenBasicHideout  extends WorldGenerator {
	...
	public boolean generate_r0(World world, Random rand, int x, int y, int z) {
		world.setBlockState(new BlockPos(x + 5, y + 0, z + 0), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(0), 3);
		world.setBlockState(new BlockPos(x + 6, y + 0, z + 0), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(0), 3);
		world.setBlockState(new BlockPos(x + 7, y + 0, z + 0), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(0), 3);
		world.setBlockState(new BlockPos(x + 1, y + 0, z + 1), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(0), 3);
		world.setBlockState(new BlockPos(x + 2, y + 0, z + 1), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(0), 3);
		world.setBlockState(new BlockPos(x + 3, y + 0, z + 1), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(0), 3);
		world.setBlockState(new BlockPos(x + 4, y + 0, z + 1), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(0), 3);
		world.setBlockState(new BlockPos(x + 5, y + 0, z + 1), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(0), 3);
		world.setBlockState(new BlockPos(x + 6, y + 0, z + 1), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(0), 3);
		world.setBlockState(new BlockPos(x + 7, y + 0, z + 1), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(0), 3);
		world.setBlockState(new BlockPos(x + 8, y + 0, z + 1), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(0), 3);
		world.setBlockState(new BlockPos(x + 9, y + 0, z + 1), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(0), 3);
		world.setBlockState(new BlockPos(x + 10, y + 0, z + 1), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(0), 3);
		world.setBlockState(new BlockPos(x + 11, y + 0, z + 1), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(0), 3);
		world.setBlockState(new BlockPos(x + 0, y + 0, z + 2), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(0), 3);
		world.setBlockState(new BlockPos(x + 1, y + 0, z + 2), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(0), 3);
		world.setBlockState(new BlockPos(x + 2, y + 0, z + 2), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(0), 3);
		world.setBlockState(new BlockPos(x + 3, y + 0, z + 2), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(0), 3);
		world.setBlockState(new BlockPos(x + 4, y + 0, z + 2), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(0), 3);
		world.setBlockState(new BlockPos(x + 5, y + 0, z + 2), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(0), 3);
		world.setBlockState(new BlockPos(x + 6, y + 0, z + 2), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(0), 3);
		world.setBlockState(new BlockPos(x + 7, y + 0, z + 2), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(0), 3);
		world.setBlockState(new BlockPos(x + 8, y + 0, z + 2), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(0), 3);
		world.setBlockState(new BlockPos(x + 9, y + 0, z + 2), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(0), 3);
		world.setBlockState(new BlockPos(x + 10, y + 0, z + 2), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(0), 3);
		world.setBlockState(new BlockPos(x + 11, y + 0, z + 2), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(0), 3);
		world.setBlockState(new BlockPos(x + 12, y + 0, z + 2), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(0), 3);
		world.setBlockState(new BlockPos(x + 0, y + 0, z + 3), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(0), 3);
		world.setBlockState(new BlockPos(x + 1, y + 0, z + 3), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(0), 3);
		world.setBlockState(new BlockPos(x + 2, y + 0, z + 3), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(0), 3);
		world.setBlockState(new BlockPos(x + 3, y + 0, z + 3), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(0), 3);
		world.setBlockState(new BlockPos(x + 4, y + 0, z + 3), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(0), 3);
		world.setBlockState(new BlockPos(x + 5, y + 0, z + 3), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(0), 3);
		world.setBlockState(new BlockPos(x + 6, y + 0, z + 3), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(0), 3);
		world.setBlockState(new BlockPos(x + 7, y + 0, z + 3), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(0), 3);
		world.setBlockState(new BlockPos(x + 8, y + 0, z + 3), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(0), 3);
		world.setBlockState(new BlockPos(x + 9, y + 0, z + 3), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(0), 3);
		world.setBlockState(new BlockPos(x + 10, y + 0, z + 3), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(0), 3);
		world.setBlockState(new BlockPos(x + 11, y + 0, z + 3), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(0), 3);
		world.setBlockState(new BlockPos(x + 12, y + 0, z + 3), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(0), 3);
		world.setBlockState(new BlockPos(x + 0, y + 0, z + 4), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(0), 3);
		world.setBlockState(new BlockPos(x + 1, y + 0, z + 4), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(0), 3);
		world.setBlockState(new BlockPos(x + 2, y + 0, z + 4), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(0), 3);
		world.setBlockState(new BlockPos(x + 3, y + 0, z + 4), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(0), 3);
		world.setBlockState(new BlockPos(x + 4, y + 0, z + 4), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(0), 3);
		world.setBlockState(new BlockPos(x + 5, y + 0, z + 4), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(0), 3);
		world.setBlockState(new BlockPos(x + 6, y + 0, z + 4), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(0), 3);
		world.setBlockState(new BlockPos(x + 7, y + 0, z + 4), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(0), 3);
		world.setBlockState(new BlockPos(x + 8, y + 0, z + 4), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(0), 3);
		world.setBlockState(new BlockPos(x + 9, y + 0, z + 4), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(0), 3);
		world.setBlockState(new BlockPos(x + 10, y + 0, z + 4), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(0), 3);
		world.setBlockState(new BlockPos(x + 11, y + 0, z + 4), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(0), 3);
		world.setBlockState(new BlockPos(x + 12, y + 0, z + 4), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(0), 3);
		world.setBlockState(new BlockPos(x + 13, y + 0, z + 4), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(0), 3);
		world.setBlockState(new BlockPos(x + 0, y + 0, z + 5), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(0), 3);
		world.setBlockState(new BlockPos(x + 1, y + 0, z + 5), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(0), 3);
		world.setBlockState(new BlockPos(x + 2, y + 0, z + 5), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(0), 3);
		world.setBlockState(new BlockPos(x + 3, y + 0, z + 5), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(0), 3);
		world.setBlockState(new BlockPos(x + 4, y + 0, z + 5), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(0), 3);
		world.setBlockState(new BlockPos(x + 5, y + 0, z + 5), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(0), 3);
		world.setBlockState(new BlockPos(x + 6, y + 0, z + 5), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(0), 3);
		world.setBlockState(new BlockPos(x + 7, y + 0, z + 5), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(0), 3);
		world.setBlockState(new BlockPos(x + 8, y + 0, z + 5), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(0), 3);
		world.setBlockState(new BlockPos(x + 9, y + 0, z + 5), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(0), 3);
		world.setBlockState(new BlockPos(x + 10, y + 0, z + 5), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(0), 3);
		world.setBlockState(new BlockPos(x + 11, y + 0, z + 5), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(0), 3);
		world.setBlockState(new BlockPos(x + 12, y + 0, z + 5), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(0), 3);
		world.setBlockState(new BlockPos(x + 13, y + 0, z + 5), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(0), 3);
		world.setBlockState(new BlockPos(x + 0, y + 0, z + 6), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(0), 3);
		world.setBlockState(new BlockPos(x + 1, y + 0, z + 6), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(0), 3);
		world.setBlockState(new BlockPos(x + 2, y + 0, z + 6), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(0), 3);
		world.setBlockState(new BlockPos(x + 3, y + 0, z + 6), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(0), 3);
		world.setBlockState(new BlockPos(x + 4, y + 0, z + 6), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(0), 3);
		world.setBlockState(new BlockPos(x + 5, y + 0, z + 6), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(0), 3);
		world.setBlockState(new BlockPos(x + 6, y + 0, z + 6), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(0), 3);
		world.setBlockState(new BlockPos(x + 7, y + 0, z + 6), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(0), 3);
		world.setBlockState(new BlockPos(x + 8, y + 0, z + 6), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(0), 3);
		world.setBlockState(new BlockPos(x + 9, y + 0, z + 6), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(0), 3);
		world.setBlockState(new BlockPos(x + 10, y + 0, z + 6), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(0), 3);
		world.setBlockState(new BlockPos(x + 11, y + 0, z + 6), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(0), 3);
		world.setBlockState(new BlockPos(x + 12, y + 0, z + 6), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(0), 3);
		world.setBlockState(new BlockPos(x + 13, y + 0, z + 6), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(0), 3);
		world.setBlockState(new BlockPos(x + 0, y + 0, z + 7), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(0), 3);
		world.setBlockState(new BlockPos(x + 1, y + 0, z + 7), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(0), 3);
		world.setBlockState(new BlockPos(x + 2, y + 0, z + 7), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(0), 3);
		world.setBlockState(new BlockPos(x + 3, y + 0, z + 7), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(0), 3);
		world.setBlockState(new BlockPos(x + 4, y + 0, z + 7), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(0), 3);
		world.setBlockState(new BlockPos(x + 5, y + 0, z + 7), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(0), 3);
		world.setBlockState(new BlockPos(x + 6, y + 0, z + 7), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(0), 3);
		world.setBlockState(new BlockPos(x + 7, y + 0, z + 7), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(0), 3);
		world.setBlockState(new BlockPos(x + 8, y + 0, z + 7), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(0), 3);
		world.setBlockState(new BlockPos(x + 9, y + 0, z + 7), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(0), 3);
		world.setBlockState(new BlockPos(x + 10, y + 0, z + 7), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(0), 3);
		world.setBlockState(new BlockPos(x + 11, y + 0, z + 7), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(0), 3);
		world.setBlockState(new BlockPos(x + 12, y + 0, z + 7), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(0), 3);
		world.setBlockState(new BlockPos(x + 13, y + 0, z + 7), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(0), 3);
		world.setBlockState(new BlockPos(x + 0, y + 0, z + 8), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(0), 3);
		world.setBlockState(new BlockPos(x + 1, y + 0, z + 8), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(0), 3);
		world.setBlockState(new BlockPos(x + 2, y + 0, z + 8), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(0), 3);
		world.setBlockState(new BlockPos(x + 3, y + 0, z + 8), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(0), 3);
		world.setBlockState(new BlockPos(x + 4, y + 0, z + 8), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(0), 3);
		world.setBlockState(new BlockPos(x + 5, y + 0, z + 8), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(0), 3);
		world.setBlockState(new BlockPos(x + 6, y + 0, z + 8), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(0), 3);
		world.setBlockState(new BlockPos(x + 7, y + 0, z + 8), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(0), 3);
		world.setBlockState(new BlockPos(x + 8, y + 0, z + 8), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(0), 3);
		world.setBlockState(new BlockPos(x + 9, y + 0, z + 8), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(0), 3);
		world.setBlockState(new BlockPos(x + 10, y + 0, z + 8), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(0), 3);
		world.setBlockState(new BlockPos(x + 11, y + 0, z + 8), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(0), 3);
		world.setBlockState(new BlockPos(x + 12, y + 0, z + 8), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(0), 3);
		world.setBlockState(new BlockPos(x + 0, y + 0, z + 9), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(0), 3);
		world.setBlockState(new BlockPos(x + 1, y + 0, z + 9), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(0), 3);
		world.setBlockState(new BlockPos(x + 2, y + 0, z + 9), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(0), 3);
		world.setBlockState(new BlockPos(x + 3, y + 0, z + 9), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(0), 3);
		world.setBlockState(new BlockPos(x + 4, y + 0, z + 9), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(0), 3);
		world.setBlockState(new BlockPos(x + 5, y + 0, z + 9), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(0), 3);
		world.setBlockState(new BlockPos(x + 6, y + 0, z + 9), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(0), 3);
		world.setBlockState(new BlockPos(x + 7, y + 0, z + 9), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(0), 3);
		world.setBlockState(new BlockPos(x + 8, y + 0, z + 9), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(0), 3);
		world.setBlockState(new BlockPos(x + 9, y + 0, z + 9), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(0), 3);
		world.setBlockState(new BlockPos(x + 10, y + 0, z + 9), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(0), 3);
		world.setBlockState(new BlockPos(x + 11, y + 0, z + 9), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(0), 3);
		world.setBlockState(new BlockPos(x + 12, y + 0, z + 9), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(0), 3);
		world.setBlockState(new BlockPos(x + 1, y + 0, z + 10), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(0), 3);
		world.setBlockState(new BlockPos(x + 2, y + 0, z + 10), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(0), 3);
		world.setBlockState(new BlockPos(x + 3, y + 0, z + 10), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(0), 3);
		world.setBlockState(new BlockPos(x + 4, y + 0, z + 10), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(0), 3);
		world.setBlockState(new BlockPos(x + 5, y + 0, z + 10), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(0), 3);
		world.setBlockState(new BlockPos(x + 6, y + 0, z + 10), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(0), 3);
		world.setBlockState(new BlockPos(x + 7, y + 0, z + 10), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(0), 3);
		world.setBlockState(new BlockPos(x + 8, y + 0, z + 10), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(0), 3);
		world.setBlockState(new BlockPos(x + 9, y + 0, z + 10), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(0), 3);
		world.setBlockState(new BlockPos(x + 10, y + 0, z + 10), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(0), 3);
		world.setBlockState(new BlockPos(x + 11, y + 0, z + 10), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(0), 3);
		world.setBlockState(new BlockPos(x + 5, y + 0, z + 11), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(0), 3);
		world.setBlockState(new BlockPos(x + 6, y + 0, z + 11), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(0), 3);
		world.setBlockState(new BlockPos(x + 7, y + 0, z + 11), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(0), 3);
		world.setBlockState(new BlockPos(x + 5, y + 1, z + 0), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(1), 3);
		world.setBlockState(new BlockPos(x + 6, y + 1, z + 0), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(1), 3);
		world.setBlockState(new BlockPos(x + 7, y + 1, z + 0), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(1), 3);
		world.setBlockState(new BlockPos(x + 1, y + 1, z + 1), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(1), 3);
		world.setBlockState(new BlockPos(x + 2, y + 1, z + 1), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(1), 3);
		world.setBlockState(new BlockPos(x + 3, y + 1, z + 1), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(1), 3);
		world.setBlockState(new BlockPos(x + 4, y + 1, z + 1), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(1), 3);
		...
		world.setBlockState(new BlockPos(x + 8, y + 1, z + 1), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(1), 3);
		world.setBlockState(new BlockPos(x + 9, y + 1, z + 1), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(1), 3);
		world.setBlockState(new BlockPos(x + 10, y + 1, z + 1), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(1), 3);
		world.setBlockState(new BlockPos(x + 11, y + 1, z + 1), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(1), 3);
		world.setBlockState(new BlockPos(x + 0, y + 1, z + 2), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(1), 3);
		...
		world.setBlockState(new BlockPos(x + 12, y + 1, z + 2), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(1), 3);
		world.setBlockState(new BlockPos(x + 0, y + 1, z + 3), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(1), 3);
		...
		world.setBlockState(new BlockPos(x + 12, y + 1, z + 3), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(1), 3);
		world.setBlockState(new BlockPos(x + 0, y + 1, z + 4), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(1), 3);
		...
		world.setBlockState(new BlockPos(x + 7, y + 1, z + 4), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(1), 3);
		...
		world.setBlockState(new BlockPos(x + 13, y + 1, z + 4), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(1), 3);
		world.setBlockState(new BlockPos(x + 0, y + 1, z + 5), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(1), 3);
		...
		world.setBlockState(new BlockPos(x + 7, y + 1, z + 5), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(1), 3);
		...
		world.setBlockState(new BlockPos(x + 0, y + 1, z + 6), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(1), 3);
		...
		world.setBlockState(new BlockPos(x + 7, y + 1, z + 6), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(1), 3);
		...
		world.setBlockState(new BlockPos(x + 0, y + 1, z + 7), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(1), 3);
		...
		world.setBlockState(new BlockPos(x + 7, y + 1, z + 7), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(1), 3);
		...
		world.setBlockState(new BlockPos(x + 13, y + 1, z + 7), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(1), 3);
		world.setBlockState(new BlockPos(x + 0, y + 1, z + 8), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(1), 3);
		...
		world.setBlockState(new BlockPos(x + 12, y + 1, z + 8), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(1), 3);
		world.setBlockState(new BlockPos(x + 0, y + 1, z + 9), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(1), 3);
		...
		world.setBlockState(new BlockPos(x + 12, y + 1, z + 9), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(1), 3);
		world.setBlockState(new BlockPos(x + 1, y + 1, z + 10), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(1), 3);
		world.setBlockState(new BlockPos(x + 2, y + 1, z + 10), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(1), 3);
		world.setBlockState(new BlockPos(x + 3, y + 1, z + 10), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(1), 3);
		world.setBlockState(new BlockPos(x + 4, y + 1, z + 10), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(1), 3);
		...
		world.setBlockState(new BlockPos(x + 8, y + 1, z + 10), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(1), 3);
		world.setBlockState(new BlockPos(x + 9, y + 1, z + 10), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(1), 3);
		world.setBlockState(new BlockPos(x + 10, y + 1, z + 10), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(1), 3);
		world.setBlockState(new BlockPos(x + 11, y + 1, z + 10), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(1), 3);
		world.setBlockState(new BlockPos(x + 5, y + 1, z + 11), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(1), 3);
		world.setBlockState(new BlockPos(x + 6, y + 1, z + 11), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(1), 3);
		world.setBlockState(new BlockPos(x + 7, y + 1, z + 11), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(1), 3);
		world.setBlockState(new BlockPos(x + 5, y + 2, z + 0), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(1), 3);
		world.setBlockState(new BlockPos(x + 6, y + 2, z + 0), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(1), 3);
		world.setBlockState(new BlockPos(x + 7, y + 2, z + 0), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(1), 3);
		world.setBlockState(new BlockPos(x + 1, y + 2, z + 1), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(1), 3);
		world.setBlockState(new BlockPos(x + 2, y + 2, z + 1), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(1), 3);
		world.setBlockState(new BlockPos(x + 3, y + 2, z + 1), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(1), 3);
		world.setBlockState(new BlockPos(x + 4, y + 2, z + 1), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(1), 3);
		...
		world.setBlockState(new BlockPos(x + 8, y + 2, z + 1), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(1), 3);
		world.setBlockState(new BlockPos(x + 9, y + 2, z + 1), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(1), 3);
		world.setBlockState(new BlockPos(x + 10, y + 2, z + 1), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(1), 3);
		world.setBlockState(new BlockPos(x + 11, y + 2, z + 1), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(1), 3);
		world.setBlockState(new BlockPos(x + 0, y + 2, z + 2), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(1), 3);
		...
		world.setBlockState(new BlockPos(x + 12, y + 2, z + 2), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(1), 3);
		world.setBlockState(new BlockPos(x + 0, y + 2, z + 3), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(1), 3);
		...
		world.setBlockState(new BlockPos(x + 12, y + 2, z + 3), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(1), 3);
		world.setBlockState(new BlockPos(x + 0, y + 2, z + 4), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(1), 3);
		...
		world.setBlockState(new BlockPos(x + 7, y + 2, z + 4), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(1), 3);
		...
		world.setBlockState(new BlockPos(x + 13, y + 2, z + 4), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(1), 3);
		world.setBlockState(new BlockPos(x + 0, y + 2, z + 5), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(1), 3);
		...
		world.setBlockState(new BlockPos(x + 7, y + 2, z + 5), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(1), 3);
		...
		world.setBlockState(new BlockPos(x + 0, y + 2, z + 6), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(1), 3);
		...
		world.setBlockState(new BlockPos(x + 7, y + 2, z + 6), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(1), 3);
		...
		world.setBlockState(new BlockPos(x + 0, y + 2, z + 7), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(1), 3);
		...
		world.setBlockState(new BlockPos(x + 7, y + 2, z + 7), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(1), 3);
		...
		world.setBlockState(new BlockPos(x + 13, y + 2, z + 7), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(1), 3);
		world.setBlockState(new BlockPos(x + 0, y + 2, z + 8), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(1), 3);
		...
		world.setBlockState(new BlockPos(x + 12, y + 2, z + 8), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(1), 3);
		world.setBlockState(new BlockPos(x + 0, y + 2, z + 9), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(1), 3);
		...
		world.setBlockState(new BlockPos(x + 12, y + 2, z + 9), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(1), 3);
		world.setBlockState(new BlockPos(x + 1, y + 2, z + 10), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(1), 3);
		world.setBlockState(new BlockPos(x + 2, y + 2, z + 10), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(1), 3);
		world.setBlockState(new BlockPos(x + 3, y + 2, z + 10), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(1), 3);
		world.setBlockState(new BlockPos(x + 4, y + 2, z + 10), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(1), 3);
		...
		world.setBlockState(new BlockPos(x + 8, y + 2, z + 10), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(1), 3);
		world.setBlockState(new BlockPos(x + 9, y + 2, z + 10), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(1), 3);
		world.setBlockState(new BlockPos(x + 10, y + 2, z + 10), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(1), 3);
		world.setBlockState(new BlockPos(x + 11, y + 2, z + 10), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(1), 3);
		world.setBlockState(new BlockPos(x + 5, y + 2, z + 11), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(1), 3);
		world.setBlockState(new BlockPos(x + 6, y + 2, z + 11), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(1), 3);
		world.setBlockState(new BlockPos(x + 7, y + 2, z + 11), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(1), 3);
		world.setBlockState(new BlockPos(x + 5, y + 3, z + 0), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(1), 3);
		world.setBlockState(new BlockPos(x + 6, y + 3, z + 0), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(1), 3);
		world.setBlockState(new BlockPos(x + 7, y + 3, z + 0), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(1), 3);
		world.setBlockState(new BlockPos(x + 1, y + 3, z + 1), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(1), 3);
		world.setBlockState(new BlockPos(x + 2, y + 3, z + 1), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(1), 3);
		world.setBlockState(new BlockPos(x + 3, y + 3, z + 1), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(1), 3);
		world.setBlockState(new BlockPos(x + 4, y + 3, z + 1), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(1), 3);
		...
		world.setBlockState(new BlockPos(x + 8, y + 3, z + 1), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(1), 3);
		world.setBlockState(new BlockPos(x + 9, y + 3, z + 1), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(1), 3);
		world.setBlockState(new BlockPos(x + 10, y + 3, z + 1), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(1), 3);
		world.setBlockState(new BlockPos(x + 11, y + 3, z + 1), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(1), 3);
		world.setBlockState(new BlockPos(x + 0, y + 3, z + 2), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(1), 3);
		...
		world.setBlockState(new BlockPos(x + 12, y + 3, z + 2), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(1), 3);
		world.setBlockState(new BlockPos(x + 0, y + 3, z + 3), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(1), 3);
		...
		world.setBlockState(new BlockPos(x + 12, y + 3, z + 3), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(1), 3);
		world.setBlockState(new BlockPos(x + 0, y + 3, z + 4), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(1), 3);
		...
		world.setBlockState(new BlockPos(x + 7, y + 3, z + 4), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(1), 3);
		...
		world.setBlockState(new BlockPos(x + 13, y + 3, z + 4), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(1), 3);
		world.setBlockState(new BlockPos(x + 0, y + 3, z + 5), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(1), 3);
		...
		world.setBlockState(new BlockPos(x + 7, y + 3, z + 5), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(1), 3);
		...
		world.setBlockState(new BlockPos(x + 13, y + 3, z + 5), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(1), 3);
		world.setBlockState(new BlockPos(x + 0, y + 3, z + 6), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(1), 3);
		...
		world.setBlockState(new BlockPos(x + 7, y + 3, z + 6), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(1), 3);
		...
		world.setBlockState(new BlockPos(x + 13, y + 3, z + 6), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(1), 3);
		world.setBlockState(new BlockPos(x + 0, y + 3, z + 7), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(1), 3);
		...
		world.setBlockState(new BlockPos(x + 7, y + 3, z + 7), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(1), 3);
		...
		world.setBlockState(new BlockPos(x + 13, y + 3, z + 7), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(1), 3);
		world.setBlockState(new BlockPos(x + 0, y + 3, z + 8), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(1), 3);
		...
		world.setBlockState(new BlockPos(x + 12, y + 3, z + 8), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(1), 3);
		world.setBlockState(new BlockPos(x + 0, y + 3, z + 9), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(1), 3);
		...
		world.setBlockState(new BlockPos(x + 12, y + 3, z + 9), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(1), 3);
		world.setBlockState(new BlockPos(x + 1, y + 3, z + 10), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(1), 3);
		world.setBlockState(new BlockPos(x + 2, y + 3, z + 10), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(1), 3);
		world.setBlockState(new BlockPos(x + 3, y + 3, z + 10), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(1), 3);
		world.setBlockState(new BlockPos(x + 4, y + 3, z + 10), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(1), 3);
		...
		world.setBlockState(new BlockPos(x + 8, y + 3, z + 10), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(1), 3);
		world.setBlockState(new BlockPos(x + 9, y + 3, z + 10), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(1), 3);
		world.setBlockState(new BlockPos(x + 10, y + 3, z + 10), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(1), 3);
		world.setBlockState(new BlockPos(x + 11, y + 3, z + 10), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(1), 3);
		world.setBlockState(new BlockPos(x + 5, y + 3, z + 11), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(1), 3);
		world.setBlockState(new BlockPos(x + 6, y + 3, z + 11), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(1), 3);
		world.setBlockState(new BlockPos(x + 7, y + 3, z + 11), ExtraPlanets_Blocks.DECORATIVE_BLOCKS2.getStateFromMeta(1), 3);
