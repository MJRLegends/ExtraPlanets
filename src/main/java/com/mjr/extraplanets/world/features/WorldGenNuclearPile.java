...
public class WorldGenNuclearPile extends WorldGenerator {
	...
	public boolean generateStructure(World world, Random rand, int x, int y, int z) {
		...
		if (Config.ceres && Config.nuclearBomb) {
			world.setBlock(x + 3, y + 2, z + 3, ExtraPlanets_Blocks.nuclearBomb, 0, 3);
			world.setBlock(x + 3, y + 2, z + 4, ExtraPlanets_Blocks.nuclearBomb, 0, 3);
			world.setBlock(x + 3, y + 2, z + 5, ExtraPlanets_Blocks.nuclearBomb, 0, 3);
		}
