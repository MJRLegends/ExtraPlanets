...
public class WorldGenSatelliteTower extends WorldGenerator {
	...
	public boolean generateStructure(World world, Random rand, BlockPos position) {
		...
		int y = position.getY();
		int z = position.getZ();
		world.setBlockState(new BlockPos(x + 1, y + 0, z + 1), AsteroidBlocks.blockBasic.getDefaultState().withProperty(BlockBasicAsteroids.BASIC_TYPE, BlockBasicAsteroids.EnumBlockBasic.DECO), 3);
		world.setBlockState(new BlockPos(x + 2, y + 0, z + 1), AsteroidBlocks.blockBasic.getDefaultState().withProperty(BlockBasicAsteroids.BASIC_TYPE, BlockBasicAsteroids.EnumBlockBasic.DECO), 3);
		world.setBlockState(new BlockPos(x + 3, y + 0, z + 1), AsteroidBlocks.blockBasic.getDefaultState().withProperty(BlockBasicAsteroids.BASIC_TYPE, BlockBasicAsteroids.EnumBlockBasic.DECO), 3);
		world.setBlockState(new BlockPos(x + 4, y + 0, z + 1), AsteroidBlocks.blockBasic.getDefaultState().withProperty(BlockBasicAsteroids.BASIC_TYPE, BlockBasicAsteroids.EnumBlockBasic.DECO), 3);
		world.setBlockState(new BlockPos(x + 5, y + 0, z + 1), AsteroidBlocks.blockBasic.getDefaultState().withProperty(BlockBasicAsteroids.BASIC_TYPE, BlockBasicAsteroids.EnumBlockBasic.DECO), 3);
		world.setBlockState(new BlockPos(x + 6, y + 0, z + 1), AsteroidBlocks.blockBasic.getDefaultState().withProperty(BlockBasicAsteroids.BASIC_TYPE, BlockBasicAsteroids.EnumBlockBasic.DECO), 3);
		world.setBlockState(new BlockPos(x + 1, y + 0, z + 2), AsteroidBlocks.blockBasic.getDefaultState().withProperty(BlockBasicAsteroids.BASIC_TYPE, BlockBasicAsteroids.EnumBlockBasic.DECO), 3);
		...
		world.setBlockState(new BlockPos(x + 6, y + 0, z + 2), AsteroidBlocks.blockBasic.getDefaultState().withProperty(BlockBasicAsteroids.BASIC_TYPE, BlockBasicAsteroids.EnumBlockBasic.DECO), 3);
		world.setBlockState(new BlockPos(x + 1, y + 0, z + 3), AsteroidBlocks.blockBasic.getDefaultState().withProperty(BlockBasicAsteroids.BASIC_TYPE, BlockBasicAsteroids.EnumBlockBasic.DECO), 3);
		...
		world.setBlockState(new BlockPos(x + 6, y + 0, z + 3), AsteroidBlocks.blockBasic.getDefaultState().withProperty(BlockBasicAsteroids.BASIC_TYPE, BlockBasicAsteroids.EnumBlockBasic.DECO), 3);
		world.setBlockState(new BlockPos(x + 1, y + 0, z + 4), AsteroidBlocks.blockBasic.getDefaultState().withProperty(BlockBasicAsteroids.BASIC_TYPE, BlockBasicAsteroids.EnumBlockBasic.DECO), 3);
		...
		world.setBlockState(new BlockPos(x + 6, y + 0, z + 4), AsteroidBlocks.blockBasic.getDefaultState().withProperty(BlockBasicAsteroids.BASIC_TYPE, BlockBasicAsteroids.EnumBlockBasic.DECO), 3);
		world.setBlockState(new BlockPos(x + 1, y + 0, z + 5), AsteroidBlocks.blockBasic.getDefaultState().withProperty(BlockBasicAsteroids.BASIC_TYPE, BlockBasicAsteroids.EnumBlockBasic.DECO), 3);
		...
		world.setBlockState(new BlockPos(x + 6, y + 0, z + 5), AsteroidBlocks.blockBasic.getDefaultState().withProperty(BlockBasicAsteroids.BASIC_TYPE, BlockBasicAsteroids.EnumBlockBasic.DECO), 3);
		world.setBlockState(new BlockPos(x + 1, y + 0, z + 6), AsteroidBlocks.blockBasic.getDefaultState().withProperty(BlockBasicAsteroids.BASIC_TYPE, BlockBasicAsteroids.EnumBlockBasic.DECO), 3);
		world.setBlockState(new BlockPos(x + 2, y + 0, z + 6), AsteroidBlocks.blockBasic.getDefaultState().withProperty(BlockBasicAsteroids.BASIC_TYPE, BlockBasicAsteroids.EnumBlockBasic.DECO), 3);
		world.setBlockState(new BlockPos(x + 3, y + 0, z + 6), AsteroidBlocks.blockBasic.getDefaultState().withProperty(BlockBasicAsteroids.BASIC_TYPE, BlockBasicAsteroids.EnumBlockBasic.DECO), 3);
		world.setBlockState(new BlockPos(x + 4, y + 0, z + 6), AsteroidBlocks.blockBasic.getDefaultState().withProperty(BlockBasicAsteroids.BASIC_TYPE, BlockBasicAsteroids.EnumBlockBasic.DECO), 3);
		world.setBlockState(new BlockPos(x + 5, y + 0, z + 6), AsteroidBlocks.blockBasic.getDefaultState().withProperty(BlockBasicAsteroids.BASIC_TYPE, BlockBasicAsteroids.EnumBlockBasic.DECO), 3);
		world.setBlockState(new BlockPos(x + 6, y + 0, z + 6), AsteroidBlocks.blockBasic.getDefaultState().withProperty(BlockBasicAsteroids.BASIC_TYPE, BlockBasicAsteroids.EnumBlockBasic.DECO), 3);
		...
		world.setBlockState(new BlockPos(x + 0, y + 14, z + 0), AsteroidBlocks.blockBasic.getDefaultState().withProperty(BlockBasicAsteroids.BASIC_TYPE, BlockBasicAsteroids.EnumBlockBasic.DECO), 3);
		world.setBlockState(new BlockPos(x + 1, y + 14, z + 0), AsteroidBlocks.blockBasic.getDefaultState().withProperty(BlockBasicAsteroids.BASIC_TYPE, BlockBasicAsteroids.EnumBlockBasic.DECO), 3);
		world.setBlockState(new BlockPos(x + 2, y + 14, z + 0), AsteroidBlocks.blockBasic.getDefaultState().withProperty(BlockBasicAsteroids.BASIC_TYPE, BlockBasicAsteroids.EnumBlockBasic.DECO), 3);
		world.setBlockState(new BlockPos(x + 3, y + 14, z + 0), AsteroidBlocks.blockBasic.getDefaultState().withProperty(BlockBasicAsteroids.BASIC_TYPE, BlockBasicAsteroids.EnumBlockBasic.DECO), 3);
		world.setBlockState(new BlockPos(x + 4, y + 14, z + 0), AsteroidBlocks.blockBasic.getDefaultState().withProperty(BlockBasicAsteroids.BASIC_TYPE, BlockBasicAsteroids.EnumBlockBasic.DECO), 3);
		world.setBlockState(new BlockPos(x + 5, y + 14, z + 0), AsteroidBlocks.blockBasic.getDefaultState().withProperty(BlockBasicAsteroids.BASIC_TYPE, BlockBasicAsteroids.EnumBlockBasic.DECO), 3);
		world.setBlockState(new BlockPos(x + 6, y + 14, z + 0), AsteroidBlocks.blockBasic.getDefaultState().withProperty(BlockBasicAsteroids.BASIC_TYPE, BlockBasicAsteroids.EnumBlockBasic.DECO), 3);
		world.setBlockState(new BlockPos(x + 7, y + 14, z + 0), AsteroidBlocks.blockBasic.getDefaultState().withProperty(BlockBasicAsteroids.BASIC_TYPE, BlockBasicAsteroids.EnumBlockBasic.DECO), 3);
		world.setBlockState(new BlockPos(x + 0, y + 14, z + 1), AsteroidBlocks.blockBasic.getDefaultState().withProperty(BlockBasicAsteroids.BASIC_TYPE, BlockBasicAsteroids.EnumBlockBasic.DECO), 3);
		world.setBlockState(new BlockPos(x + 1, y + 14, z + 1), GCBlocks.wallGC.getStateFromMeta(3), 3);
		world.setBlockState(new BlockPos(x + 2, y + 14, z + 1), AsteroidBlocks.blockBasic.getDefaultState().withProperty(BlockBasicAsteroids.BASIC_TYPE, BlockBasicAsteroids.EnumBlockBasic.DECO), 3);
		...
		world.setBlockState(new BlockPos(x + 5, y + 14, z + 1), AsteroidBlocks.blockBasic.getDefaultState().withProperty(BlockBasicAsteroids.BASIC_TYPE, BlockBasicAsteroids.EnumBlockBasic.DECO), 3);
		world.setBlockState(new BlockPos(x + 6, y + 14, z + 1), GCBlocks.wallGC.getStateFromMeta(3), 3);
		world.setBlockState(new BlockPos(x + 7, y + 14, z + 1), AsteroidBlocks.blockBasic.getDefaultState().withProperty(BlockBasicAsteroids.BASIC_TYPE, BlockBasicAsteroids.EnumBlockBasic.DECO), 3);
		world.setBlockState(new BlockPos(x + 0, y + 14, z + 2), AsteroidBlocks.blockBasic.getDefaultState().withProperty(BlockBasicAsteroids.BASIC_TYPE, BlockBasicAsteroids.EnumBlockBasic.DECO), 3);
		world.setBlockState(new BlockPos(x + 1, y + 14, z + 2), AsteroidBlocks.blockBasic.getDefaultState().withProperty(BlockBasicAsteroids.BASIC_TYPE, BlockBasicAsteroids.EnumBlockBasic.DECO), 3);
		...
		world.setBlockState(new BlockPos(x + 6, y + 14, z + 2), AsteroidBlocks.blockBasic.getDefaultState().withProperty(BlockBasicAsteroids.BASIC_TYPE, BlockBasicAsteroids.EnumBlockBasic.DECO), 3);
		world.setBlockState(new BlockPos(x + 7, y + 14, z + 2), AsteroidBlocks.blockBasic.getDefaultState().withProperty(BlockBasicAsteroids.BASIC_TYPE, BlockBasicAsteroids.EnumBlockBasic.DECO), 3);
		world.setBlockState(new BlockPos(x + 0, y + 14, z + 3), AsteroidBlocks.blockBasic.getDefaultState().withProperty(BlockBasicAsteroids.BASIC_TYPE, BlockBasicAsteroids.EnumBlockBasic.DECO), 3);
		...
		world.setBlockState(new BlockPos(x + 7, y + 14, z + 3), AsteroidBlocks.blockBasic.getDefaultState().withProperty(BlockBasicAsteroids.BASIC_TYPE, BlockBasicAsteroids.EnumBlockBasic.DECO), 3);
		world.setBlockState(new BlockPos(x + 0, y + 14, z + 4), AsteroidBlocks.blockBasic.getDefaultState().withProperty(BlockBasicAsteroids.BASIC_TYPE, BlockBasicAsteroids.EnumBlockBasic.DECO), 3);
		...
		world.setBlockState(new BlockPos(x + 7, y + 14, z + 4), AsteroidBlocks.blockBasic.getDefaultState().withProperty(BlockBasicAsteroids.BASIC_TYPE, BlockBasicAsteroids.EnumBlockBasic.DECO), 3);
		world.setBlockState(new BlockPos(x + 0, y + 14, z + 5), AsteroidBlocks.blockBasic.getDefaultState().withProperty(BlockBasicAsteroids.BASIC_TYPE, BlockBasicAsteroids.EnumBlockBasic.DECO), 3);
		world.setBlockState(new BlockPos(x + 1, y + 14, z + 5), AsteroidBlocks.blockBasic.getDefaultState().withProperty(BlockBasicAsteroids.BASIC_TYPE, BlockBasicAsteroids.EnumBlockBasic.DECO), 3);
		...
		world.setBlockState(new BlockPos(x + 6, y + 14, z + 5), AsteroidBlocks.blockBasic.getDefaultState().withProperty(BlockBasicAsteroids.BASIC_TYPE, BlockBasicAsteroids.EnumBlockBasic.DECO), 3);
		world.setBlockState(new BlockPos(x + 7, y + 14, z + 5), AsteroidBlocks.blockBasic.getDefaultState().withProperty(BlockBasicAsteroids.BASIC_TYPE, BlockBasicAsteroids.EnumBlockBasic.DECO), 3);
		world.setBlockState(new BlockPos(x + 0, y + 14, z + 6), AsteroidBlocks.blockBasic.getDefaultState().withProperty(BlockBasicAsteroids.BASIC_TYPE, BlockBasicAsteroids.EnumBlockBasic.DECO), 3);
		world.setBlockState(new BlockPos(x + 1, y + 14, z + 6), GCBlocks.wallGC.getStateFromMeta(3), 3);
		world.setBlockState(new BlockPos(x + 2, y + 14, z + 6), AsteroidBlocks.blockBasic.getDefaultState().withProperty(BlockBasicAsteroids.BASIC_TYPE, BlockBasicAsteroids.EnumBlockBasic.DECO), 3);
		...
		world.setBlockState(new BlockPos(x + 5, y + 14, z + 6), AsteroidBlocks.blockBasic.getDefaultState().withProperty(BlockBasicAsteroids.BASIC_TYPE, BlockBasicAsteroids.EnumBlockBasic.DECO), 3);
		world.setBlockState(new BlockPos(x + 6, y + 14, z + 6), GCBlocks.wallGC.getStateFromMeta(3), 3);
		world.setBlockState(new BlockPos(x + 7, y + 14, z + 6), AsteroidBlocks.blockBasic.getDefaultState().withProperty(BlockBasicAsteroids.BASIC_TYPE, BlockBasicAsteroids.EnumBlockBasic.DECO), 3);
		world.setBlockState(new BlockPos(x + 0, y + 14, z + 7), AsteroidBlocks.blockBasic.getDefaultState().withProperty(BlockBasicAsteroids.BASIC_TYPE, BlockBasicAsteroids.EnumBlockBasic.DECO), 3);
		world.setBlockState(new BlockPos(x + 1, y + 14, z + 7), AsteroidBlocks.blockBasic.getDefaultState().withProperty(BlockBasicAsteroids.BASIC_TYPE, BlockBasicAsteroids.EnumBlockBasic.DECO), 3);
		world.setBlockState(new BlockPos(x + 2, y + 14, z + 7), AsteroidBlocks.blockBasic.getDefaultState().withProperty(BlockBasicAsteroids.BASIC_TYPE, BlockBasicAsteroids.EnumBlockBasic.DECO), 3);
		world.setBlockState(new BlockPos(x + 3, y + 14, z + 7), AsteroidBlocks.blockBasic.getDefaultState().withProperty(BlockBasicAsteroids.BASIC_TYPE, BlockBasicAsteroids.EnumBlockBasic.DECO), 3);
		world.setBlockState(new BlockPos(x + 4, y + 14, z + 7), AsteroidBlocks.blockBasic.getDefaultState().withProperty(BlockBasicAsteroids.BASIC_TYPE, BlockBasicAsteroids.EnumBlockBasic.DECO), 3);
		world.setBlockState(new BlockPos(x + 5, y + 14, z + 7), AsteroidBlocks.blockBasic.getDefaultState().withProperty(BlockBasicAsteroids.BASIC_TYPE, BlockBasicAsteroids.EnumBlockBasic.DECO), 3);
		world.setBlockState(new BlockPos(x + 6, y + 14, z + 7), AsteroidBlocks.blockBasic.getDefaultState().withProperty(BlockBasicAsteroids.BASIC_TYPE, BlockBasicAsteroids.EnumBlockBasic.DECO), 3);
		world.setBlockState(new BlockPos(x + 7, y + 14, z + 7), AsteroidBlocks.blockBasic.getDefaultState().withProperty(BlockBasicAsteroids.BASIC_TYPE, BlockBasicAsteroids.EnumBlockBasic.DECO), 3);
		...
		world.setBlockState(new BlockPos(x + 1, y + 17, z + 1), GCBlocks.glowstoneTorch.getDefaultState().withProperty(BlockGlowstoneTorch.FACING, EnumFacing.UP), 3);
		world.setBlockState(new BlockPos(x + 6, y + 17, z + 1), GCBlocks.glowstoneTorch.getDefaultState().withProperty(BlockGlowstoneTorch.FACING, EnumFacing.UP), 3);
		...
		world.setBlockState(new BlockPos(x + 1, y + 17, z + 6), GCBlocks.glowstoneTorch.getDefaultState().withProperty(BlockGlowstoneTorch.FACING, EnumFacing.UP), 3);
		world.setBlockState(new BlockPos(x + 6, y + 17, z + 6), GCBlocks.glowstoneTorch.getDefaultState().withProperty(BlockGlowstoneTorch.FACING, EnumFacing.UP), 3);
		...
		world.setBlockState(new BlockPos(x + 3, y + 19, z + 2), AsteroidBlocks.blockBasic.getDefaultState().withProperty(BlockBasicAsteroids.BASIC_TYPE, BlockBasicAsteroids.EnumBlockBasic.DECO), 3);
		world.setBlockState(new BlockPos(x + 4, y + 19, z + 2), AsteroidBlocks.blockBasic.getDefaultState().withProperty(BlockBasicAsteroids.BASIC_TYPE, BlockBasicAsteroids.EnumBlockBasic.DECO), 3);
		world.setBlockState(new BlockPos(x + 5, y + 19, z + 2), GCBlocks.wallGC.getStateFromMeta(3), 3);
		world.setBlockState(new BlockPos(x + 2, y + 19, z + 3), AsteroidBlocks.blockBasic.getDefaultState().withProperty(BlockBasicAsteroids.BASIC_TYPE, BlockBasicAsteroids.EnumBlockBasic.DECO), 3);
		world.setBlockState(new BlockPos(x + 3, y + 19, z + 3), AsteroidBlocks.blockBasic.getDefaultState().withProperty(BlockBasicAsteroids.BASIC_TYPE, BlockBasicAsteroids.EnumBlockBasic.DECO), 3);
		world.setBlockState(new BlockPos(x + 4, y + 19, z + 3), AsteroidBlocks.blockBasic.getDefaultState().withProperty(BlockBasicAsteroids.BASIC_TYPE, BlockBasicAsteroids.EnumBlockBasic.DECO), 3);
		world.setBlockState(new BlockPos(x + 5, y + 19, z + 3), AsteroidBlocks.blockBasic.getDefaultState().withProperty(BlockBasicAsteroids.BASIC_TYPE, BlockBasicAsteroids.EnumBlockBasic.DECO), 3);
		world.setBlockState(new BlockPos(x + 2, y + 19, z + 4), AsteroidBlocks.blockBasic.getDefaultState().withProperty(BlockBasicAsteroids.BASIC_TYPE, BlockBasicAsteroids.EnumBlockBasic.DECO), 3);
		world.setBlockState(new BlockPos(x + 3, y + 19, z + 4), AsteroidBlocks.blockBasic.getDefaultState().withProperty(BlockBasicAsteroids.BASIC_TYPE, BlockBasicAsteroids.EnumBlockBasic.DECO), 3);
		world.setBlockState(new BlockPos(x + 4, y + 19, z + 4), AsteroidBlocks.blockBasic.getDefaultState().withProperty(BlockBasicAsteroids.BASIC_TYPE, BlockBasicAsteroids.EnumBlockBasic.DECO), 3);
		world.setBlockState(new BlockPos(x + 5, y + 19, z + 4), AsteroidBlocks.blockBasic.getDefaultState().withProperty(BlockBasicAsteroids.BASIC_TYPE, BlockBasicAsteroids.EnumBlockBasic.DECO), 3);
		world.setBlockState(new BlockPos(x + 2, y + 19, z + 5), GCBlocks.wallGC.getStateFromMeta(3), 3);
		world.setBlockState(new BlockPos(x + 3, y + 19, z + 5), AsteroidBlocks.blockBasic.getDefaultState().withProperty(BlockBasicAsteroids.BASIC_TYPE, BlockBasicAsteroids.EnumBlockBasic.DECO), 3);
		world.setBlockState(new BlockPos(x + 4, y + 19, z + 5), AsteroidBlocks.blockBasic.getDefaultState().withProperty(BlockBasicAsteroids.BASIC_TYPE, BlockBasicAsteroids.EnumBlockBasic.DECO), 3);
