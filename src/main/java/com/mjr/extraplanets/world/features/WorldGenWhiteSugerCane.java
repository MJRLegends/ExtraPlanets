	...
	public boolean generate(World world, Random rand, BlockPos position) {
		for (int i = 0; i < 20; ++i) {
			...
			if (world.isAirBlock(blockpos)) {
				...
				if (world.getBlockState(blockpos1.west()).getBlock().getMaterial() == ExtraPlanets_Fluids.CHOCOLATE_MATERIAL || world.getBlockState(blockpos1.east()).getBlock().getMaterial() == ExtraPlanets_Fluids.CHOCOLATE_MATERIAL
						|| world.getBlockState(blockpos1.north()).getBlock().getMaterial() == ExtraPlanets_Fluids.CHOCOLATE_MATERIAL || world.getBlockState(blockpos1.south()).getBlock().getMaterial() == ExtraPlanets_Fluids.CHOCOLATE_MATERIAL) {
