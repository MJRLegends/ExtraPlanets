...
public class WorldGenYellowHut extends WorldGenerator {
	...
	public boolean generate(World world, Random rand, BlockPos position) {
		if (WorldGenUtilities.checkValidSpawn(world, position, 5) == false)
			...
			if (Config.DEBUG_MODE)
				MessageUtilities.debugMessageToLog(Constants.modID, "Spawning Yellow Hut at (x, y, z)" + position.toString());
	...
	public boolean generateStructure(World world, Random rand, BlockPos position) {
		...
		world.setBlockState(new BlockPos(x + 1, y + 0, z + 1), ExtraPlanets_Blocks.KEPLER22B_MAPLE_LOG.getDefaultState().withProperty(BlockKepler22bMapleTreeLog.VARIANT, BlockKepler22bMapleTreeLog.EnumType.MAPLE_YELLOW), 3);
		...
		world.setBlockState(new BlockPos(x + 5, y + 0, z + 1), ExtraPlanets_Blocks.KEPLER22B_MAPLE_LOG.getDefaultState().withProperty(BlockKepler22bMapleTreeLog.VARIANT, BlockKepler22bMapleTreeLog.EnumType.MAPLE_YELLOW), 3);
		...
		world.setBlockState(new BlockPos(x + 1, y + 0, z + 6), ExtraPlanets_Blocks.KEPLER22B_MAPLE_LOG.getDefaultState().withProperty(BlockKepler22bMapleTreeLog.VARIANT, BlockKepler22bMapleTreeLog.EnumType.MAPLE_YELLOW), 3);
		...
		world.setBlockState(new BlockPos(x + 5, y + 0, z + 6), ExtraPlanets_Blocks.KEPLER22B_MAPLE_LOG.getDefaultState().withProperty(BlockKepler22bMapleTreeLog.VARIANT, BlockKepler22bMapleTreeLog.EnumType.MAPLE_YELLOW), 3);
		...
		world.setBlockState(new BlockPos(x + 1, y + 1, z + 1), ExtraPlanets_Blocks.KEPLER22B_MAPLE_LOG.getDefaultState().withProperty(BlockKepler22bMapleTreeLog.VARIANT, BlockKepler22bMapleTreeLog.EnumType.MAPLE_YELLOW), 3);
		...
		world.setBlockState(new BlockPos(x + 5, y + 1, z + 1), ExtraPlanets_Blocks.KEPLER22B_MAPLE_LOG.getDefaultState().withProperty(BlockKepler22bMapleTreeLog.VARIANT, BlockKepler22bMapleTreeLog.EnumType.MAPLE_YELLOW), 3);
		...
		world.setBlockState(new BlockPos(x + 1, y + 1, z + 6), ExtraPlanets_Blocks.KEPLER22B_MAPLE_LOG.getDefaultState().withProperty(BlockKepler22bMapleTreeLog.VARIANT, BlockKepler22bMapleTreeLog.EnumType.MAPLE_YELLOW), 3);
		...
		world.setBlockState(new BlockPos(x + 5, y + 1, z + 6), ExtraPlanets_Blocks.KEPLER22B_MAPLE_LOG.getDefaultState().withProperty(BlockKepler22bMapleTreeLog.VARIANT, BlockKepler22bMapleTreeLog.EnumType.MAPLE_YELLOW), 3);
		...
		world.setBlockState(new BlockPos(x + 1, y + 2, z + 1), ExtraPlanets_Blocks.KEPLER22B_MAPLE_LOG.getDefaultState().withProperty(BlockKepler22bMapleTreeLog.VARIANT, BlockKepler22bMapleTreeLog.EnumType.MAPLE_YELLOW), 3);
		...
		world.setBlockState(new BlockPos(x + 5, y + 2, z + 1), ExtraPlanets_Blocks.KEPLER22B_MAPLE_LOG.getDefaultState().withProperty(BlockKepler22bMapleTreeLog.VARIANT, BlockKepler22bMapleTreeLog.EnumType.MAPLE_YELLOW), 3);
		...
		world.setBlockState(new BlockPos(x + 2, y + 2, z + 2), Blocks.WOODEN_SLAB.getDefaultState().withProperty(BlockWoodSlab.VARIANT, BlockPlanks.EnumType.OAK).withProperty(BlockWoodSlab.HALF, BlockSlab.EnumBlockHalf.TOP), 3);
		world.setBlockState(new BlockPos(x + 3, y + 2, z + 2), Blocks.WOODEN_SLAB.getDefaultState().withProperty(BlockWoodSlab.VARIANT, BlockPlanks.EnumType.OAK).withProperty(BlockWoodSlab.HALF, BlockSlab.EnumBlockHalf.TOP), 3);
		world.setBlockState(new BlockPos(x + 4, y + 2, z + 2), Blocks.WOODEN_SLAB.getDefaultState().withProperty(BlockWoodSlab.VARIANT, BlockPlanks.EnumType.OAK).withProperty(BlockWoodSlab.HALF, BlockSlab.EnumBlockHalf.TOP), 3);
		...
		world.setBlockState(new BlockPos(x + 2, y + 2, z + 3), Blocks.WOODEN_SLAB.getDefaultState().withProperty(BlockWoodSlab.VARIANT, BlockPlanks.EnumType.OAK).withProperty(BlockWoodSlab.HALF, BlockSlab.EnumBlockHalf.TOP), 3);
		world.setBlockState(new BlockPos(x + 3, y + 2, z + 3), Blocks.WOODEN_SLAB.getDefaultState().withProperty(BlockWoodSlab.VARIANT, BlockPlanks.EnumType.OAK).withProperty(BlockWoodSlab.HALF, BlockSlab.EnumBlockHalf.TOP), 3);
		world.setBlockState(new BlockPos(x + 4, y + 2, z + 3), Blocks.WOODEN_SLAB.getDefaultState().withProperty(BlockWoodSlab.VARIANT, BlockPlanks.EnumType.OAK).withProperty(BlockWoodSlab.HALF, BlockSlab.EnumBlockHalf.TOP), 3);
		...
		world.setBlockState(new BlockPos(x + 2, y + 2, z + 4), Blocks.WOODEN_SLAB.getDefaultState().withProperty(BlockWoodSlab.VARIANT, BlockPlanks.EnumType.OAK).withProperty(BlockWoodSlab.HALF, BlockSlab.EnumBlockHalf.TOP), 3);
		world.setBlockState(new BlockPos(x + 3, y + 2, z + 4), Blocks.WOODEN_SLAB.getDefaultState().withProperty(BlockWoodSlab.VARIANT, BlockPlanks.EnumType.OAK).withProperty(BlockWoodSlab.HALF, BlockSlab.EnumBlockHalf.TOP), 3);
		world.setBlockState(new BlockPos(x + 4, y + 2, z + 4), Blocks.WOODEN_SLAB.getDefaultState().withProperty(BlockWoodSlab.VARIANT, BlockPlanks.EnumType.OAK).withProperty(BlockWoodSlab.HALF, BlockSlab.EnumBlockHalf.TOP), 3);
		...
		world.setBlockState(new BlockPos(x + 2, y + 2, z + 5), Blocks.WOODEN_SLAB.getDefaultState().withProperty(BlockWoodSlab.VARIANT, BlockPlanks.EnumType.OAK).withProperty(BlockWoodSlab.HALF, BlockSlab.EnumBlockHalf.TOP), 3);
		world.setBlockState(new BlockPos(x + 3, y + 2, z + 5), Blocks.PLANKS.getStateFromMeta(0), 3);
		world.setBlockState(new BlockPos(x + 4, y + 2, z + 5), Blocks.WOODEN_SLAB.getDefaultState().withProperty(BlockWoodSlab.VARIANT, BlockPlanks.EnumType.OAK).withProperty(BlockWoodSlab.HALF, BlockSlab.EnumBlockHalf.TOP), 3);
		...
		world.setBlockState(new BlockPos(x + 1, y + 2, z + 6), ExtraPlanets_Blocks.KEPLER22B_MAPLE_LOG.getDefaultState().withProperty(BlockKepler22bMapleTreeLog.VARIANT, BlockKepler22bMapleTreeLog.EnumType.MAPLE_YELLOW), 3);
		...
		world.setBlockState(new BlockPos(x + 5, y + 2, z + 6), ExtraPlanets_Blocks.KEPLER22B_MAPLE_LOG.getDefaultState().withProperty(BlockKepler22bMapleTreeLog.VARIANT, BlockKepler22bMapleTreeLog.EnumType.MAPLE_YELLOW), 3);
		...
		world.setBlockState(new BlockPos(x + 1, y + 3, z + 1), ExtraPlanets_Blocks.KEPLER22B_MAPLE_LOG.getDefaultState().withProperty(BlockKepler22bMapleTreeLog.VARIANT, BlockKepler22bMapleTreeLog.EnumType.MAPLE_YELLOW), 3);
		...
		world.setBlockState(new BlockPos(x + 5, y + 3, z + 1), ExtraPlanets_Blocks.KEPLER22B_MAPLE_LOG.getDefaultState().withProperty(BlockKepler22bMapleTreeLog.VARIANT, BlockKepler22bMapleTreeLog.EnumType.MAPLE_YELLOW), 3);
		...
		world.setBlockState(new BlockPos(x + 1, y + 3, z + 6), ExtraPlanets_Blocks.KEPLER22B_MAPLE_LOG.getDefaultState().withProperty(BlockKepler22bMapleTreeLog.VARIANT, BlockKepler22bMapleTreeLog.EnumType.MAPLE_YELLOW), 3);
		...
		world.setBlockState(new BlockPos(x + 5, y + 3, z + 6), ExtraPlanets_Blocks.KEPLER22B_MAPLE_LOG.getDefaultState().withProperty(BlockKepler22bMapleTreeLog.VARIANT, BlockKepler22bMapleTreeLog.EnumType.MAPLE_YELLOW), 3);
		...
		world.setBlockState(new BlockPos(x + 1, y + 4, z + 1), ExtraPlanets_Blocks.KEPLER22B_MAPLE_LOG.getDefaultState().withProperty(BlockKepler22bMapleTreeLog.VARIANT, BlockKepler22bMapleTreeLog.EnumType.MAPLE_YELLOW), 3);
		...
		world.setBlockState(new BlockPos(x + 5, y + 4, z + 1), ExtraPlanets_Blocks.KEPLER22B_MAPLE_LOG.getDefaultState().withProperty(BlockKepler22bMapleTreeLog.VARIANT, BlockKepler22bMapleTreeLog.EnumType.MAPLE_YELLOW), 3);
		...
		world.setBlockState(new BlockPos(x + 1, y + 4, z + 6), ExtraPlanets_Blocks.KEPLER22B_MAPLE_LOG.getDefaultState().withProperty(BlockKepler22bMapleTreeLog.VARIANT, BlockKepler22bMapleTreeLog.EnumType.MAPLE_YELLOW), 3);
		...
		world.setBlockState(new BlockPos(x + 5, y + 4, z + 6), ExtraPlanets_Blocks.KEPLER22B_MAPLE_LOG.getDefaultState().withProperty(BlockKepler22bMapleTreeLog.VARIANT, BlockKepler22bMapleTreeLog.EnumType.MAPLE_YELLOW), 3);
		...
		world.setBlockState(new BlockPos(x + 1, y + 5, z + 1), ExtraPlanets_Blocks.KEPLER22B_MAPLE_LOG.getDefaultState().withProperty(BlockKepler22bMapleTreeLog.VARIANT, BlockKepler22bMapleTreeLog.EnumType.MAPLE_YELLOW), 3);
		...
		world.setBlockState(new BlockPos(x + 5, y + 5, z + 1), ExtraPlanets_Blocks.KEPLER22B_MAPLE_LOG.getDefaultState().withProperty(BlockKepler22bMapleTreeLog.VARIANT, BlockKepler22bMapleTreeLog.EnumType.MAPLE_YELLOW), 3);
		...
		world.setBlockState(new BlockPos(x + 1, y + 5, z + 6), ExtraPlanets_Blocks.KEPLER22B_MAPLE_LOG.getDefaultState().withProperty(BlockKepler22bMapleTreeLog.VARIANT, BlockKepler22bMapleTreeLog.EnumType.MAPLE_YELLOW), 3);
		...
		world.setBlockState(new BlockPos(x + 5, y + 5, z + 6), ExtraPlanets_Blocks.KEPLER22B_MAPLE_LOG.getDefaultState().withProperty(BlockKepler22bMapleTreeLog.VARIANT, BlockKepler22bMapleTreeLog.EnumType.MAPLE_YELLOW), 3);
		...
		world.setBlockState(new BlockPos(x + 1, y + 6, z + 1), Blocks.WOODEN_SLAB.getDefaultState().withProperty(BlockWoodSlab.VARIANT, BlockPlanks.EnumType.OAK).withProperty(BlockWoodSlab.HALF, BlockSlab.EnumBlockHalf.BOTTOM), 3);
		world.setBlockState(new BlockPos(x + 2, y + 6, z + 1), Blocks.WOODEN_SLAB.getDefaultState().withProperty(BlockWoodSlab.VARIANT, BlockPlanks.EnumType.OAK).withProperty(BlockWoodSlab.HALF, BlockSlab.EnumBlockHalf.BOTTOM), 3);
		world.setBlockState(new BlockPos(x + 3, y + 6, z + 1), Blocks.WOODEN_SLAB.getDefaultState().withProperty(BlockWoodSlab.VARIANT, BlockPlanks.EnumType.OAK).withProperty(BlockWoodSlab.HALF, BlockSlab.EnumBlockHalf.BOTTOM), 3);
		world.setBlockState(new BlockPos(x + 4, y + 6, z + 1), Blocks.WOODEN_SLAB.getDefaultState().withProperty(BlockWoodSlab.VARIANT, BlockPlanks.EnumType.OAK).withProperty(BlockWoodSlab.HALF, BlockSlab.EnumBlockHalf.BOTTOM), 3);
		world.setBlockState(new BlockPos(x + 5, y + 6, z + 1), Blocks.WOODEN_SLAB.getDefaultState().withProperty(BlockWoodSlab.VARIANT, BlockPlanks.EnumType.OAK).withProperty(BlockWoodSlab.HALF, BlockSlab.EnumBlockHalf.BOTTOM), 3);
		...
		world.setBlockState(new BlockPos(x + 1, y + 6, z + 2), Blocks.WOODEN_SLAB.getDefaultState().withProperty(BlockWoodSlab.VARIANT, BlockPlanks.EnumType.OAK).withProperty(BlockWoodSlab.HALF, BlockSlab.EnumBlockHalf.BOTTOM), 3);
		world.setBlockState(new BlockPos(x + 2, y + 6, z + 2), Blocks.WOODEN_SLAB.getDefaultState().withProperty(BlockWoodSlab.VARIANT, BlockPlanks.EnumType.OAK).withProperty(BlockWoodSlab.HALF, BlockSlab.EnumBlockHalf.BOTTOM), 3);
		world.setBlockState(new BlockPos(x + 3, y + 6, z + 2), Blocks.WOODEN_SLAB.getDefaultState().withProperty(BlockWoodSlab.VARIANT, BlockPlanks.EnumType.OAK).withProperty(BlockWoodSlab.HALF, BlockSlab.EnumBlockHalf.BOTTOM), 3);
		world.setBlockState(new BlockPos(x + 4, y + 6, z + 2), Blocks.WOODEN_SLAB.getDefaultState().withProperty(BlockWoodSlab.VARIANT, BlockPlanks.EnumType.OAK).withProperty(BlockWoodSlab.HALF, BlockSlab.EnumBlockHalf.BOTTOM), 3);
		world.setBlockState(new BlockPos(x + 5, y + 6, z + 2), Blocks.WOODEN_SLAB.getDefaultState().withProperty(BlockWoodSlab.VARIANT, BlockPlanks.EnumType.OAK).withProperty(BlockWoodSlab.HALF, BlockSlab.EnumBlockHalf.BOTTOM), 3);
		...
		world.setBlockState(new BlockPos(x + 1, y + 6, z + 3), Blocks.WOODEN_SLAB.getDefaultState().withProperty(BlockWoodSlab.VARIANT, BlockPlanks.EnumType.OAK).withProperty(BlockWoodSlab.HALF, BlockSlab.EnumBlockHalf.BOTTOM), 3);
		world.setBlockState(new BlockPos(x + 2, y + 6, z + 3), Blocks.WOODEN_SLAB.getDefaultState().withProperty(BlockWoodSlab.VARIANT, BlockPlanks.EnumType.OAK).withProperty(BlockWoodSlab.HALF, BlockSlab.EnumBlockHalf.BOTTOM), 3);
		world.setBlockState(new BlockPos(x + 3, y + 6, z + 3), Blocks.WOODEN_SLAB.getDefaultState().withProperty(BlockWoodSlab.VARIANT, BlockPlanks.EnumType.OAK).withProperty(BlockWoodSlab.HALF, BlockSlab.EnumBlockHalf.BOTTOM), 3);
		world.setBlockState(new BlockPos(x + 4, y + 6, z + 3), Blocks.WOODEN_SLAB.getDefaultState().withProperty(BlockWoodSlab.VARIANT, BlockPlanks.EnumType.OAK).withProperty(BlockWoodSlab.HALF, BlockSlab.EnumBlockHalf.BOTTOM), 3);
		world.setBlockState(new BlockPos(x + 5, y + 6, z + 3), Blocks.WOODEN_SLAB.getDefaultState().withProperty(BlockWoodSlab.VARIANT, BlockPlanks.EnumType.OAK).withProperty(BlockWoodSlab.HALF, BlockSlab.EnumBlockHalf.BOTTOM), 3);
		...
		world.setBlockState(new BlockPos(x + 1, y + 6, z + 4), Blocks.WOODEN_SLAB.getDefaultState().withProperty(BlockWoodSlab.VARIANT, BlockPlanks.EnumType.OAK).withProperty(BlockWoodSlab.HALF, BlockSlab.EnumBlockHalf.BOTTOM), 3);
		world.setBlockState(new BlockPos(x + 2, y + 6, z + 4), Blocks.WOODEN_SLAB.getDefaultState().withProperty(BlockWoodSlab.VARIANT, BlockPlanks.EnumType.OAK).withProperty(BlockWoodSlab.HALF, BlockSlab.EnumBlockHalf.BOTTOM), 3);
		world.setBlockState(new BlockPos(x + 3, y + 6, z + 4), Blocks.WOODEN_SLAB.getDefaultState().withProperty(BlockWoodSlab.VARIANT, BlockPlanks.EnumType.OAK).withProperty(BlockWoodSlab.HALF, BlockSlab.EnumBlockHalf.BOTTOM), 3);
		world.setBlockState(new BlockPos(x + 4, y + 6, z + 4), Blocks.WOODEN_SLAB.getDefaultState().withProperty(BlockWoodSlab.VARIANT, BlockPlanks.EnumType.OAK).withProperty(BlockWoodSlab.HALF, BlockSlab.EnumBlockHalf.BOTTOM), 3);
		world.setBlockState(new BlockPos(x + 5, y + 6, z + 4), Blocks.WOODEN_SLAB.getDefaultState().withProperty(BlockWoodSlab.VARIANT, BlockPlanks.EnumType.OAK).withProperty(BlockWoodSlab.HALF, BlockSlab.EnumBlockHalf.BOTTOM), 3);
		...
		world.setBlockState(new BlockPos(x + 1, y + 6, z + 5), Blocks.WOODEN_SLAB.getDefaultState().withProperty(BlockWoodSlab.VARIANT, BlockPlanks.EnumType.OAK).withProperty(BlockWoodSlab.HALF, BlockSlab.EnumBlockHalf.BOTTOM), 3);
		world.setBlockState(new BlockPos(x + 2, y + 6, z + 5), Blocks.WOODEN_SLAB.getDefaultState().withProperty(BlockWoodSlab.VARIANT, BlockPlanks.EnumType.OAK).withProperty(BlockWoodSlab.HALF, BlockSlab.EnumBlockHalf.BOTTOM), 3);
		world.setBlockState(new BlockPos(x + 3, y + 6, z + 5), Blocks.WOODEN_SLAB.getDefaultState().withProperty(BlockWoodSlab.VARIANT, BlockPlanks.EnumType.OAK).withProperty(BlockWoodSlab.HALF, BlockSlab.EnumBlockHalf.BOTTOM), 3);
		world.setBlockState(new BlockPos(x + 4, y + 6, z + 5), Blocks.WOODEN_SLAB.getDefaultState().withProperty(BlockWoodSlab.VARIANT, BlockPlanks.EnumType.OAK).withProperty(BlockWoodSlab.HALF, BlockSlab.EnumBlockHalf.BOTTOM), 3);
		world.setBlockState(new BlockPos(x + 5, y + 6, z + 5), Blocks.WOODEN_SLAB.getDefaultState().withProperty(BlockWoodSlab.VARIANT, BlockPlanks.EnumType.OAK).withProperty(BlockWoodSlab.HALF, BlockSlab.EnumBlockHalf.BOTTOM), 3);
		...
		world.setBlockState(new BlockPos(x + 1, y + 6, z + 6), Blocks.WOODEN_SLAB.getDefaultState().withProperty(BlockWoodSlab.VARIANT, BlockPlanks.EnumType.OAK).withProperty(BlockWoodSlab.HALF, BlockSlab.EnumBlockHalf.BOTTOM), 3);
		world.setBlockState(new BlockPos(x + 2, y + 6, z + 6), Blocks.WOODEN_SLAB.getDefaultState().withProperty(BlockWoodSlab.VARIANT, BlockPlanks.EnumType.OAK).withProperty(BlockWoodSlab.HALF, BlockSlab.EnumBlockHalf.BOTTOM), 3);
		world.setBlockState(new BlockPos(x + 3, y + 6, z + 6), Blocks.WOODEN_SLAB.getDefaultState().withProperty(BlockWoodSlab.VARIANT, BlockPlanks.EnumType.OAK).withProperty(BlockWoodSlab.HALF, BlockSlab.EnumBlockHalf.BOTTOM), 3);
		world.setBlockState(new BlockPos(x + 4, y + 6, z + 6), Blocks.WOODEN_SLAB.getDefaultState().withProperty(BlockWoodSlab.VARIANT, BlockPlanks.EnumType.OAK).withProperty(BlockWoodSlab.HALF, BlockSlab.EnumBlockHalf.BOTTOM), 3);
		world.setBlockState(new BlockPos(x + 5, y + 6, z + 6), Blocks.WOODEN_SLAB.getDefaultState().withProperty(BlockWoodSlab.VARIANT, BlockPlanks.EnumType.OAK).withProperty(BlockWoodSlab.HALF, BlockSlab.EnumBlockHalf.BOTTOM), 3);
