...
public class ExtraPlanets_RecipeGeneration {
	...
	public static void generate() {
		...
		RecipeDumper.addShapedRecipeWithCondition(Constants.modID, "recipe_enabled", "oxygentanks", new ItemStack(ExtraPlanets_Items.TIER_4_EQUIPMENT_KIT, 1, 4), new Object[] { "M G", "T T", "   ", 'M', new ItemStack(GCItems.oxMask), 'G',
				new ItemStack(GCItems.oxygenGear), 'T', new ItemStack(ExtraPlanets_Items.OXYGEN_TANK_VERY_HEAVY) });
