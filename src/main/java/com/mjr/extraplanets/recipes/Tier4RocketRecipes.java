...
public class Tier4RocketRecipes {
	...
	// Body
	input.put(2, new ItemStack(ExtraPlanetsItems.heavyDutyPlateTier4, 1, 0));
	input.put(3, new ItemStack(ExtraPlanetsItems.heavyDutyPlateTier4, 1, 0));
	input.put(4, new ItemStack(ExtraPlanetsItems.heavyDutyPlateTier4, 1, 0));
	input.put(5, new ItemStack(ExtraPlanetsItems.heavyDutyPlateTier4, 1, 0));
	input.put(6, new ItemStack(ExtraPlanetsItems.heavyDutyPlateTier4, 1, 0));
	input.put(7, new ItemStack(ExtraPlanetsItems.heavyDutyPlateTier4, 1, 0));
	input.put(8, new ItemStack(ExtraPlanetsItems.heavyDutyPlateTier4, 1, 0));
	input.put(9, new ItemStack(ExtraPlanetsItems.heavyDutyPlateTier4, 1, 0));
	input.put(10, new ItemStack(ExtraPlanetsItems.heavyDutyPlateTier4, 1, 0));
	input.put(11, new ItemStack(ExtraPlanetsItems.heavyDutyPlateTier4, 1, 0));

	input.put(12, new ItemStack(ExtraPlanetsItems.engineTier4, 1, 1)); // Booster
	input.put(13, new ItemStack(ExtraPlanetsItems.finTier4, 1, 0)); // Fin
	input.put(14, new ItemStack(ExtraPlanetsItems.finTier4, 1, 0)); // Fin
	input.put(15, new ItemStack(ExtraPlanetsItems.engineTier4, 1, 0)); // Engine
	input.put(16, new ItemStack(ExtraPlanetsItems.engineTier4, 1, 1)); // Booster
	input.put(17, new ItemStack(ExtraPlanetsItems.finTier4, 1, 0)); // Fin
	input.put(18, new ItemStack(ExtraPlanetsItems.finTier4, 1, 0)); // Fin
	input.put(19, null);
	input.put(20, null);
	input.put(21, null);
