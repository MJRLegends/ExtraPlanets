...
public class MarsRoverRecipes {
	...
	public static void registerRoverCraftingRecipe() {
		...
		input.put(16, new ItemStack(ExtraPlanets_Items.electricParts, 1, 2));
		input.put(17, new ItemStack(ExtraPlanets_Items.electricParts, 1, 2));
		input.put(18, new ItemStack(ExtraPlanets_Items.electricParts, 1, 2));
		input.put(19, new ItemStack(ExtraPlanets_Items.electricParts, 1, 2));
		input.put(20, new ItemStack(ExtraPlanets_Items.electricParts, 1, 2));
		input.put(21, new ItemStack(ExtraPlanets_Items.electricParts, 1, 2));
		input.put(22, null);
		input.put(23, null);
		input.put(24, null);
