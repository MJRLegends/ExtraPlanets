...
public class MarsRoverRecipes {
	...
	public static ItemStack findMatchingMarsRoverRecipe(InventorySchematicTier4Rocket inventoryRocketBench) {
	...
	public static void registerRoverCraftingRecipe() {
		...
		input.put(9, new ItemStack(GCItems.partBuggy, 1, 1));
		...
		input.put(16, new ItemStack(MarsItems.marsItemBasic, 1, 3));
		input.put(17, new ItemStack(MarsItems.marsItemBasic, 1, 3));
		input.put(18, new ItemStack(MarsItems.marsItemBasic, 1, 3));
		...
		input.put(22, new ItemStack(ExtraPlanets_Items.electricParts, 1, 3));
		input.put(23, new ItemStack(ExtraPlanets_Items.electricParts, 1, 3));
		input.put(24, new ItemStack(ExtraPlanets_Items.electricParts, 1, 3));
		input.put(25, null);
