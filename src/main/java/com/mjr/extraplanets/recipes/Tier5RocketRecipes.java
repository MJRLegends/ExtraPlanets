...
public class Tier5RocketRecipes {
	...
	public static void registerRocketCraftingRecipe(){
		...
		input.put(20, null);
		input.put(21, null);
		Tier5RocketRecipes.addTier5RocketRecipe(new NasaWorkbenchRecipe(new ItemStack(ExtraPlanetsItems.tier5Rocket, 1, 0), input));

		HashMap<Integer, ItemStack> input2 = new HashMap<Integer, ItemStack>(input);
		input2.put(19, new ItemStack(Blocks.chest));
		input2.put(20, null);
		input2.put(21, null);
		Tier5RocketRecipes.addTier5RocketRecipe(new NasaWorkbenchRecipe(new ItemStack(ExtraPlanetsItems.tier5Rocket, 1, 1), input2));
		...
		input2.put(20, new ItemStack(Blocks.chest));
		input2.put(21, null);
		Tier5RocketRecipes.addTier5RocketRecipe(new NasaWorkbenchRecipe(new ItemStack(ExtraPlanetsItems.tier5Rocket, 1, 2), input2));
		...
		input2.put(20, new ItemStack(Blocks.chest));
		input2.put(21, new ItemStack(Blocks.chest));
		Tier5RocketRecipes.addTier5RocketRecipe(new NasaWorkbenchRecipe(new ItemStack(ExtraPlanetsItems.tier5Rocket, 1, 3), input2));
	}
}
