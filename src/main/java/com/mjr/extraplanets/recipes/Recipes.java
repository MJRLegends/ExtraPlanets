...
public class Recipes {
	...
	if (Config.venus) {
		...
		new ItemStack(ExtraPlanetsItems.tier4Items, 1, 4), 'Y', Blocks.redstone_torch });
	    GameRegistry.addRecipe(new ItemStack(ExtraPlanetsItems.tier4Items, 1, 2), new Object[] { " Y ", "XYX", "X X", 'X',
		new ItemStack(ExtraPlanetsItems.tier4Items, 1, 4), 'Y', new ItemStack(AsteroidsItems.basicItem, 1, 0) });
		...
		new ItemStack(ExtraPlanetsItems.tier4Items, 1, 4), 'Y', Items.flint_and_steel, 'Z', GCItems.oxygenVent });
	    GameRegistry.addRecipe(new ItemStack(ExtraPlanetsItems.tier4Items, 1, 1), new Object[] { "ZYZ", "ZWZ", "XVX", 'V',
		GCItems.oxygenVent, 'W', new ItemStack(GCItems.fuelCanister, 1, 1), 'X', new ItemStack(ExtraPlanetsItems.tier4Items, 1, 3), 'Y',
	...
	if (Config.jupiter) {
		...
		new ItemStack(ExtraPlanetsItems.tier5Items, 1, 3), 'Y',
		...
		GCItems.oxygenVent, 'W', new ItemStack(GCItems.fuelCanister, 1, 1), 'X', new ItemStack(ExtraPlanetsItems.tier5Items, 1, 3), 'Y',
		new ItemStack(Blocks.wool, 1, 11), 'Z', new ItemStack(ExtraPlanetsItems.tier5Items, 1, 5) });
	}
	if (Config.saturn) {
		...
		new ItemStack(ExtraPlanetsItems.tier6Items, 1, 3), 'Y',
		new ItemStack(ExtraPlanetsItems.tier5Items, 1, 3) });
		...
		GCItems.oxygenVent, 'W', new ItemStack(GCItems.fuelCanister, 1, 1), 'X', new ItemStack(ExtraPlanetsItems.tier6Items, 1, 3), 'Y',
	...
	if (Config.uranus) {
		...
		new ItemStack(ExtraPlanetsItems.tier7Items, 1, 3), 'Y',
		new ItemStack(ExtraPlanetsItems.tier6Items, 1, 3) });
		...
		GCItems.oxygenVent, 'W', new ItemStack(GCItems.fuelCanister, 1, 1), 'X', new ItemStack(ExtraPlanetsItems.tier7Items, 1, 3), 'Y',
	...
	if (Config.neptune) {
		...
		new ItemStack(ExtraPlanetsItems.tier8Items, 1, 3), 'Y',
		new ItemStack(ExtraPlanetsItems.tier7Items, 1, 3) });
		...
		GCItems.oxygenVent, 'W', new ItemStack(GCItems.fuelCanister, 1, 1), 'X', new ItemStack(ExtraPlanetsItems.tier8Items, 1, 3), 'Y',
		new ItemStack(Blocks.wool, 1, 2), 'Z', new ItemStack(ExtraPlanetsItems.tier7Items, 1, 4) });
	}
	...
	CompressorRecipes.addShapelessRecipe(new ItemStack(ExtraPlanetsItems.tier4Items, 1, 4), new ItemStack(
		AsteroidsItems.basicItem, 1, 0), new ItemStack(ExtraPlanetsItems.tier4Items, 1, 4));
	CompressorRecipes.addShapelessRecipe(new ItemStack(ExtraPlanetsItems.tier5Items, 1, 3), new ItemStack(
		ExtraPlanetsItems.tier4Items, 1, 4), new ItemStack(ExtraPlanetsItems.tier5Items, 1, 4));
