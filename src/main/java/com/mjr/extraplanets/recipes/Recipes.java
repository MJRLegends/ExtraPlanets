...
public class Recipes {
	...
	CompressorRecipes.addShapelessRecipe(new ItemStack(ExtraPlanetsItems.tier4Items, 1, 4), new ItemStack(ExtraPlanetsItems.tier4Items,
		1, 5), new ItemStack(ExtraPlanetsItems.tier4Items, 1, 5));
	CompressorRecipes.addShapelessRecipe(new ItemStack(ExtraPlanetsItems.tier5Items, 1, 4), new ItemStack(ExtraPlanetsItems.tier5Items,
		1, 5), new ItemStack(ExtraPlanetsItems.tier5Items, 1, 5));
	CompressorRecipes.addShapelessRecipe(new ItemStack(ExtraPlanetsItems.tier6Items, 1, 4), new ItemStack(ExtraPlanetsItems.tier6Items,
		1, 5), new ItemStack(ExtraPlanetsItems.tier6Items, 1, 5));
	CompressorRecipes.addShapelessRecipe(new ItemStack(ExtraPlanetsItems.tier7Items, 1, 4), new ItemStack(ExtraPlanetsItems.tier7Items,
		1, 5), new ItemStack(ExtraPlanetsItems.tier7Items, 1, 5));
	CompressorRecipes.addShapelessRecipe(new ItemStack(ExtraPlanetsItems.tier7Items, 1, 6), new ItemStack(ExtraPlanetsItems.tier7Items,
		1, 4), new ItemStack(ExtraPlanetsItems.tier7Items, 1, 4));
	...
	CompressorRecipes.addShapelessRecipe(new ItemStack(ExtraPlanetsItems.tier4Items, 1, 3), new ItemStack(AsteroidsItems.basicItem, 1,
		0), new ItemStack(ExtraPlanetsItems.tier4Items, 1, 4));
	CompressorRecipes.addShapelessRecipe(new ItemStack(ExtraPlanetsItems.tier5Items, 1, 3), new ItemStack(ExtraPlanetsItems.tier4Items,
		1, 3), new ItemStack(ExtraPlanetsItems.tier5Items, 1, 4));
	CompressorRecipes.addShapelessRecipe(new ItemStack(ExtraPlanetsItems.tier6Items, 1, 3), new ItemStack(ExtraPlanetsItems.tier5Items,
		1, 3), new ItemStack(ExtraPlanetsItems.tier6Items, 1, 4));
	CompressorRecipes.addShapelessRecipe(new ItemStack(ExtraPlanetsItems.tier7Items, 1, 3), new ItemStack(ExtraPlanetsItems.tier6Items,
		1, 3), new ItemStack(ExtraPlanetsItems.tier7Items, 1, 6));
	CompressorRecipes.addShapelessRecipe(new ItemStack(ExtraPlanetsItems.tier8Items, 1, 3), new ItemStack(ExtraPlanetsItems.tier7Items,
		1, 3), new ItemStack(ExtraPlanetsItems.compressedZinc, 1, 0));
