...
public class SkyProviderDeimos extends IRenderHandler {
	...
	public SkyProviderDeimos(IGalacticraftWorldProvider marsProvider) {
	...
	public void render(float partialTicks, WorldClient world, Minecraft mc) {
		...
		f10 = this.sunSize;
		mc.renderEngine.bindTexture(SkyProviderDeimos.sunTexture);
		...
		FMLClientHandler.instance().getClient().renderEngine.bindTexture(SkyProviderDeimos.overworldTexture);
		worldRenderer1.begin(GL11.GL_QUADS, DefaultVertexFormats.POSITION_TEX);
