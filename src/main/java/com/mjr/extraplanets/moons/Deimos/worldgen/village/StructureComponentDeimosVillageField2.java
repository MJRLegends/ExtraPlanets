...
public class StructureComponentDeimosVillageField2 extends StructureComponentDeimosVillage {
	...
	public static StructureComponentDeimosVillageField2 func_74900_a(StructureComponentDeimosVillageStartPiece par0ComponentVillageStartPiece, List par1List, Random par2Random, int par3, int par4, int par5, int par6, int par7) {
		...
		return StructureComponentDeimosVillage.canVillageGoDeeper(structureboundingbox) && StructureComponent.findIntersecting(par1List, structureboundingbox) == null ? new StructureComponentDeimosVillageField2(par0ComponentVillageStartPiece, par7,
