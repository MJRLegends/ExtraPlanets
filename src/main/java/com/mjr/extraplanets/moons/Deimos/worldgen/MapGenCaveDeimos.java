...
public class MapGenCaveDeimos extends MapGenBaseMeta
{
	private Block grassblock = ExtraPlanets_Blocks.deimosBlocks;
	private Block dirtblock = ExtraPlanets_Blocks.deimosBlocks;
	private Block stoneblock = ExtraPlanets_Blocks.deimosBlocks;
