...
public class ChunkProviderTriton extends ChunkProviderSpace {
	...
	protected BiomeGenBase[] getBiomesForGeneration() {
		return new BiomeGenBase[] { TritonBiomes.triton };
	}
	...
	protected BlockMetaPair getGrassBlock() {
		return new BlockMetaPair(ExtraPlanets_Blocks.tritonBlocks, (byte) 0);
	}

	@Override
	protected BlockMetaPair getDirtBlock() {
		return new BlockMetaPair(ExtraPlanets_Blocks.tritonBlocks, (byte) 1);
	}

	@Override
	protected BlockMetaPair getStoneBlock() {
		return new BlockMetaPair(ExtraPlanets_Blocks.tritonBlocks, (byte) 2);
	}
