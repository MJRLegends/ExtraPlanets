...
public class StructureComponentTritonVillageWell extends StructureComponentTritonVillage {
    ...
    public StructureComponentTritonVillageWell() {
    }

    public StructureComponentTritonVillageWell(StructureComponentTritonVillageStartPiece par1ComponentVillageStartPiece, int par2, Random par3Random, int par4, int par5) {
	...
	StructureVillagePiecesTriton.getNextStructureComponentVillagePath((StructureComponentTritonVillageStartPiece) par1StructureComponent, par2List, par3Random, this.boundingBox.minX - 1, this.boundingBox.maxY - 4, this.boundingBox.minZ + 1, 1, this.getComponentType());
	StructureVillagePiecesTriton.getNextStructureComponentVillagePath((StructureComponentTritonVillageStartPiece) par1StructureComponent, par2List, par3Random, this.boundingBox.maxX + 1, this.boundingBox.maxY - 4, this.boundingBox.minZ + 1, 3, this.getComponentType());
	StructureVillagePiecesTriton.getNextStructureComponentVillagePath((StructureComponentTritonVillageStartPiece) par1StructureComponent, par2List, par3Random, this.boundingBox.minX + 1, this.boundingBox.maxY - 4, this.boundingBox.minZ - 1, 2, this.getComponentType());
	StructureVillagePiecesTriton.getNextStructureComponentVillagePath((StructureComponentTritonVillageStartPiece) par1StructureComponent, par2List, par3Random, this.boundingBox.minX + 1, this.boundingBox.maxY - 4, this.boundingBox.maxZ + 1, 0, this.getComponentType());
    }
	...
	this.fillWithMetadataBlocks(par1World, par3StructureBoundingBox, 1, 0, 1, 4, 12, 4, ExtraPlanetsBlocks.tritonStone, 1, Blocks.flowing_water, 0, false);
	...
	this.fillWithMetadataBlocks(par1World, par3StructureBoundingBox, 1, 15, 1, 4, 15, 4, ExtraPlanetsBlocks.tritonStone, 1, ExtraPlanetsBlocks.tritonStone, 1, false);
