...
public class StructureVillagePiecesTriton {
	...
	private static StructureComponentTritonVillage func_75083_a(StructureComponentTritonVillageStartPiece par0ComponentVillageStartPiece, StructureVillagePieceWeightTriton par1StructureVillagePieceWeight, List<StructureComponent> par2List,
	...
	private static StructureComponentTritonVillage getNextVillageComponent(StructureComponentTritonVillageStartPiece par0ComponentVillageStartPiece, List<StructureComponent> par1List, Random par2Random, int par3, int par4, int par5, int par6,
			int par7) {
