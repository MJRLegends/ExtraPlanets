...
public class BiomeProviderTriton extends BiomeProvider {
	...
	protected BiomeProviderTriton() {
		biomeCache = new BiomeCache(this);
		biomesToSpawnIn = new ArrayList<>();
	}

	public BiomeProviderTriton(long seed, WorldType type) {
		this();
	...
	public BiomeProviderTriton(World world) {
	...
	public Biome getBiome(BlockPos pos, Biome defaultBiome) {
		return this.biomeCache.getBiome(pos.getX(), pos.getZ(), TritonBiomes.triton);
	}
