...
{
	private Block grassblock = ExtraPlanets_Blocks.tritonBlocks;
	private Block dirtblock = ExtraPlanets_Blocks.tritonBlocks;
	private Block stoneblock = ExtraPlanets_Blocks.tritonBlocks;
