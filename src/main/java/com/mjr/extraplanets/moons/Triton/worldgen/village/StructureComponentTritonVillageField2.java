...
public class StructureComponentTritonVillageField2 extends StructureComponentTritonVillage {
	...
	public static StructureComponentTritonVillageField2 func_74900_a(StructureComponentTritonVillageStartPiece par0ComponentVillageStartPiece, List par1List, Random par2Random, int par3, int par4, int par5, int par6, int par7) {
		...
		return StructureComponentTritonVillage.canVillageGoDeeper(structureboundingbox) && StructureComponent.findIntersecting(par1List, structureboundingbox) == null
				? new StructureComponentTritonVillageField2(par0ComponentVillageStartPiece, par7, par2Random, structureboundingbox, par6)
				: null;
	}
