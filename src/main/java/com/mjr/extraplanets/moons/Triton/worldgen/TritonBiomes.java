...
public class TritonBiomes extends Biome {
	...
	public static final Biome triton = new BiomeGenTriton(new BiomeProperties("triton").setBaseHeight(2.5F).setHeightVariation(0.4F).setRainfall(0.0F).setRainDisabled());

	TritonBiomes(BiomeProperties properties)
	{
		super(properties);
