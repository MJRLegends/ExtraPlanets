...
public class TitanBiomes extends Biome {
	...
	public static final Biome titan = new BiomeGenTitan(new BiomeProperties("titan").setBaseHeight(2.5F).setHeightVariation(0.4F).setRainfall(0.0F).setRainDisabled());

	TitanBiomes(BiomeProperties properties)
	{
		super(properties);
