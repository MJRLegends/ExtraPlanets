...
public class MapGenCaveTitan extends MapGenBaseMeta {
	private Block grassblock = ExtraPlanets_Blocks.titanBlocks;
	private Block dirtblock = ExtraPlanets_Blocks.titanBlocks;
	private Block stoneblock = ExtraPlanets_Blocks.titanBlocks;
