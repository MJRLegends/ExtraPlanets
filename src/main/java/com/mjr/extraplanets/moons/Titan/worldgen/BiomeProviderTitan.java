...
public class BiomeProviderTitan extends BiomeProvider
{
    ...
    protected BiomeProviderTitan()
    {
        biomeCache = new BiomeCache(this);
        biomesToSpawnIn = new ArrayList<>();
    }

    public BiomeProviderTitan(long seed, WorldType type)
    {
        this();
    ...
    public BiomeProviderTitan(World world)
    {
    ...
    {
        return this.biomeCache.getBiome(pos.getX(), pos.getZ(), TitanBiomes.titan);
    }
