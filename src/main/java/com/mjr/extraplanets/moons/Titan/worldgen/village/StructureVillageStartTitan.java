...
public class StructureVillageStartTitan extends StructureStart {
	...
	public StructureVillageStartTitan(World par1World, Random par2Random, int par3, int par4, int par5) {
		super(par3, par4);

		final ArrayList<StructureVillagePieceWeightTitan> var6 = StructureVillagePiecesTitan.getStructureVillageWeightedPieceList(par2Random, par5);
		final StructureComponentTitanVillageStartPiece var7 = new StructureComponentTitanVillageStartPiece(par1World.getWorldChunkManager(), 0, par2Random, (par3 << 4) + 2, (par4 << 4) + 2, var6, par5);
		...
		while (var13.hasNext()) {
			...
			if (!(var12 instanceof StructureComponentTitanVillageRoadPiece)) {
				++var10;
			}
		}
	}
