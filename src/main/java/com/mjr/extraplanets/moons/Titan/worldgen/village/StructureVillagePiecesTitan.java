...
public class StructureVillagePiecesTitan {
	...
	private static StructureComponentTitanVillage func_75083_a(StructureComponentTitanVillageStartPiece par0ComponentVillageStartPiece, StructureVillagePieceWeightTitan par1StructureVillagePieceWeight, List<StructureComponent> par2List, Random par3Random, int par4, int par5, int par6, int par7, int par8) {
