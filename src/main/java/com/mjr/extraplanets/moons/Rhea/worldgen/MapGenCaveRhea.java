...
public class MapGenCaveRhea extends MapGenBaseMeta
{
	private Block grassblock = ExtraPlanets_Blocks.rheaBlocks;
	private Block dirtblock = ExtraPlanets_Blocks.rheaBlocks;
	private Block stoneblock = ExtraPlanets_Blocks.rheaBlocks;
