...
public class StructureComponentRheaVillageField2 extends StructureComponentRheaVillage {
	...
	public StructureComponentRheaVillageField2() {
	}

	public StructureComponentRheaVillageField2(StructureComponentRheaVillageStartPiece par1ComponentVillageStartPiece, int par2, Random par3Random, StructureBoundingBox par4StructureBoundingBox, int par5) {
	...
	public static StructureComponentRheaVillageField2 func_74900_a(StructureComponentRheaVillageStartPiece par0ComponentVillageStartPiece, List par1List, Random par2Random, int par3, int par4, int par5, int par6, int par7) {
		...
		return StructureComponentRheaVillage.canVillageGoDeeper(structureboundingbox) && StructureComponent.findIntersecting(par1List, structureboundingbox) == null
				? new StructureComponentRheaVillageField2(par0ComponentVillageStartPiece, par7, par2Random, structureboundingbox, par6)
				: null;
	}
