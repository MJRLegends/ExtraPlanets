...
public class SkyProviderTitania extends IRenderHandler {
	private static final ResourceLocation overworldTexture = new ResourceLocation(micdoodle8.mods.galacticraft.core.Constants.ASSET_PREFIX, "textures/gui/celestialbodies/uranus.png");
	...
	public SkyProviderTitania(IGalacticraftWorldProvider marsProvider) {
	...
	public void render(float partialTicks, WorldClient world, Minecraft mc) {
		...
		f10 = this.sunSize;
		mc.renderEngine.bindTexture(SkyProviderTitania.sunTexture);
		...
		FMLClientHandler.instance().getClient().renderEngine.bindTexture(SkyProviderTitania.overworldTexture);
		worldRenderer1.begin(GL11.GL_QUADS, DefaultVertexFormats.POSITION_TEX);
