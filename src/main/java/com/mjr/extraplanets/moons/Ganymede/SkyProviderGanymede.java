...
public class SkyProviderGanymede extends IRenderHandler {
	...
	public SkyProviderGanymede(IGalacticraftWorldProvider ceresProvider) {
	...
	public void render(float partialTicks, WorldClient world, Minecraft mc) {
		...
		// Render earth
		f10 = (sunSize * 1.5F) * 0.35F;
		GL11.glScalef(0.6F, 0.6F, 0.6F);
		GL11.glRotatef(40.0F, 0.0F, 0.0F, 1.0F);
		GL11.glRotatef(200F, 1.0F, 0.0F, 0.0F);
		GL11.glColor4f(1.0F, 1.0F, 1.0F, 1F);
		MCUtilities.getClient().renderEngine.bindTexture(SkyProviderGanymede.overworldTexture);
		worldRenderer1.begin(GL11.GL_QUADS, DefaultVertexFormats.POSITION_TEX);
