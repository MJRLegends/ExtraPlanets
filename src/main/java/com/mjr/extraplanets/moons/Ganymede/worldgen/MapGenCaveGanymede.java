...
public class MapGenCaveGanymede extends MapGenBaseMeta
{
	private Block grassblock = ExtraPlanets_Blocks.ganymedeBlocks;
	private Block dirtblock = ExtraPlanets_Blocks.ganymedeBlocks;
	private Block stoneblock = ExtraPlanets_Blocks.ganymedeBlocks;
