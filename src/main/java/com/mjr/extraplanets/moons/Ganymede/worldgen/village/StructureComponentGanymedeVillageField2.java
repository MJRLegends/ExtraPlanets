...
public class StructureComponentGanymedeVillageField2 extends StructureComponentGanymedeVillage {
	...
	public static StructureComponentGanymedeVillageField2 func_74900_a(StructureComponentGanymedeVillageStartPiece par0ComponentVillageStartPiece, List par1List, Random par2Random, int par3, int par4, int par5, int par6, int par7) {
		...
		return StructureComponentGanymedeVillage.canVillageGoDeeper(structureboundingbox) && StructureComponent.findIntersecting(par1List, structureboundingbox) == null ? new StructureComponentGanymedeVillageField2(par0ComponentVillageStartPiece,
