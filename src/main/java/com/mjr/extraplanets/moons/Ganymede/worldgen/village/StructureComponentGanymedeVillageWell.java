...
public class StructureComponentGanymedeVillageWell extends StructureComponentGanymedeVillage {
	...
	public void buildComponent(StructureComponent par1StructureComponent, List par2List, Random par3Random) {
		StructureVillagePiecesGanymede.getNextStructureComponentVillagePath((StructureComponentGanymedeVillageStartPiece) par1StructureComponent, par2List, par3Random, this.boundingBox.minX - 1, this.boundingBox.maxY - 4, this.boundingBox.minZ + 1,
				1, this.getComponentType());
		StructureVillagePiecesGanymede.getNextStructureComponentVillagePath((StructureComponentGanymedeVillageStartPiece) par1StructureComponent, par2List, par3Random, this.boundingBox.maxX + 1, this.boundingBox.maxY - 4, this.boundingBox.minZ + 1,
				3, this.getComponentType());
		StructureVillagePiecesGanymede.getNextStructureComponentVillagePath((StructureComponentGanymedeVillageStartPiece) par1StructureComponent, par2List, par3Random, this.boundingBox.minX + 1, this.boundingBox.maxY - 4, this.boundingBox.minZ - 1,
				2, this.getComponentType());
		StructureVillagePiecesGanymede.getNextStructureComponentVillagePath((StructureComponentGanymedeVillageStartPiece) par1StructureComponent, par2List, par3Random, this.boundingBox.minX + 1, this.boundingBox.maxY - 4, this.boundingBox.maxZ + 1,
