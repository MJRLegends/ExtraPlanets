...
public class BiomeGenCallistoShaleMountains extends CallistoBiomes {
	...
	public BiomeGenCallistoShaleMountains(BiomeProperties properties, int id) {
		super(properties);
		Biome.registerBiome(id, Constants.TEXTURE_PREFIX + this.getBiomeName(), this);
		if (Config.REGISTER_BIOME_TYPES)
			BiomeDictionary.addTypes(this, BiomeDictionary.Type.COLD, BiomeDictionary.Type.DRY, BiomeDictionary.Type.DEAD, BiomeDictionary.Type.DENSE, BiomeDictionary.Type.MOUNTAIN);
