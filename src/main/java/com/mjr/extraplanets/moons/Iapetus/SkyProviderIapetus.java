...
public class SkyProviderIapetus extends IRenderHandler {
	...
	public SkyProviderIapetus(IGalacticraftWorldProvider ceresProvider) {
	...
	public void render(float partialTicks, WorldClient world, Minecraft mc) {
		...
		f10 = this.sunSize;
		mc.renderEngine.bindTexture(SkyProviderIapetus.sunTexture);
		...
		MCUtilities.getClient().renderEngine.bindTexture(SkyProviderIapetus.overworldTexture);
		worldRenderer1.begin(GL11.GL_QUADS, DefaultVertexFormats.POSITION_TEX);
