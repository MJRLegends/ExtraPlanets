...
import com.mjr.extraplanets.moons.Iapetus.worldgen.village.MapGenVillageIapetus;
...
public class ChunkProviderIapetus extends ChunkProviderSpace {
	...
	private final MapGenVillageIapetus villageGenerator = new MapGenVillageIapetus();
