...
public class MapGenCaveIapetus extends MapGenBaseMeta
{
	private Block grassblock = ExtraPlanets_Blocks.iapetusBlocks;
	private Block dirtblock = ExtraPlanets_Blocks.iapetusBlocks;
	private Block stoneblock = ExtraPlanets_Blocks.iapetusBlocks;
