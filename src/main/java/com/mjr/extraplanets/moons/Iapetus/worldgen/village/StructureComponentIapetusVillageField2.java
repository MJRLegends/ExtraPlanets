...
public class StructureComponentIapetusVillageField2 extends StructureComponentIapetusVillage {
	...
	public StructureComponentIapetusVillageField2() {
	}

	public StructureComponentIapetusVillageField2(StructureComponentIapetusVillageStartPiece par1ComponentVillageStartPiece, int par2, Random par3Random, StructureBoundingBox par4StructureBoundingBox, int par5) {
	...
	public static StructureComponentIapetusVillageField2 func_74900_a(StructureComponentIapetusVillageStartPiece par0ComponentVillageStartPiece, List par1List, Random par2Random, int par3, int par4, int par5, int par6, int par7) {
		...
		return StructureComponentIapetusVillage.canVillageGoDeeper(structureboundingbox) && StructureComponent.findIntersecting(par1List, structureboundingbox) == null ? new StructureComponentIapetusVillageField2(par0ComponentVillageStartPiece, par7, par2Random, structureboundingbox, par6) : null;
	}
