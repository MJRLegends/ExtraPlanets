...
public class StructureVillagePiecesIapetus {
	...
	private static StructureComponentIapetusVillage func_75083_a(StructureComponentIapetusVillageStartPiece par0ComponentVillageStartPiece, StructureVillagePieceWeightIapetus par1StructureVillagePieceWeight, List<StructureComponent> par2List, Random par3Random, int par4, int par5, int par6, int par7, int par8) {
	...
	private static StructureComponentIapetusVillage getNextVillageComponent(StructureComponentIapetusVillageStartPiece par0ComponentVillageStartPiece, List<StructureComponent> par1List, Random par2Random, int par3, int par4, int par5, int par6, int par7) {
