...
import com.mjr.extraplanets.moons.Io.worldgen.biomes.GenLayerIo;

public class WorldChunkManagerIo extends WorldChunkManager {
	...
	public WorldChunkManagerIo(long seed, WorldType type) {
		this();
		GenLayer[] genLayers = GenLayerIo.createWorld(seed);
