...
public class MapGenCaveIo extends MapGenBaseMeta
{
	private Block grassblock = ExtraPlanets_Blocks.ioBlocks;
	private Block dirtblock = ExtraPlanets_Blocks.ioBlocks;
	private Block stoneblock = ExtraPlanets_Blocks.ioBlocks;
