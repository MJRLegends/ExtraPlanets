...
public class IoBiomes extends BiomeGenBase {
	...
	public static final BiomeGenBase ioAshLands = new BiomeGenIoAshLands(Config.ioAshLandsBiomeID).setBiomeName("ioAshLands").setHeight(new Height(2.0F, 2.0F));
	public static final BiomeGenBase ioBurningPlains = new BiomeGenIoBurningPlains(Config.ioBurningPlainsBiomeID).setBiomeName("ioBurningPlains").setHeight(new Height(0.125F, 0.015F));
