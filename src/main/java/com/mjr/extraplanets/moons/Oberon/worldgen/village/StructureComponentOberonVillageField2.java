...
public class StructureComponentOberonVillageField2 extends StructureComponentOberonVillage {
	...
	public static StructureComponentOberonVillageField2 func_74900_a(StructureComponentOberonVillageStartPiece par0ComponentVillageStartPiece, List par1List, Random par2Random, int par3, int par4, int par5, int par6, int par7) {
		...
		return StructureComponentOberonVillage.canVillageGoDeeper(structureboundingbox) && StructureComponent.findIntersecting(par1List, structureboundingbox) == null
				? new StructureComponentOberonVillageField2(par0ComponentVillageStartPiece, par7, par2Random, structureboundingbox, par6)
				: null;
	}
