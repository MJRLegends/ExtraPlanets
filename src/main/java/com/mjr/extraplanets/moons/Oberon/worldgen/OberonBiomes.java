...
public class OberonBiomes extends Biome {
	...
	public static final Biome oberon = new BiomeGenOberon(new BiomeProperties("oberon").setBaseHeight(2.5F).setHeightVariation(0.4F).setRainfall(0.0F).setRainDisabled());

	OberonBiomes(BiomeProperties properties)
	{
		super(properties);
