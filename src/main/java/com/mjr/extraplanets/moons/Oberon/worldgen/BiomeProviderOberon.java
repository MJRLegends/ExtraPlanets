...
public class BiomeProviderOberon extends BiomeProvider {
	...
	protected BiomeProviderOberon() {
		biomeCache = new BiomeCache(this);
		biomesToSpawnIn = new ArrayList<>();
	}

	public BiomeProviderOberon(long seed, WorldType type) {
		this();
	...
	public BiomeProviderOberon(World world) {
	...
	public Biome getBiome(BlockPos pos, Biome defaultBiome) {
		return this.biomeCache.getBiome(pos.getX(), pos.getZ(), OberonBiomes.oberon);
	}
