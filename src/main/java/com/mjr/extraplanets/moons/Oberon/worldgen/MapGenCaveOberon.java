...
public class MapGenCaveOberon extends MapGenBaseMeta {
	private Block grassblock = ExtraPlanets_Blocks.oberonBlocks;
	private Block dirtblock = ExtraPlanets_Blocks.oberonBlocks;
	private Block stoneblock = ExtraPlanets_Blocks.oberonBlocks;
