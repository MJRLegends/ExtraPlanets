...
public class StructureComponentEuropaVillageField2 extends StructureComponentEuropaVillage {
	...
	public static StructureComponentEuropaVillageField2 func_74900_a(StructureComponentEuropaVillageStartPiece par0ComponentVillageStartPiece, List par1List, Random par2Random, int par3, int par4, int par5, int par6, int par7) {
		...
		return StructureComponentEuropaVillage.canVillageGoDeeper(structureboundingbox) && StructureComponent.findIntersecting(par1List, structureboundingbox) == null
				? new StructureComponentEuropaVillageField2(par0ComponentVillageStartPiece, par7, par2Random, structureboundingbox, par6)
				: null;
	}
