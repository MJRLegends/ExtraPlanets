...
public class MapGenCaveEuropa extends MapGenBaseMeta
{
	private Block grassblock = ExtraPlanets_Blocks.europaBlocks;
	private Block dirtblock = ExtraPlanets_Blocks.europaBlocks;
	private Block stoneblock = ExtraPlanets_Blocks.europaBlocks;
