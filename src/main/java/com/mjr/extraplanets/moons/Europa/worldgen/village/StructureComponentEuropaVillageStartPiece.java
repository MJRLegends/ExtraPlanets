...
public class StructureComponentEuropaVillageStartPiece extends StructureComponentEuropaVillageWell {
    ...
    public StructureComponentEuropaVillageStartPiece(WorldChunkManager par1WorldChunkManager, int par2, Random par3Random, int par4, int par5, ArrayList<StructureVillagePieceWeightEuropa> par6ArrayList, int par7) {
	super((StructureComponentEuropaVillageStartPiece) null, 0, par3Random, par4, par5);
