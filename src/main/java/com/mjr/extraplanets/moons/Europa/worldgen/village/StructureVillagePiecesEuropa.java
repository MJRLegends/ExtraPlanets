...
public class StructureVillagePiecesEuropa {
	...
	private static StructureComponentEuropaVillage func_75083_a(StructureComponentEuropaVillageStartPiece par0ComponentVillageStartPiece, StructureVillagePieceWeightEuropa par1StructureVillagePieceWeight, List<StructureComponent> par2List,
	...
	private static StructureComponentEuropaVillage getNextVillageComponent(StructureComponentEuropaVillageStartPiece par0ComponentVillageStartPiece, List<StructureComponent> par1List, Random par2Random, int par3, int par4, int par5, int par6,
			int par7) {
