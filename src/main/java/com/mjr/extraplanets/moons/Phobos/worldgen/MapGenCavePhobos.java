...
public class MapGenCavePhobos extends MapGenBaseMeta
{
	private Block grassblock = ExtraPlanets_Blocks.phobosBlocks;
	private Block dirtblock = ExtraPlanets_Blocks.phobosBlocks;
	private Block stoneblock = ExtraPlanets_Blocks.phobosBlocks;
