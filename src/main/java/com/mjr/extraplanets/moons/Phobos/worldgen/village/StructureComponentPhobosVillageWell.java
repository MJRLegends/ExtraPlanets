...
public class StructureComponentPhobosVillageWell extends StructureComponentPhobosVillage {
	private int averageGroundLevel = -1;

	public StructureComponentPhobosVillageWell() {
	}

	public StructureComponentPhobosVillageWell(StructureComponentPhobosVillageStartPiece par1ComponentVillageStartPiece, int par2, Random par3Random, int par4, int par5) {
	...
	public boolean addComponentParts(World par1World, Random par2Random, StructureBoundingBox par3StructureBoundingBox) {
		...
		this.fillWithMetadataBlocks(par1World, par3StructureBoundingBox, 1, 0, 1, 4, 12, 4, ExtraPlanets_Blocks.phobosBlocks, 2, Blocks.flowing_water, 0, false);
		...
		this.fillWithMetadataBlocks(par1World, par3StructureBoundingBox, 1, 15, 1, 4, 15, 4, ExtraPlanets_Blocks.phobosBlocks, 2, ExtraPlanets_Blocks.phobosBlocks, 2, false);
