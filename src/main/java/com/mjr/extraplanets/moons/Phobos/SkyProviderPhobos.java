...
public class SkyProviderPhobos extends IRenderHandler {
	...
	public SkyProviderPhobos(IGalacticraftWorldProvider marsProvider) {
	...
	public void render(float partialTicks, WorldClient world, Minecraft mc) {
		...
		f10 = this.sunSize;
		mc.renderEngine.bindTexture(SkyProviderPhobos.sunTexture);
		...
		FMLClientHandler.instance().getClient().renderEngine.bindTexture(SkyProviderPhobos.overworldTexture);
		worldRenderer1.begin(GL11.GL_QUADS, DefaultVertexFormats.POSITION_TEX);
