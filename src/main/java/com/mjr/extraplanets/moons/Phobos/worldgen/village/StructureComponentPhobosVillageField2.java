...
public class StructureComponentPhobosVillageField2 extends StructureComponentPhobosVillage {
	...
	public StructureComponentPhobosVillageField2() {
	}

	public StructureComponentPhobosVillageField2(StructureComponentPhobosVillageStartPiece par1ComponentVillageStartPiece, int par2, Random par3Random, StructureBoundingBox par4StructureBoundingBox, int par5) {
	...
	public static StructureComponentPhobosVillageField2 func_74900_a(StructureComponentPhobosVillageStartPiece par0ComponentVillageStartPiece, List par1List, Random par2Random, int par3, int par4, int par5, int par6, int par7) {
		...
		return StructureComponentPhobosVillage.canVillageGoDeeper(structureboundingbox) && StructureComponent.findIntersecting(par1List, structureboundingbox) == null ? new StructureComponentPhobosVillageField2(par0ComponentVillageStartPiece, par7, par2Random, structureboundingbox, par6) : null;
	}
