...
public class Tier9RocketRecipeCategory extends BlankRecipeCategory<IRecipeWrapper> {
	...
	public void setRecipe(@Nonnull IRecipeLayout recipeLayout, @Nonnull IRecipeWrapper recipeWrapper) {
		...
		if (recipeWrapper instanceof Tier9RocketRecipeWrapper) {
			Tier9RocketRecipeWrapper rocketRecipeWrapper = (Tier9RocketRecipeWrapper) recipeWrapper;
