...
public class Tier10RocketRecipeHandler implements IRecipeHandler<Tier10RocketRecipeWrapper> {
	...
	@Override
	public String getRecipeCategoryUid(Tier10RocketRecipeWrapper recipe) {
		return this.getRecipeCategoryUid();
	}

	@Nonnull
	@Override
	public IRecipeWrapper getRecipeWrapper(@Nonnull Tier10RocketRecipeWrapper recipe) {
		return recipe;
	}

	@Override
	public boolean isRecipeValid(@Nonnull Tier10RocketRecipeWrapper recipe) {
