...
public class Tier10ElectricRocketRecipeCategory extends BlankRecipeCategory<IRecipeWrapper> {
	...
	public void setRecipe(@Nonnull IRecipeLayout recipeLayout, @Nonnull IRecipeWrapper recipeWrapper) {
		...
		if (recipeWrapper instanceof Tier10ElectricRocketRecipeWrapper) {
			Tier10ElectricRocketRecipeWrapper rocketRecipeWrapper = (Tier10ElectricRocketRecipeWrapper) recipeWrapper;
