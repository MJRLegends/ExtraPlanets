	...
	public void update() {
		if (!this.worldObj.isRemote && this.corner == 0) {
			...
			if (attachedLaunchPads.size() == 25) {
				...
				this.worldObj.setBlockState(this.getPos(), ExtraPlanets_Blocks.ADVANCED_LAUCHPAD_FULL.getStateFromMeta(BlockCustomLandingPadFull.EnumLandingPadFullType.ROCKET_POWER_CHARGING_PAD.getMeta()), 2);
			}
		}
	}
