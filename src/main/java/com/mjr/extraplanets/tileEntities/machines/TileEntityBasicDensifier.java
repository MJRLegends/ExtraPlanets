...
public class TileEntityBasicDensifier extends TileBaseElectricBlockWithInventory implements ISidedInventory, IFluidHandlerWrapper {
	...
	private void checkFluidTankTransfer(int slot, FluidTank tank) {
		if (this.getStackInSlot(slot) != null) {
			if (FluidUtil.isEmptyContainer(this.getStackInSlot(slot)) == false && FluidUtil.getFluidContained(this.getStackInSlot(slot)) != null && FluidUtil.getFluidContained(this.getStackInSlot(slot)).getFluid() != null) {
				...
				} else if (FluidUtil.getFluidContained(this.getStackInSlot(slot)).getFluid().equals(ExtraPlanets_Fluids.GLOWSTONE_FLUID)) {
					if (this.inputTank.getFluid() == null) {
				...
				} else if (FluidUtil.getFluidContained(this.getStackInSlot(slot)).getFluid().equals(ExtraPlanets_Fluids.NITROGEN_FLUID)) {
					if (this.inputTank.getFluid() == null) {
				...
				} else if (FluidUtil.getFluidContained(this.getStackInSlot(slot)).getFluid().equals(ExtraPlanets_Fluids.FROZEN_WATER_FLUID)) {
					if (this.inputTank.getFluid() == null) {
				...
				} else if (FluidUtil.getFluidContained(this.getStackInSlot(slot)).getFluid().equals(ExtraPlanets_Fluids.LIQUID_HYDROCARBON_FLUID)) {
					if (this.inputTank.getFluid() == null) {
	...
	public String getName() {
		return GCCoreUtil.translate("container.basic.densifier.name");
	}
