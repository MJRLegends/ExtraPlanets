...
public class ExtraPlanets_SolarSystems {
	...
	private static void initializeSolarSystems() {
		if (Config.KEPLER_SOLAR_SYSTEMS) {
			kepler22 = new SolarSystem("kepler22", "milkyWay").setMapPosition(new Vector3(0.60F + Config.KEPLER22_SYSTEM_X_OFFSET, 0.0F, 0.30F + Config.KEPLER22_SYSTEM_Z_OFFSET));
			...
			kepler47 = new SolarSystem("kepler47", "milkyWay").setMapPosition(new Vector3(-0.40F + Config.KEPLER47_SYSTEM_X_OFFSET, 0.0F, -0.80F + Config.KEPLER47_SYSTEM_Z_OFFSET));
			...
			kepler62 = new SolarSystem("kepler62", "milkyWay").setMapPosition(new Vector3(1.0F + Config.KEPLER62_SYSTEM_X_OFFSET, 0.0F, -1.0F + Config.KEPLER62_SYSTEM_Z_OFFSET));
			...
			kepler69 = new SolarSystem("kepler69", "milkyWay").setMapPosition(new Vector3(-0.90F + Config.KEPLER69_SYSTEM_X_OFFSET, 0.0F, 0.0F + Config.KEPLER69_SYSTEM_Z_OFFSET));
