...
public class BlockFireBomb extends Block {
	...
	public void onBlockDestroyedByExplosion(World p_149723_1_, int p_149723_2_, int p_149723_3_, int p_149723_4_, Explosion p_149723_5_) {
		if (!p_149723_1_.isRemote) {
			EntityFireBombPrimed fireBombprimed = new EntityFireBombPrimed(p_149723_1_, p_149723_2_ + 0.5F, p_149723_3_ + 0.5F, p_149723_4_ + 0.5F, p_149723_5_.getExplosivePlacedBy());
			fireBombprimed.fuse = p_149723_1_.rand.nextInt(fireBombprimed.fuse / 4) + fireBombprimed.fuse / 8;
			p_149723_1_.spawnEntityInWorld(fireBombprimed);
		}
	}
	...
	public void primeTnt(World p_150114_1_, int p_150114_2_, int p_150114_3_, int p_150114_4_, int p_150114_5_, EntityLivingBase p_150114_6_) {
		if (!p_150114_1_.isRemote) {
			if ((p_150114_5_ & 1) == 1) {
				EntityFireBombPrimed fireBombprimed = new EntityFireBombPrimed(p_150114_1_, p_150114_2_ + 0.5F, p_150114_3_ + 0.5F, p_150114_4_ + 0.5F, p_150114_6_);
				p_150114_1_.spawnEntityInWorld(fireBombprimed);
				p_150114_1_.playSoundAtEntity(fireBombprimed, "game.tnt.primed", 1.0F, 1.0F);
			}
		}
	}
