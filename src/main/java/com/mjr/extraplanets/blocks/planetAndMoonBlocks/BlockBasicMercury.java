...
{
    public static final PropertyEnum BASIC_TYPE = PropertyEnum.create("basicTypeMercury", EnumBlockBasic.class);

    public enum EnumBlockBasic implements IStringSerializable
    {
        SURFACE(0, "mercury_surface"),
        SUB_SURFACE(1, "mercury_sub_surface"),
        STONE(2, "mercury_stone"),
        ORE_IRON(3, "mercury_ore_iron"),
        ORE_TIN(4, "mercury_ore_tin"),
