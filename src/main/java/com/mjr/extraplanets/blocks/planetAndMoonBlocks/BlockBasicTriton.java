...
import com.mjr.extraplanets.blocks.planetAndMoonBlocks.BlockBasicCallisto.EnumBlockBasic;
...
{
    public static final PropertyEnum BASIC_TYPE = PropertyEnum.create("basicTypeTriton", EnumBlockBasic.class);

    public enum EnumBlockBasic implements IStringSerializable
    {
        SURFACE(0, "triton_surface"),
        SUB_SURFACE(1, "triton_sub_surface"),
        STONE(2, "triton_stone"),
        ORE_IRON(3, "triton_ore_iron"),
        ORE_TIN(4, "triton_ore_tin"),
        ORE_COPPER(5, "triton_ore_copper");
