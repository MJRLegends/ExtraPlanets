...
public class BlockBasicKepler22b extends Block {
	...
	public void registerBlockIcons(IIconRegister par1IconRegister) {
		...
		this.blockIcons[0] = par1IconRegister.registerIcon(Constants.TEXTURE_PREFIX + this.name + "Grass");
		this.blockIcons[1] = par1IconRegister.registerIcon(Constants.TEXTURE_PREFIX + this.name + "Dirt");
