...
{
    public static final PropertyEnum BASIC_TYPE = PropertyEnum.create("basicTypeCeres", EnumBlockBasic.class);

    public enum EnumBlockBasic implements IStringSerializable
    {
        SURFACE(0, "ceres_surface"),
        SUB_SURFACE(1, "ceres_sub_surface"),
        STONE(2, "ceres_stone"),
        ORE_IRON(3, "ceres_ore_iron"),
        ORE_TIN(4, "ceres_ore_tin"),
        ORE_COPPER(5, "ceres_ore_copper"),
        ORE_URANIUM(6, "ceres_ore_uranium"),
        URANIUM_BLOCK(7, "ceres_uranium_block"),
        STONEBRICKS(8, "ceres_stonebricks");
