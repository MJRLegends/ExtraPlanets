...
{
    public static final PropertyEnum BASIC_TYPE = PropertyEnum.create("basicTypeRhea", EnumBlockBasic.class);

    public enum EnumBlockBasic implements IStringSerializable
    {
        SURFACE(0, "rhea_surface"),
        SUB_SURFACE(1, "rhea_sub_surface"),
        STONE(2, "rhea_stone"),
        ORE_IRON(3, "rhea_ore_iron"),
        ORE_TIN(4, "rhea_ore_tin"),
        ORE_COPPER(5, "rhea_ore_copper");
