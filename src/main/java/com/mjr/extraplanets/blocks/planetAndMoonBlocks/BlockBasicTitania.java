...
{
    public static final PropertyEnum BASIC_TYPE = PropertyEnum.create("basicTypeTitania", EnumBlockBasic.class);

    public enum EnumBlockBasic implements IStringSerializable
    {
        SURFACE(0, "titania_surface"),
        SUB_SURFACE(1, "titania_sub_surface"),
        STONE(2, "titania_stone"),
        ORE_IRON(3, "titania_ore_iron"),
        ORE_TIN(4, "titania_ore_tin"),
        ORE_COPPER(5, "titania_ore_copper");
