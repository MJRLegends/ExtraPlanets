...
public class BlockBasicEuropa extends Block implements IDetectableResource, IPlantableBlock, ITerraformableBlock, ISortableBlock
{
    ...
    {
        SURFACE(0, "europa_surface"),
        SUB_SURFACE(1, "europa_sub_surface"),
        STONE(2, "europa_stone"),
        ORE_IRON(3, "europa_ore_iron"),
        ORE_TIN(4, "europa_ore_tin"),
        ORE_COPPER(5, "europa_ore_copper");
