...
public class BlockBasicGanymede extends Block implements IDetectableResource, IPlantableBlock, ITerraformableBlock, ISortableBlock
{
    ...
    {
        SURFACE(0, "ganymede_surface"),
        SUB_SURFACE(1, "ganymede_sub_surface"),
        STONE(2, "ganymede_stone"),
        ORE_IRON(3, "ganymede_ore_iron"),
        ORE_TIN(4, "ganymede_ore_tin"),
        ORE_COPPER(5, "ganymede_ore_copper");
