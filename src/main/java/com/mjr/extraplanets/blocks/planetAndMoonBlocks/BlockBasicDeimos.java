...
public class BlockBasicDeimos extends Block implements IDetectableResource, IPlantableBlock, ITerraformableBlock, ISortableBlock
{
    ...
    {
        SURFACE(0, "deimos_surface"),
        SUB_SURFACE(1, "deimos_sub_surface"),
        STONE(2, "deimos_stone"),
        ORE_IRON(3, "deimos_ore_iron"),
        ORE_TIN(4, "deimos_ore_tin"),
        ORE_COPPER(5, "deimos_ore_copper");
