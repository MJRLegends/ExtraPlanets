...
public class T7TreasureChest extends BlockContainer implements ITileEntityProvider, ItemBlockDesc.IBlockShiftDesc {
	...
	public void registerBlockIcons(IIconRegister par1IconRegister) {
		this.blockIcon = par1IconRegister.registerIcon(Constants.TEXTURE_PREFIX + "treasure_chest_t7");
	}
	...
	public int getRenderType() {
		return ClientProxy.treasureT7ChestID;
	}
	...
	public void onNeighborBlockChange(World par1World, int par2, int par3, int par4, Block par5) {
		...
		final TileEntityT7TreasureChest var6 = (TileEntityT7TreasureChest) par1World.getTileEntity(par2, par3, par4);
	...
	public void breakBlock(World par1World, int par2, int par3, int par4, Block par5, int par6) {
		final TileEntityT7TreasureChest var7 = (TileEntityT7TreasureChest) par1World.getTileEntity(par2, par3, par4);
	...
	public boolean onBlockActivated(World par1World, int par2, int par3, int par4, EntityPlayer par5EntityPlayer, int par6, float par7, float par8, float par9) {
		...
		if (var10 == null) {
			...
			return true;
		} else if (T7TreasureChest.isOcelotBlockingChest(par1World, par2, par3, par4)) {
			return true;
		} else if (par1World.getBlock(par2 - 1, par3, par4) == this && (par1World.isSideSolid(par2 - 1, par3 + 1, par4, ForgeDirection.DOWN) || T7TreasureChest.isOcelotBlockingChest(par1World, par2 - 1, par3, par4))) {
			return true;
		} else if (par1World.getBlock(par2 + 1, par3, par4) == this && (par1World.isSideSolid(par2 + 1, par3 + 1, par4, ForgeDirection.DOWN) || T7TreasureChest.isOcelotBlockingChest(par1World, par2 + 1, par3, par4))) {
			return true;
		} else if (par1World.getBlock(par2, par3, par4 - 1) == this && (par1World.isSideSolid(par2, par3 + 1, par4 - 1, ForgeDirection.DOWN) || T7TreasureChest.isOcelotBlockingChest(par1World, par2, par3, par4 - 1))) {
			return true;
		} else if (par1World.getBlock(par2, par3, par4 + 1) == this && (par1World.isSideSolid(par2, par3 + 1, par4 + 1, ForgeDirection.DOWN) || T7TreasureChest.isOcelotBlockingChest(par1World, par2, par3, par4 + 1))) {
			return true;
		} else {
			if (par1World.getBlock(par2 - 1, par3, par4) == this) {
				var10 = new InventoryLargeChest("container.chestDouble", (TileEntityT7TreasureChest) par1World.getTileEntity(par2 - 1, par3, par4), (IInventory) var10);
			}

			if (par1World.getBlock(par2 + 1, par3, par4) == this) {
				var10 = new InventoryLargeChest("container.chestDouble", (IInventory) var10, (TileEntityT7TreasureChest) par1World.getTileEntity(par2 + 1, par3, par4));
			}

			if (par1World.getBlock(par2, par3, par4 - 1) == this) {
				var10 = new InventoryLargeChest("container.chestDouble", (TileEntityT7TreasureChest) par1World.getTileEntity(par2, par3, par4 - 1), (IInventory) var10);
			}

			if (par1World.getBlock(par2, par3, par4 + 1) == this) {
				var10 = new InventoryLargeChest("container.chestDouble", (IInventory) var10, (TileEntityT7TreasureChest) par1World.getTileEntity(par2, par3, par4 + 1));
			}
			...
			if (par1World.isRemote) {
				...
				// par5EntityPlayer.addStat(ExtraPlanets_Achievements.uranusBoss,
				// 1);
				return true;
			}
		}
	...
	public TileEntity createNewTileEntity(World par1World, int metadata) {
		return new TileEntityT7TreasureChest(7);
	}
