...
public class T5TreasureChest extends BlockContainer implements ITileEntityProvider, ItemBlockDesc.IBlockShiftDesc
{
    ...
    {
	return ExtraPlanetsBlocks.treasureT5ChestID;
    }
	...
	final TileEntityT5TreasureChest var6 = (TileEntityT5TreasureChest) par1World.getTileEntity(par2, par3, par4);
    ...
    {
	final TileEntityT5TreasureChest var7 = (TileEntityT5TreasureChest) par1World.getTileEntity(par2, par3, par4);
	...
	else if (T5TreasureChest.isOcelotBlockingChest(par1World, par2, par3, par4))
	{
	    return true;
	}
	else if (par1World.getBlock(par2 - 1, par3, par4) == this && (par1World.isSideSolid(par2 - 1, par3 + 1, par4, ForgeDirection.DOWN) || T5TreasureChest.isOcelotBlockingChest(par1World, par2 - 1, par3, par4)))
	{
	    return true;
	}
	else if (par1World.getBlock(par2 + 1, par3, par4) == this && (par1World.isSideSolid(par2 + 1, par3 + 1, par4, ForgeDirection.DOWN) || T5TreasureChest.isOcelotBlockingChest(par1World, par2 + 1, par3, par4)))
	...
	else if (par1World.getBlock(par2, par3, par4 - 1) == this && (par1World.isSideSolid(par2, par3 + 1, par4 - 1, ForgeDirection.DOWN) || T5TreasureChest.isOcelotBlockingChest(par1World, par2, par3, par4 - 1)))
	{
	    return true;
	}
	else if (par1World.getBlock(par2, par3, par4 + 1) == this && (par1World.isSideSolid(par2, par3 + 1, par4 + 1, ForgeDirection.DOWN) || T5TreasureChest.isOcelotBlockingChest(par1World, par2, par3, par4 + 1)))
	...
	else
	{
	    if (par1World.getBlock(par2 - 1, par3, par4) == this)
	    {
		var10 = new InventoryLargeChest("container.chestDouble", (TileEntityT5TreasureChest) par1World.getTileEntity(par2 - 1, par3, par4), (IInventory) var10);
	    }

	    if (par1World.getBlock(par2 + 1, par3, par4) == this)
	    {
		var10 = new InventoryLargeChest("container.chestDouble", (IInventory) var10, (TileEntityT5TreasureChest) par1World.getTileEntity(par2 + 1, par3, par4));
	    }

	    if (par1World.getBlock(par2, par3, par4 - 1) == this)
	    {
		var10 = new InventoryLargeChest("container.chestDouble", (TileEntityT5TreasureChest) par1World.getTileEntity(par2, par3, par4 - 1), (IInventory) var10);
	    }

	    if (par1World.getBlock(par2, par3, par4 + 1) == this)
	    {
		var10 = new InventoryLargeChest("container.chestDouble", (IInventory) var10, (TileEntityT5TreasureChest) par1World.getTileEntity(par2, par3, par4 + 1));
	    }
		...
		par5EntityPlayer.addStat(Achievements.jupiterBoss, 1);
		return true;
	    }
	}
    }
    ...
    {
	return new TileEntityT5TreasureChest(5);
    }
