...
public class T6TreasureChest extends BlockContainer implements ITileEntityProvider, ItemBlockDesc.IBlockShiftDesc
{
	...
	{
		this.blockIcon = par1IconRegister.registerIcon(Constants.TEXTURE_PREFIX + "treasureChestT6");
	}
	...
	{
		return ClientProxy.treasureT6ChestID;
	}
	...
	public void onNeighborBlockChange(World par1World, int par2, int par3, int par4, Block par5)
	{
		...
		final TileEntityT6TreasureChest var6 = (TileEntityT6TreasureChest) par1World.getTileEntity(par2, par3, par4);
	...
	{
		final TileEntityT6TreasureChest var7 = (TileEntityT6TreasureChest) par1World.getTileEntity(par2, par3, par4);
	...
	public boolean onBlockActivated(World par1World, int par2, int par3, int par4, EntityPlayer par5EntityPlayer, int par6, float par7, float par8, float par9)
	{
		...
		else if (T6TreasureChest.isOcelotBlockingChest(par1World, par2, par3, par4))
		{
			return true;
		}
		else if (par1World.getBlock(par2 - 1, par3, par4) == this && (par1World.isSideSolid(par2 - 1, par3 + 1, par4, ForgeDirection.DOWN) || T6TreasureChest.isOcelotBlockingChest(par1World, par2 - 1, par3, par4)))
		{
			return true;
		}
		else if (par1World.getBlock(par2 + 1, par3, par4) == this && (par1World.isSideSolid(par2 + 1, par3 + 1, par4, ForgeDirection.DOWN) || T6TreasureChest.isOcelotBlockingChest(par1World, par2 + 1, par3, par4)))
		...
		else if (par1World.getBlock(par2, par3, par4 - 1) == this && (par1World.isSideSolid(par2, par3 + 1, par4 - 1, ForgeDirection.DOWN) || T6TreasureChest.isOcelotBlockingChest(par1World, par2, par3, par4 - 1)))
		{
			return true;
		}
		else if (par1World.getBlock(par2, par3, par4 + 1) == this && (par1World.isSideSolid(par2, par3 + 1, par4 + 1, ForgeDirection.DOWN) || T6TreasureChest.isOcelotBlockingChest(par1World, par2, par3, par4 + 1)))
		...
		else
		{
			if (par1World.getBlock(par2 - 1, par3, par4) == this)
			{
				var10 = new InventoryLargeChest("container.chestDouble", (TileEntityT6TreasureChest) par1World.getTileEntity(par2 - 1, par3, par4), (IInventory) var10);
			}

			if (par1World.getBlock(par2 + 1, par3, par4) == this)
			{
				var10 = new InventoryLargeChest("container.chestDouble", (IInventory) var10, (TileEntityT6TreasureChest) par1World.getTileEntity(par2 + 1, par3, par4));
			}

			if (par1World.getBlock(par2, par3, par4 - 1) == this)
			{
				var10 = new InventoryLargeChest("container.chestDouble", (TileEntityT6TreasureChest) par1World.getTileEntity(par2, par3, par4 - 1), (IInventory) var10);
			}

			if (par1World.getBlock(par2, par3, par4 + 1) == this)
			{
				var10 = new InventoryLargeChest("container.chestDouble", (IInventory) var10, (TileEntityT6TreasureChest) par1World.getTileEntity(par2, par3, par4 + 1));
			}
			...
			else
			{
				...
				//par5EntityPlayer.addStat(ExtraPlanets_Achievements.saturnBoss, 1);
				return true;
			}
		}
	}
	...
	{
		return new TileEntityT6TreasureChest(6);
	}
