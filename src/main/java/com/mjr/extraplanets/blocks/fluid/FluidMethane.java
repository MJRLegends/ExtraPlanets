...
public class FluidMethane extends BlockFluidClassic implements IFluidBlock {
	public FluidMethane(String assetName) {
		super(ExtraPlanets_Fluids.methane_fluid, ExtraPlanets_Fluids.methane_material);
