...
public class FluidNitrogen extends BlockFluidClassic implements IFluidBlock {
	public FluidNitrogen(String assetName) {
		super(ExtraPlanets_Fluids.nitrogen_fluid, ExtraPlanets_Fluids.nitrogen_material);
