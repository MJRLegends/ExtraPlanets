...
public class FluidLiquidCaramel extends FluidBasic {
	public FluidLiquidCaramel(String name) {
		super(ExtraPlanets_Fluids.liquid_caramel_fluid);
		setRenderPass(1);
		setBlockName(name);
	}
	...
	public String getStillTextures() {
		return Constants.TEXTURE_PREFIX + "fluids/" + "liquid_caramel_still";
	}

	@Override
	public String getFlowingTextures() {
		return Constants.TEXTURE_PREFIX + "fluids/" + "liquid_caramel_flow";
	}
}
