...
public class FluidRadioActiveWater extends FluidBasic {
	public FluidRadioActiveWater(String name) {
		super(ExtraPlanets_Fluids.radio_active_water_fluid);
		setRenderPass(1);
		setBlockName(name);
	}
	...
	public String getStillTextures() {
		return Constants.TEXTURE_PREFIX + "fluids/" + "radioactive_water_still";
	}

	@Override
	public String getFlowingTextures() {
		return Constants.TEXTURE_PREFIX + "fluids/" + "radioactive_water_flow";
	}
}
