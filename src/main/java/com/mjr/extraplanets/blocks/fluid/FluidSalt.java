...
public class FluidSalt extends BlockFluidClassic implements IFluidBlock
{
    public FluidSalt(String assetName)
    {
        super(ExtraPlanets_Fluids.salt_fluid, ExtraPlanets_Fluids.salt_material);
