...
public class BasicCrystallizer extends BlockAdvancedTile implements IShiftDescription, ISortableBlock {
	...
	public void randomDisplayTick(World worldIn, BlockPos pos, IBlockState state, Random rand) {
		...
		if (te instanceof TileEntityBasicCrystallizer) {
			final TileEntityBasicCrystallizer crystallizer = (TileEntityBasicCrystallizer) te;
	...
	public TileEntity createTileEntity(World world, IBlockState state) {
		return new TileEntityBasicCrystallizer();
	}

	@Override
	public void breakBlock(World worldIn, BlockPos pos, IBlockState state) {
		final TileEntityBasicCrystallizer var7 = (TileEntityBasicCrystallizer) worldIn.getTileEntity(pos);
