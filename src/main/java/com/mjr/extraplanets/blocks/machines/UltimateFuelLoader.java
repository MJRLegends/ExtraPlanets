...
public class UltimateFuelLoader extends BlockAdvancedTile {
	...
	public void registerBlockIcons(IIconRegister par1IconRegister) {
		...
		this.iconFront = par1IconRegister.registerIcon(Constants.TEXTURE_PREFIX + "machine_ultimate_fuelloader");
		this.iconFuelInput = par1IconRegister.registerIcon(GalacticraftCore.TEXTURE_PREFIX + "machine_fuel_input");
	}

	@Override
	public TileEntity createTileEntity(World world, int metadata) {
		return new TileEntityUltimateFuelLoader();
	}
