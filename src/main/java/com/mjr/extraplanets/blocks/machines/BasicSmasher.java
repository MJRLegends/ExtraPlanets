...
public class BasicSmasher extends BlockAdvancedTile implements IShiftDescription, ISortableBlock {
	...
	public void randomDisplayTick(World worldIn, BlockPos pos, IBlockState state, Random rand) {
		...
		if (te instanceof TileEntityBasicSmasher) {
			final TileEntityBasicSmasher crystallizer = (TileEntityBasicSmasher) te;
	...
	public TileEntity createTileEntity(World world, IBlockState state) {
		return new TileEntityBasicSmasher();
	}

	@Override
	public void breakBlock(World worldIn, BlockPos pos, IBlockState state) {
		final TileEntityBasicSmasher var7 = (TileEntityBasicSmasher) worldIn.getTileEntity(pos);
