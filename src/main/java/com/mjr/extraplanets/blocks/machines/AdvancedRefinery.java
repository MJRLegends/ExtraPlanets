...
public class AdvancedRefinery extends BlockAdvancedTile implements ItemBlockDesc.IBlockShiftDesc {
	...
	public AdvancedRefinery(String assetName) {
		...
		this.setBlockTextureName(GalacticraftCore.TEXTURE_PREFIX + "refinery");
	...
	public void breakBlock(World par1World, int par2, int par3, int par4, Block par5, int par6) {
		final TileEntityAdvancedRefinery var7 = (TileEntityAdvancedRefinery) par1World.getTileEntity(par2, par3, par4);
