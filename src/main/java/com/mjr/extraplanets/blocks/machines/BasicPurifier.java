...
public class BasicPurifier extends BlockAdvancedTile implements IShiftDescription, ISortableBlock {
	private final Random crystallizerRand = new Random();

	public static final PropertyDirection FACING = PropertyDirection.create("facing", EnumFacing.Plane.HORIZONTAL);

	public BasicPurifier(String name) {
		super(Material.ROCK);
	...
	public void randomDisplayTick(IBlockState stateIn, World world, BlockPos pos, Random rand) {
		...
		if (te instanceof TileEntityBasicPurifier) {
			final TileEntityBasicPurifier crystallizer = (TileEntityBasicPurifier) te;
	...
	public TileEntity createTileEntity(World world, IBlockState state) {
		return new TileEntityBasicPurifier();
	}

	@Override
	public void breakBlock(World world, BlockPos pos, IBlockState state) {
		final TileEntityBasicPurifier var7 = (TileEntityBasicPurifier) world.getTileEntity(pos);
