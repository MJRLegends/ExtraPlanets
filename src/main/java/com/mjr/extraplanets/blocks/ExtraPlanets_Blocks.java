...
public class ExtraPlanets_Blocks {
	...
	public static Block MERCURY_DUNGEON_BRICKS_STAIRS;
	...
	public static Block JUPITER_DUNGEON_BRICKS_STAIRS;
	...
	public static Block SATURN_DUNGEON_BRICKS_STAIRS;
	...
	public static Block URANUS_DUNGEON_BRICKS_STAIRS;
	...
	public static Block NEPTUNE_DUNGEON_BRICKS_STAIRS;
	...
	public static Block PLUTO_DUNGEON_BRICKS_STAIRS;
...
//		MERCURY_DUNGEON_BRICKS_STAIRS = new BlockBasicStairs("mercury_stairs_dungeon_bricks", MERCURY_BLOCKS.getDefaultState().withProperty(BlockBasicMercury.BASIC_TYPE, BlockBasicMercury.EnumBlockBasic.DUNGEON_BRICK)).setHardness(2.0F);
//		
...
//		JUPITER_DUNGEON_BRICKS_STAIRS = new BlockBasicStairs("jupiter_stairs_dungeon_bricks", JUPITER_BLOCKS.getDefaultState().withProperty(BlockBasicJupiter.BASIC_TYPE, BlockBasicJupiter.EnumBlockBasic.DUNGEON_BRICK)).setHardness(2.0F);
//		
...
//		SATURN_DUNGEON_BRICKS_STAIRS = new BlockBasicStairs("saturn_stairs_dungeon_bricks", SATURN_BLOCKS.getDefaultState().withProperty(BlockBasicSaturn.BASIC_TYPE, BlockBasicSaturn.EnumBlockBasic.DUNGEON_BRICK)).setHardness(2.0F);
//		
...
//		URANUS_DUNGEON_BRICKS_STAIRS = new BlockBasicStairs("uranus_stairs_dungeon_bricks", URANUS_BLOCKS.getDefaultState().withProperty(BlockBasicUranus.BASIC_TYPE, BlockBasicUranus.EnumBlockBasic.DUNGEON_BRICK)).setHardness(2.0F);
//		
...
//		NEPTUNE_DUNGEON_BRICKS_STAIRS = new BlockBasicStairs("neptune_stairs_dungeon_bricks", NEPTUNE_BLOCKS.getDefaultState().withProperty(BlockBasicNeptune.BASIC_TYPE, BlockBasicNeptune.EnumBlockBasic.DUNGEON_BRICK)).setHardness(2.0F);
//		
...
//		PLUTO_DUNGEON_BRICKS_STAIRS = new BlockBasicStairs("pluto_stairs_dungeon_bricks", PLUTO_BLOCKS.getDefaultState().withProperty(BlockBasicPluto.BASIC_TYPE, BlockBasicPluto.EnumBlockBasic.DUNGEON_BRICK)).setHardness(2.0F);
	}
...
//		RegisterHelper.registerBlock(MERCURY_DUNGEON_BRICKS_STAIRS, ItemBlockGC.class, MERCURY_DUNGEON_BRICKS_STAIRS.getUnlocalizedName().substring(5));
//		
...
//		RegisterHelper.registerBlock(JUPITER_DUNGEON_BRICKS_STAIRS, ItemBlockGC.class, JUPITER_DUNGEON_BRICKS_STAIRS.getUnlocalizedName().substring(5));
//		
...
//		RegisterHelper.registerBlock(SATURN_DUNGEON_BRICKS_STAIRS, ItemBlockGC.class, SATURN_DUNGEON_BRICKS_STAIRS.getUnlocalizedName().substring(5));
//		
...
//		RegisterHelper.registerBlock(URANUS_DUNGEON_BRICKS_STAIRS, ItemBlockGC.class, URANUS_DUNGEON_BRICKS_STAIRS.getUnlocalizedName().substring(5));
//		
...
//		RegisterHelper.registerBlock(NEPTUNE_DUNGEON_BRICKS_STAIRS, ItemBlockGC.class, NEPTUNE_DUNGEON_BRICKS_STAIRS.getUnlocalizedName().substring(5));
//		
...
//		RegisterHelper.registerBlock(PLUTO_DUNGEON_BRICKS_STAIRS, ItemBlockGC.class, PLUTO_DUNGEON_BRICKS_STAIRS.getUnlocalizedName().substring(5));
	}
