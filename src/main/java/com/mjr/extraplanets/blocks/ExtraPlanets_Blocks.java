...
public class ExtraPlanets_Blocks {
	...
	private static void registerBlocks() throws NoSuchMethodException {
		...
		RegisterUtilities.registerBlock(DIAMOND_GRIT, DIAMOND_GRIT.getUnlocalizedName().substring(5));
		RegisterUtilities.registerBlock(GOLD_GRIT, GOLD_GRIT.getUnlocalizedName().substring(5));
		RegisterUtilities.registerBlock(COAL_GRIT, COAL_GRIT.getUnlocalizedName().substring(5));
		RegisterUtilities.registerBlock(IRON_GRIT, IRON_GRIT.getUnlocalizedName().substring(5));
		RegisterUtilities.registerBlock(EMERALD_GRIT, EMERALD_GRIT.getUnlocalizedName().substring(5));
	}
