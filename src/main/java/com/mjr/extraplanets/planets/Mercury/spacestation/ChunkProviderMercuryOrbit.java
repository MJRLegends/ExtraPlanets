...
public class ChunkProviderMercuryOrbit extends ChunkProviderGenerate {
	private final Random rand;

	private final World worldObj;

	public ChunkProviderMercuryOrbit(World par1World, long par2, boolean par4) {
	...
	public String makeString() {
		return "MercuryOrbitLevelSource";
	}
