...
public class RoomTreasureMercuryBase extends SizedPieceMercury
{
    ...
    public RoomTreasureMercuryBase(DungeonConfiguration configuration, Random rand, int blockPosX, int blockPosZ, EnumFacing entranceDir)
    {
        this(configuration, rand, blockPosX, blockPosZ, rand.nextInt(4) + 6, configuration.getRoomHeight(), rand.nextInt(4) + 6, entranceDir);
    }

    public RoomTreasureMercuryBase(DungeonConfiguration configuration, Random rand, int blockPosX, int blockPosZ, int sizeX, int sizeY, int sizeZ, EnumFacing entranceDir)
    {
    ...
    public PieceMercury getNextPiece(DungeonStartMercury startPiece, Random rand)
    {
        if (startPiece.attachedComponents.size() > 2)
        {
            ...
            if (component instanceof RoomBossMercury)
            {
                ...
                ((RoomBossMercury) component).setChestPos(new BlockPos(blockpos));
            }
        }
        return null;
    }
