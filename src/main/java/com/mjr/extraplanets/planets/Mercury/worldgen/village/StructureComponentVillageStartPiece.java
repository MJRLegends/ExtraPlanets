...
public class StructureComponentVillageStartPiece extends StructureComponentVillageWell {
	...
	public StructureComponentVillageStartPiece(WorldChunkManager biomeProvider, int par2, Random par3Random, int par4, int par5, ArrayList<StructureVillagePieceWeightMercury> par6ArrayList, int par7) {
