...
public class StructureVillageStartMercury extends StructureStart {
	...
	public StructureVillageStartMercury(World par1World, Random rand, int par3, int par4, int par5) {
		super(par3, par4);

		final ArrayList<StructureVillagePieceWeightMercury> var6 = StructureVillagePiecesMercury.getStructureVillageWeightedPieceList(rand, par5);
		final StructureComponentVillageStartPiece var7 = new StructureComponentVillageStartPiece(par1World.getBiomeProvider(), 0, rand, (par3 << 4) + 2, (par4 << 4) + 2, var6, par5);
