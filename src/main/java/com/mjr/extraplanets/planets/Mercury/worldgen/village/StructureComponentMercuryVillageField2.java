...
public class StructureComponentMercuryVillageField2 extends StructureComponentMercuryVillage {
    ...
    public StructureComponentMercuryVillageField2() {
    }

    public StructureComponentMercuryVillageField2(StructureComponentMercuryVillageStartPiece par1ComponentVillageStartPiece, int par2, Random par3Random, StructureBoundingBox par4StructureBoundingBox, int par5) {
    ...
    public static StructureComponentMercuryVillageField2 func_74900_a(StructureComponentMercuryVillageStartPiece par0ComponentVillageStartPiece, List par1List, Random par2Random, int par3, int par4, int par5, int par6, int par7) {
	...
	return StructureComponentMercuryVillage.canVillageGoDeeper(structureboundingbox) && StructureComponent.findIntersecting(par1List, structureboundingbox) == null ? new StructureComponentMercuryVillageField2(par0ComponentVillageStartPiece, par7, par2Random, structureboundingbox, par6) : null;
    }
