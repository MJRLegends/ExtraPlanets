...
public class WorldProviderMercuryOrbit extends WorldProviderSpace implements IOrbitDimension, ISolarLevel, IExitHeight
{
	public int spaceStationDimensionID;

	private static final float GFORCE = 9.81F / 400F; //gravity in metres per tick squared

	private OrbitSpinSaveDataMercury savefile;
	...
	{
		return ExtraPlanets_SpaceStations.mercurySpaceStation;
	}
	...
	{
		return ChunkProviderMercuryOrbit.class;
	}
	...
	public void updateWeather()
	{
		...
		if (!this.worldObj.isRemote)
		{
			...
			{
				this.savefile = OrbitSpinSaveDataMercury.initWorldData(this.worldObj);
	...
	public void updateSpinSpeed()
	{
		if (this.momentOfInertia > 0F)
		{
			...
			else
			{
				...
				this.angularVelocityTarget = MathHelper.sqrt_float(WorldProviderMercuryOrbit.GFORCE / maxR) / 2;
