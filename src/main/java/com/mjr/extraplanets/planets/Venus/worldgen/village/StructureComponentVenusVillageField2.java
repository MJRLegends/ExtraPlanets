...
public class StructureComponentVenusVillageField2 extends StructureComponentVenusVillage {
    ...
    public StructureComponentVenusVillageField2() {
    }

    public StructureComponentVenusVillageField2(StructureComponentVenusVillageStartPiece par1ComponentVillageStartPiece, int par2, Random par3Random, StructureBoundingBox par4StructureBoundingBox, int par5) {
    ...
    public static StructureComponentVenusVillageField2 func_74900_a(StructureComponentVenusVillageStartPiece par0ComponentVillageStartPiece, List par1List, Random par2Random, int par3, int par4, int par5, int par6, int par7) {
	...
	return StructureComponentVenusVillage.canVillageGoDeeper(structureboundingbox) && StructureComponent.findIntersecting(par1List, structureboundingbox) == null ? new StructureComponentVenusVillageField2(par0ComponentVillageStartPiece, par7, par2Random, structureboundingbox, par6) : null;
    }
