...
{
	private Block grassblock = ExtraPlanets_Blocks.venusBlocks;
	private Block dirtblock = ExtraPlanets_Blocks.venusBlocks;
	private Block stoneblock = ExtraPlanets_Blocks.venusBlocks;
