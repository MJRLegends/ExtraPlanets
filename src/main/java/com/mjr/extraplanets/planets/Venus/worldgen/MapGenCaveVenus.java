...
{
	private Block grassblock = ExtraPlanetsBlocks.venusSurface;
	private Block dirtblock = ExtraPlanetsBlocks.venusSubSurface;
	private Block stoneblock = ExtraPlanetsBlocks.venusStone;
