...
public class StructureVillagePiecesVenus {
	...
	private static StructureComponentVenusVillage func_75083_a(StructureComponentVenusVillageStartPiece par0ComponentVillageStartPiece, StructureVillagePieceWeightVenus par1StructureVillagePieceWeight, List<StructureComponent> par2List, Random par3Random, int par4, int par5, int par6, int par7, int par8) {
