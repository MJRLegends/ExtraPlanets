...
public class WorldProviderVenusOrbit extends WorldProviderSpace implements IOrbitDimension, ISolarLevel, IExitHeight
{
	public int spaceStationDimensionID;

	private static final float GFORCE = 9.81F / 400F; //gravity in metres per tick squared

	private OrbitSpinSaveDataVenus savefile;
	...
	{
		return PlanetsMain.venusSpaceStation;
	}
	...
	public void updateWeather()
	{
		...
		if (!this.worldObj.isRemote)
		{
			...
			{
				this.savefile = OrbitSpinSaveDataVenus.initWorldData(this.worldObj);
	...
	public void updateSpinSpeed()
	{
		if (this.momentOfInertia > 0F)
		{
			...
			else
			{
				...
				this.angularVelocityTarget = MathHelper.sqrt_float(WorldProviderVenusOrbit.GFORCE / maxR) / 2;
