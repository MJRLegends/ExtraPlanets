...
public class StructureComponentCeresVillageField2 extends StructureComponentCeresVillage {
	...
	public static StructureComponentCeresVillageField2 func_74900_a(StructureComponentCeresVillageStartPiece par0ComponentVillageStartPiece, List par1List, Random par2Random, int par3, int par4, int par5, int par6, int par7) {
		...
		return StructureComponentCeresVillage.canVillageGoDeeper(structureboundingbox) && StructureComponent.findIntersecting(par1List, structureboundingbox) == null
				? new StructureComponentCeresVillageField2(par0ComponentVillageStartPiece, par7, par2Random, structureboundingbox, par6)
				: null;
	}
