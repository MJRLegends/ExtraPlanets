...
{
	private Block grassblock = ExtraPlanets_Blocks.ceresBlocks;
	private Block dirtblock = ExtraPlanets_Blocks.ceresBlocks;
	private Block stoneblock = ExtraPlanets_Blocks.ceresBlocks;
