...
public class StructureVillagePiecesCeres {
			...
			while (var9 < 5) {
				...
				while (var11.hasNext()) {
					...
					if (var10 < 0) {
						...
						final StructureComponentVillage var13 = StructureVillagePiecesCeres.func_75083_a(par0ComponentVillageStartPiece, var12, par1List, rand, par3, par4, par5, par6, par7);
	...
	private static StructureComponent getNextVillageStructureComponent(StructureComponentVillageStartPiece par0ComponentVillageStartPiece, List<StructureComponent> par1List, Random rand, int par3, int par4, int par5, EnumFacing par6, int par7) {
		if (par7 > 50) {
			...
			final StructureComponentVillage var8 = StructureVillagePiecesCeres.getNextVillageComponent(par0ComponentVillageStartPiece, par1List, rand, par3, par4, par5, par6, par7 + 1);
	...
	static StructureComponent getNextStructureComponent(StructureComponentVillageStartPiece par0ComponentVillageStartPiece, List<StructureComponent> par1List, Random rand, int par3, int par4, int par5, EnumFacing par6, int par7) {
		return StructureVillagePiecesCeres.getNextVillageStructureComponent(par0ComponentVillageStartPiece, par1List, rand, par3, par4, par5, par6, par7);
	}
	...
	static StructureComponent getNextStructureComponentVillagePath(StructureComponentVillageStartPiece par0ComponentVillageStartPiece, List<StructureComponent> par1List, Random rand, int par3, int par4, int par5, EnumFacing par6, int par7) {
		return StructureVillagePiecesCeres.getNextComponentVillagePath(par0ComponentVillageStartPiece, par1List, rand, par3, par4, par5, par6, par7);
	}
}
