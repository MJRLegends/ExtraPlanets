...
public class StructureVillageStartCeres extends StructureStart {
	...
	public StructureVillageStartCeres(World par1World, Random rand, int par3, int par4, int par5) {
		super(par3, par4);

		final ArrayList<StructureVillagePieceWeightCeres> var6 = StructureVillagePiecesCeres.getStructureVillageWeightedPieceList(rand, par5);
