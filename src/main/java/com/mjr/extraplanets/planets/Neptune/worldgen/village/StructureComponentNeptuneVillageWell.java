...
public class StructureComponentNeptuneVillageWell extends StructureComponentNeptuneVillage {
	...
	public boolean addComponentParts(World par1World, Random par2Random, StructureBoundingBox par3StructureBoundingBox) {
		...
		this.fillWithMetadataBlocks(par1World, par3StructureBoundingBox, 1, 0, 1, 4, 12, 4, ExtraPlanetsBlocks.neptuneBlocks, 2, Blocks.flowing_water, 0, false);
		...
		this.fillWithMetadataBlocks(par1World, par3StructureBoundingBox, 1, 15, 1, 4, 15, 4, ExtraPlanetsBlocks.neptuneBlocks, 2, ExtraPlanetsBlocks.neptuneBlocks, 2, false);
