...
public class RoomChestsNeptune extends DungeonRoom
{
	int sizeX;
	int sizeY;
	int sizeZ;
	...
	public RoomChestsNeptune(MapGenDungeon dungeon, int posX, int posY, int posZ, ForgeDirection entranceDir)
	{
	...
	{
		return new RoomChestsNeptune(dungeon, x, y, z, dir);
	}
