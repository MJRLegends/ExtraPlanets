...
public class GenLayerNeptuneBiomes extends GenLayer {
	private static final BiomeGenBase[] biomes = new BiomeGenBase[] { NeptuneBiomes.neptune, NeptuneBiomes.neptuneRadioActiveWaterSea, NeptuneBiomes.neptuneLayeredHills };
