...
public class StructureVillageStartNeptune extends StructureStart {
	...
	final StructureComponentNeptuneVillageStartPiece var7 = new StructureComponentNeptuneVillageStartPiece(par1World.getWorldChunkManager(), 0, par2Random, (par3 << 4) + 2, (par4 << 4) + 2, var6, par5);
	...
	while (var13.hasNext()) {
	    ...
	    if (!(var12 instanceof StructureComponentNeptuneVillageRoadPiece)) {
		++var10;
	    }
	}
    }
