...
public class StructureComponentNeptuneVillageField2 extends StructureComponentNeptuneVillage {
	...
	public StructureComponentNeptuneVillageField2() {
	}

	public StructureComponentNeptuneVillageField2(StructureComponentNeptuneVillageStartPiece par1ComponentVillageStartPiece, int par2, Random par3Random, StructureBoundingBox par4StructureBoundingBox, int par5) {
	...
	public static StructureComponentNeptuneVillageField2 func_74900_a(StructureComponentNeptuneVillageStartPiece par0ComponentVillageStartPiece, List par1List, Random par2Random, int par3, int par4, int par5, int par6, int par7) {
		...
		return StructureComponentNeptuneVillage.canVillageGoDeeper(structureboundingbox) && StructureComponent.findIntersecting(par1List, structureboundingbox) == null ? new StructureComponentNeptuneVillageField2(par0ComponentVillageStartPiece, par7, par2Random, structureboundingbox, par6) : null;
	}
