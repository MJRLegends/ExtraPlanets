...
public class WorldProviderNeptuneOrbit extends WorldProviderSpace implements IOrbitDimension, ISolarLevel, IExitHeight
{
	public int spaceStationDimensionID;

	private static final float GFORCE = 9.81F / 400F; //gravity in metres per tick squared

	private OrbitSpinSaveDataNeptune savefile;
	...
	{
		return PlanetsMain.neptuneSpaceStation;
	}
	...
	{
		return ChunkProviderNeptuneOrbit.class;
	}
	...
	public void updateWeather()
	{
		...
		if (!this.worldObj.isRemote)
		{
			...
			{
				this.savefile = OrbitSpinSaveDataNeptune.initWorldData(this.worldObj);
	...
	public void updateSpinSpeed()
	{
		if (this.momentOfInertia > 0F)
		{
			...
			else
			{
				...
				this.angularVelocityTarget = MathHelper.sqrt_float(WorldProviderNeptuneOrbit.GFORCE / maxR) / 2;
