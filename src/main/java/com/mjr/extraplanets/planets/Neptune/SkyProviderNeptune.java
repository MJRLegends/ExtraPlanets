...
public class SkyProviderNeptune extends IRenderHandler {
	private static final ResourceLocation overworldTexture = new ResourceLocation(Constants.ASSET_PREFIX,
			"textures/gui/celestialbodies/pluto.png");
	private static final ResourceLocation overworldTexture2 = new ResourceLocation(GalacticraftCore.ASSET_PREFIX,
