...
public class NeptuneBiomes extends Biome {
	...
	public static final Biome neptune = new BiomeGenNeptune(new BiomeProperties("neptune").setBaseHeight(2.5F).setHeightVariation(0.4F).setRainfall(0.0F).setRainDisabled());

	NeptuneBiomes(BiomeProperties properties) {
		super(properties);
