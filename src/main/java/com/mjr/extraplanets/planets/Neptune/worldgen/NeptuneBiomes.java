...
public class NeptuneBiomes extends BiomeGenBase {
	...
	public static final BiomeGenBase neptuneRadioActiveWaterSea = new BiomeGenNeptuneRadioActiveWaterSea(Config.NEPTUNE_RADIO_ACTIVE_WATER_SEA_ID).setBiomeName("neptuneRadioActiveWaterSea").setHeight(new Height(-1.0F, 0.0F));
	...
	public final void generateNeptuneBiomeTerrain(Random rand, ChunkPrimer chunk, int x, int z, double stoneNoise) {
