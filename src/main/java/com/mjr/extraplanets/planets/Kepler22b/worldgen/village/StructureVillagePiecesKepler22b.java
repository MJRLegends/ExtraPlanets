...
public class StructureVillagePiecesKepler22b {
	...
	private static StructureComponentKepler22bVillage func_75083_a(StructureComponentKepler22bVillageStartPiece par0ComponentVillageStartPiece, StructureVillagePieceWeightKepler22b par1StructureVillagePieceWeight, List<StructureComponent> par2List, Random par3Random, int par4, int par5, int par6, int par7, int par8) {
	...
	private static StructureComponentKepler22bVillage getNextVillageComponent(StructureComponentKepler22bVillageStartPiece par0ComponentVillageStartPiece, List<StructureComponent> par1List, Random par2Random, int par3, int par4, int par5, int par6, int par7) {
