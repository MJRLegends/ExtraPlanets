...
public class SkyProviderKepler22b extends IRenderHandler {
	private static final ResourceLocation sunTexture = new ResourceLocation(Constants.ASSET_PREFIX, "textures/gui/planets/sun.png");
	...
	public SkyProviderKepler22b(IGalacticraftWorldProvider ceresProvider) {
