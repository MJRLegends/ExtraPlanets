...
public class BiomeGenKepler22bCoalPlains extends Kepler22bBiomes {
	...
	public BiomeGenKepler22bCoalPlains() {
		super(Config.kepler22bCoalPlainsBiomeID);
		this.enableRain = true;
		this.enableSnow = true;
		this.setTemperatureRainfall(0.8F, 0.9F);
		this.topBlock = ExtraPlanets_Blocks.coalGrit;
		this.topMeta = 0;
		this.fillerBlock = ExtraPlanets_Blocks.coalGrit;
		this.fillerMeta = 0;
