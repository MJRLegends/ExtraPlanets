...
public class StructureComponentKepler22bVillageTorch extends StructureComponentKepler22bVillage {
	private int averageGroundLevel = -1;

	public StructureComponentKepler22bVillageTorch() {
	}

	public StructureComponentKepler22bVillageTorch(StructureComponentKepler22bVillageStartPiece par1ComponentVillageStartPiece, int par2, Random par3Random, StructureBoundingBox par4StructureBoundingBox, int par5) {
	...
	public static StructureBoundingBox func_74904_a(StructureComponentKepler22bVillageStartPiece par0ComponentVillageStartPiece, List par1List, Random par2Random, int par3, int par4, int par5, int par6) {
