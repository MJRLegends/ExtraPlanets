...
public class BiomeGenBaseKepler22b extends BiomeGenBase {
	public static BiomeGenBase kepler22bPlains = new BiomeGenKepler22bPlains().setBiomeName("Kepler22b Plains").setEnableSnow().setTemperatureRainfall(0.8F, 0.9F).setHeight(new Height(0.1F, 0.2F));
