...
public class BiomeGenKepler22bDiamondPlains extends Kepler22bBiomes {
	...
	public BiomeGenKepler22bDiamondPlains() {
		super(Config.kepler22bDiamondPlainsBiomeID);
		this.enableRain = true;
		this.enableSnow = true;
		this.setTemperatureRainfall(0.8F, 0.9F);
		this.topBlock = ExtraPlanets_Blocks.diamondGrit;
		this.topMeta = 0;
		this.fillerBlock = ExtraPlanets_Blocks.diamondGrit;
		this.fillerMeta = 0;
