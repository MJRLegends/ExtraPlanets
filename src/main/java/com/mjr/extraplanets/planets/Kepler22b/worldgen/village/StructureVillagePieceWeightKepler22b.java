...
public class StructureVillagePieceWeightKepler22b {
	public Class<? extends StructureComponentKepler22bVillage> villagePieceClass;
	public final int villagePieceWeight;
	public int villagePiecesSpawned;
	public int villagePiecesLimit;

	public StructureVillagePieceWeightKepler22b(Class<? extends StructureComponentKepler22bVillage> par1Class, int par2, int par3) {
