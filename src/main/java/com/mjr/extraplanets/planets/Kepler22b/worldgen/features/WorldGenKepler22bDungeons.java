					...
					for (int k4 = l1; k4 <= i2; ++k4) {
						...
						if (k3 != k && i4 != -1 && k4 != l1 && k3 != l && i4 != 4 && k4 != i2) {
							...
							if (i4 == -1 && rand.nextInt(4) != 0) {
								world.setBlockState(blockpos1, ExtraPlanets_Blocks.KEPLER22B_BLOCKS.getDefaultState().withProperty(BlockBasicKepler22b.BASIC_TYPE, BlockBasicKepler22b.EnumBlockBasic.STONEBRICKS), 2);
							} else {
								world.setBlockState(blockpos1, ExtraPlanets_Blocks.KEPLER22B_BLOCKS.getDefaultState().withProperty(BlockBasicKepler22b.BASIC_TYPE, BlockBasicKepler22b.EnumBlockBasic.COBBLESTONE), 2);
							}
						}
					}
				}
