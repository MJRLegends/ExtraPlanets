...
public class ChunkProviderKepler22b extends ChunkProviderGenerate {
	...
	//private MapGenCaveKepler22b caveGenerator; TODO
	//public BiomeDecoratorKepler22b biomedecoratorplanet = new BiomeDecoratorKepler22b(); TODO
	//private MapGenVillageKepler22b villageGenerator = new MapGenVillageKepler22b(); TODO
	...
	public Chunk provideChunk(int x, int z) {
		...
		//this.caveGenerator.generate(this, this.worldObj, x, z, blockStorage, metaStorage); TODO
	...
	public void populate(IChunkProvider chunk, int x, int z) {
		...
		//this.villageGenerator.generateStructuresInChunk(this.worldObj, this.rand, x, z); TODO
		BlockFalling.fallInstantly = false;
	}

	public void decoratePlanet(World world, Random rand, int x, int z) {
		//this.biomedecoratorplanet.decorate(world, rand, x, z); TODO
	}
	...
	public void recreateStructures(int x, int z) {
		//this.villageGenerator.func_151539_a(this, this.worldObj, x, z, (Block[]) null); TODO
	}
