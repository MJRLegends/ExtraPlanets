...
public class ChunkProviderKepler22bOrbit extends ChunkProviderGenerate
{
	private final Random rand;

	private final World worldObj;

	public ChunkProviderKepler22bOrbit(World par1World, long par2, boolean par4)
	{
	...
	{
		return "Kepler22bOrbitLevelSource";
	}
