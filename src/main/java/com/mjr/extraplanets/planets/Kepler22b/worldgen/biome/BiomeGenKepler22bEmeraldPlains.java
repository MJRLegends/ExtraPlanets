...
public class BiomeGenKepler22bEmeraldPlains extends Kepler22bBiomes {
	...
	public BiomeGenKepler22bEmeraldPlains() {
		super(Config.kepler22bEmeraldPlainsBiomeID);
		this.enableRain = true;
		this.enableSnow = true;
		this.setTemperatureRainfall(0.8F, 0.9F);
		this.topBlock = ExtraPlanets_Blocks.emeraldGrit;
		this.topMeta = 0;
		this.fillerBlock = ExtraPlanets_Blocks.emeraldGrit;
		this.fillerMeta = 0;
