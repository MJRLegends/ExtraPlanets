                                ...
                                for (int localZ = l2; localZ < i3; localZ++)
                                {
                                    ...
                                    if (xfactorSq + zfactorSq < 1.0D)
                                    {
                                        ...
                                        if (yfactor > -0.7D && xfactorSq + yfactorSq + zfactorSq < 1.0D)
                                        {
                                            ...
                                            if (block == ExtraPlanets_Blocks.kepler22bBlueGrass || block == ExtraPlanets_Blocks.kepler22bPurpleGrass || block == ExtraPlanets_Blocks.kepler22bRedGrass || block == ExtraPlanets_Blocks.kepler22bYellowGrass)
                                            {
