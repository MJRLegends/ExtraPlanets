								...
								for (int localZ = l2; localZ < i3; localZ++) {
									...
									if (xfactorSq + zfactorSq < 1.0D) {
										...
										if (yfactor > -0.7D && xfactorSq + yfactorSq + zfactorSq < 1.0D) {
											...
											} else if ((blockIdArray[coords] == grassblock1) || (blockIdArray[coords] == grassblock2) || (blockIdArray[coords] == grassblock3) || (blockIdArray[coords] == grassblock4)
													|| (blockIdArray[coords] == grassblock5) && (metaArray[coords] == 0) && (random.nextInt(BREAK_THROUGH_CHANCE) == 0)) {
												blockIdArray[coords] = Blocks.air;
											}
										}
									}
