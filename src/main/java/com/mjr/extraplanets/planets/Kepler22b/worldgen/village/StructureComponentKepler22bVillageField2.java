...
public class StructureComponentKepler22bVillageField2 extends StructureComponentKepler22bVillage {
	...
	public StructureComponentKepler22bVillageField2() {
	}

	public StructureComponentKepler22bVillageField2(StructureComponentKepler22bVillageStartPiece par1ComponentVillageStartPiece, int par2, Random par3Random, StructureBoundingBox par4StructureBoundingBox, int par5) {
	...
	public static StructureComponentKepler22bVillageField2 func_74900_a(StructureComponentKepler22bVillageStartPiece par0ComponentVillageStartPiece, List par1List, Random par2Random, int par3, int par4, int par5, int par6, int par7) {
		...
		return StructureComponentKepler22bVillage.canVillageGoDeeper(structureboundingbox) && StructureComponent.findIntersecting(par1List, structureboundingbox) == null ? new StructureComponentKepler22bVillageField2(par0ComponentVillageStartPiece, par7, par2Random, structureboundingbox, par6) : null;
	}
