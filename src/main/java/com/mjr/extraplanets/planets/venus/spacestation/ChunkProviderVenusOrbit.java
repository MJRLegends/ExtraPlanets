...
public class ChunkProviderVenusOrbit extends ChunkProviderGenerate
{
    private final Random rand;

    private final World worldObj;

    public ChunkProviderVenusOrbit(World par1World, long par2, boolean par4)
    {
