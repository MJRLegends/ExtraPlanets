...
public class StructureComponentVillageWell extends StructureComponentVillage {
	...
	public boolean addComponentParts(World par1World, Random par2Random, StructureBoundingBox par3StructureBoundingBox) {
		...
		this.fillWithBlocks(par1World, par3StructureBoundingBox, 1, 0, 1, 4, 12, 4, ExtraPlanets_Blocks.SATURN_BLOCKS.getStateFromMeta(0), Blocks.flowing_water.getDefaultState(), false);
		...
		this.fillWithBlocks(par1World, par3StructureBoundingBox, 1, 15, 1, 4, 15, 4, ExtraPlanets_Blocks.SATURN_BLOCKS.getStateFromMeta(0), ExtraPlanets_Blocks.SATURN_BLOCKS.getStateFromMeta(0), false);
