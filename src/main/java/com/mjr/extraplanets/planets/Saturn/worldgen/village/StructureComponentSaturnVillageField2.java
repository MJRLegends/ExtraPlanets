...
public class StructureComponentSaturnVillageField2 extends StructureComponentSaturnVillage {
	...
	public static StructureComponentSaturnVillageField2 func_74900_a(StructureComponentSaturnVillageStartPiece par0ComponentVillageStartPiece, List par1List, Random par2Random, int par3, int par4, int par5, int par6, int par7) {
		...
		return StructureComponentSaturnVillage.canVillageGoDeeper(structureboundingbox) && StructureComponent.findIntersecting(par1List, structureboundingbox) == null ? new StructureComponentSaturnVillageField2(par0ComponentVillageStartPiece, par7,
