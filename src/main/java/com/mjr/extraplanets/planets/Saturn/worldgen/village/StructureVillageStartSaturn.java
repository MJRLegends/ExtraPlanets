...
public class StructureVillageStartSaturn extends StructureStart {
	...
	public StructureVillageStartSaturn(World par1World, Random rand, int par3, int par4, int par5) {
		super(par3, par4);

		final ArrayList<StructureVillagePieceWeightSaturn> var6 = StructureVillagePiecesSaturn.getStructureVillageWeightedPieceList(rand, par5);
