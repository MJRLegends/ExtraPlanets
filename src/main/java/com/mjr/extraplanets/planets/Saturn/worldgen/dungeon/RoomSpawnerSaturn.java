...
public class RoomSpawnerSaturn extends DungeonRoom
{
    ...
    public RoomSpawnerSaturn(MapGenDungeon dungeon, int posX, int posY, int posZ, ForgeDirection entranceDir)
    {
    ...
    {
	return new RoomSpawnerSaturn(dungeon, x, y, z, dir);
    }
	...
	for (final ChunkCoordinates spawnerCoords : this.spawners)
	{
		...
		if (spawner != null)
		{
		    spawner.func_145881_a().setEntityName(RoomSpawnerSaturn.getMob(rand));
		}
	    }
	}
    }
