...
{
	private Block grassblock = ExtraPlanets_Blocks.saturnBlocks;
	private Block dirtblock = ExtraPlanets_Blocks.saturnBlocks;
	private Block stoneblock = ExtraPlanets_Blocks.saturnBlocks;
