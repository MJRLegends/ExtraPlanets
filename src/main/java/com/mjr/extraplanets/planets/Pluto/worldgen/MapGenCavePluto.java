...
public class MapGenCavePluto extends MapGenBaseMeta {
	private Block grassblock = ExtraPlanets_Blocks.plutoBlocks;
	private Block dirtblock = ExtraPlanets_Blocks.plutoBlocks;
	private Block stoneblock = ExtraPlanets_Blocks.plutoBlocks;
