...
public class SkyProviderPluto extends IRenderHandler {
	private static final ResourceLocation overworldTexture = new ResourceLocation(Constants.ASSET_PREFIX, "textures/gui/celestialbodies/eris.png");
	private static final ResourceLocation overworldTexture2 = new ResourceLocation(micdoodle8.mods.galacticraft.core.Constants.ASSET_PREFIX, "textures/gui/celestialbodies/neptune.png");
	...
	public void render(float partialTicks, WorldClient world, Minecraft mc) {
		...
		GL11.glRotatef(200F, 1.0F, 0.0F, 0.0F);
		GL11.glColor4f(1.0F, 1.0F, 1.0F, 1F);
		FMLClientHandler.instance().getClient().renderEngine.bindTexture(SkyProviderPluto.overworldTexture);
		worldRenderer1.begin(GL11.GL_QUADS, DefaultVertexFormats.POSITION_TEX);
		worldRenderer1.pos(-f10, -100.0D, f10).tex(0, 1).endVertex();
		worldRenderer1.pos(f10, -100.0D, f10).tex(1, 1).endVertex();
		worldRenderer1.pos(f10, -100.0D, -f10).tex(1, 0).endVertex();
