...
public class StructureComponentPlutoVillageField2 extends StructureComponentPlutoVillage {
	...
	public static StructureComponentPlutoVillageField2 func_74900_a(StructureComponentPlutoVillageStartPiece par0ComponentVillageStartPiece, List par1List, Random par2Random, int par3, int par4, int par5, int par6, int par7) {
		...
		return StructureComponentPlutoVillage.canVillageGoDeeper(structureboundingbox) && StructureComponent.findIntersecting(par1List, structureboundingbox) == null
				? new StructureComponentPlutoVillageField2(par0ComponentVillageStartPiece, par7, par2Random, structureboundingbox, par6)
				: null;
	}
