...
public class StructureVillagePiecesPluto
{
    public static ArrayList<StructureVillagePieceWeightPluto> getStructureVillageWeightedPieceList(Random par0Random, int par1)
    {
        ...
        var2.add(new StructureVillagePieceWeightPluto(StructureComponentVillageWoodHut.class, 5, MathHelper.getInt(par0Random, 2 + par1, 5 + par1 * 3)));
        var2.add(new StructureVillagePieceWeightPluto(StructureComponentVillageField.class, 5, MathHelper.getInt(par0Random, 3 + par1, 5 + par1)));
        var2.add(new StructureVillagePieceWeightPluto(StructureComponentVillageField2.class, 5, MathHelper.getInt(par0Random, 3 + par1, 5 + par1)));
        var2.add(new StructureVillagePieceWeightPluto(StructureComponentVillageHouse.class, 5, MathHelper.getInt(par0Random, 3 + par1, 4 + par1 * 2)));
