...
public class StructureVillageStartPluto extends StructureStart {
	...
	final ArrayList<StructureVillagePieceWeightPluto> var6 = StructureVillagePiecesPluto.getStructureVillageWeightedPieceList(par2Random, par5);
	final StructureComponentPlutoVillageStartPiece var7 = new StructureComponentPlutoVillageStartPiece(par1World.getWorldChunkManager(), 0, par2Random, (par3 << 4) + 2, (par4 << 4) + 2, var6, par5);
	...
	while (var13.hasNext()) {
	    ...
	    if (!(var12 instanceof StructureComponentPlutoVillageRoadPiece)) {
		++var10;
	    }
	}
    }
