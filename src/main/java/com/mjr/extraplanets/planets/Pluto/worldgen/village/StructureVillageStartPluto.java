...
public class StructureVillageStartPluto extends StructureStart {
	public StructureVillageStartPluto() {
	}

	public StructureVillageStartPluto(World par1World, Random rand, int par3, int par4, int par5) {
		super(par3, par4);

		final ArrayList<StructureVillagePieceWeightPluto> var6 = StructureVillagePiecesPluto.getStructureVillageWeightedPieceList(rand, par5);
