...
public class RoomSpawnerUranus extends DungeonRoom
{
    int sizeX;
    int sizeY;
    int sizeZ;
    ...
    public RoomSpawnerUranus(MapGenDungeon dungeon, int posX, int posY, int posZ, ForgeDirection entranceDir)
    {
    ...
    {
	return new RoomSpawnerUranus(dungeon, x, y, z, dir);
    }
	...
	for (final ChunkCoordinates spawnerCoords : this.spawners)
	{
		...
		if (spawner != null)
		{
		    spawner.func_145881_a().setEntityName(RoomSpawnerUranus.getMob(rand));
		}
	    }
	}
    }
