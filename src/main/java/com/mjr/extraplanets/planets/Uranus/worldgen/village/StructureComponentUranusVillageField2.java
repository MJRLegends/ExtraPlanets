...
public class StructureComponentUranusVillageField2 extends StructureComponentUranusVillage {
	...
	public static StructureComponentUranusVillageField2 func_74900_a(StructureComponentUranusVillageStartPiece par0ComponentVillageStartPiece, List par1List, Random par2Random, int par3, int par4, int par5, int par6, int par7) {
		...
		return StructureComponentUranusVillage.canVillageGoDeeper(structureboundingbox) && StructureComponent.findIntersecting(par1List, structureboundingbox) == null ? new StructureComponentUranusVillageField2(par0ComponentVillageStartPiece, par7,
