...
public class WorldProviderUranusOrbit extends WorldProviderSpace implements IOrbitDimension, ISolarLevel, IExitHeight
{
	public int spaceStationDimensionID;

	private static final float GFORCE = 9.81F / 400F; //gravity in metres per tick squared

	private OrbitSpinSaveDataUranus savefile;
	...
	{
		return PlanetsMain.uranusSpaceStation;
	}
	...
	{
		return ChunkProviderUranusOrbit.class;
	}
	...
	public void updateWeather()
	{
		...
		if (!this.worldObj.isRemote)
		{
			...
			{
				this.savefile = OrbitSpinSaveDataUranus.initWorldData(this.worldObj);
	...
	public void updateSpinSpeed()
	{
		if (this.momentOfInertia > 0F)
		{
			...
			else
			{
				...
				this.angularVelocityTarget = MathHelper.sqrt_float(WorldProviderUranusOrbit.GFORCE / maxR) / 2;
