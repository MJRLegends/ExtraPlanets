...
public class RoomChestsUranus extends DungeonRoom
{
	int sizeX;
	int sizeY;
	int sizeZ;
	...
	public RoomChestsUranus(MapGenDungeon dungeon, int posX, int posY, int posZ, ForgeDirection entranceDir)
	{
	...
	{
		return new RoomChestsUranus(dungeon, x, y, z, dir);
	}
