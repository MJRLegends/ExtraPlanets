...
public class RoomTreasureUranus extends DungeonRoom
{
	...
	public void generate(Block[] chunk, byte[] meta, int cx, int cz)
	{
		...
		if (this.placeBlock(chunk, meta, hx, this.posY, hz, cx, cz, ExtraPlanetsBlocks.treasureChestTier7, 0))
		{
	...
	protected void handleTileEntities(Random rand)
	{
		if (!this.chests.isEmpty())
		{
			...
			{
				this.worldObj.setBlock(coords.posX, coords.posY, coords.posZ, ExtraPlanetsBlocks.treasureChestTier7, 0, 3);
