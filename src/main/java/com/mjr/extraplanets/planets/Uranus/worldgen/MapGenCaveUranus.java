...
{
    private Block grassblock = ExtraPlanetsBlocks.uranusSurface;
    private Block dirtblock = ExtraPlanetsBlocks.uranusSubSurface;
    private Block stoneblock = ExtraPlanetsBlocks.uranusStone;
