...
public class MapGenCaveUranus extends MapGenBaseMeta
{
	private Block grassblock = ExtraPlanets_Blocks.uranusBlocks;
	private Block dirtblock = ExtraPlanets_Blocks.uranusBlocks;
	private Block stoneblock = ExtraPlanets_Blocks.uranusBlocks;
