...
public class RoomEmptyUranus extends DungeonRoom {
	int sizeX;
	int sizeY;
	int sizeZ;

	public RoomEmptyUranus(MapGenDungeon dungeon, int posX, int posY, int posZ, ForgeDirection entranceDir) {
	...
	protected DungeonRoom makeRoom(MapGenDungeon dungeon, int x, int y, int z, ForgeDirection dir) {
		return new RoomEmptyUranus(dungeon, x, y, z, dir);
	}
