...
public class StructureVillageStartUranus extends StructureStart {
	public StructureVillageStartUranus() {
	}

	public StructureVillageStartUranus(World par1World, Random rand, int par3, int par4, int par5) {
		super(par3, par4);

		final ArrayList<StructureVillagePieceWeightUranus> var6 = StructureVillagePiecesUranus.getStructureVillageWeightedPieceList(rand, par5);
