...
public class StructureVillageStartUranus extends StructureStart {
	...
	public StructureVillageStartUranus(World par1World, Random par2Random, int par3, int par4, int par5) {
		...
		final ArrayList<StructureVillagePieceWeightUranus> var6 = StructureVillagePiecesUranus.getStructureVillageWeightedPieceList(par2Random, par5);
		final StructureComponentUranusVillageStartPiece var7 = new StructureComponentUranusVillageStartPiece(par1World.getWorldChunkManager(), 0, par2Random, (par3 << 4) + 2, (par4 << 4) + 2, var6, par5);
		...
		while (var13.hasNext()) {
			...
			if (!(var12 instanceof StructureComponentUranusVillageRoadPiece)) {
				++var10;
			}
		}
	}
