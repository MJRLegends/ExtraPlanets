...
public class UranusBiomes extends BiomeGenBase {
	public static BiomeGenBase uranus = new BiomeGenUranus(Config.uranusBiomeID).setBiomeName("Uranus").setHeight(BiomeGenBase.height_LowPlains);
	public static BiomeGenBase uranusFrozenSea = new BiomeGenUranusFrozenSea(Config.uranusFrozenSeaBiomeID).setBiomeName("UranusFrozenSea").setHeight(BiomeGenBase.height_Oceans);
	public static BiomeGenBase uranusSnowLands = new BiomeGenUranusSnowLands(Config.uranusSnowLandsBiomeID).setBiomeName("UranusSnowLands").setHeight(new Height(0.825F, 0.25F));
	...
	public BiomeDecorator createBiomeDecorator() {
		return new BiomeDecoratorUranus();
	}
					...
					if (currentBlock == Blocks.stone) {
						...
						if (currentFillerDepth == -1) {
							if (maxFillerDepth <= 0) {
								topBlock = null;
								topMeta = 0;
								fillerBlock = ExtraPlanets_Blocks.uranusBlocks;
								fillerMeta = 1;
