...
public class UranusBiomes extends BiomeGenBaseGC {
	...
	public static final Biome uranusFrozenWaterSea = new BiomeGenUranusFrozenWaterSea(new BiomeProperties("Uranus Frozen Water").setBaseHeight(-1.0F).setHeightVariation(0.0F).setRainfall(0.0F).setRainDisabled());
