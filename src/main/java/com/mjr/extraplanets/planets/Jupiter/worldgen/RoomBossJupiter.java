...
public class RoomBossJupiter extends RoomBoss {
	...
	public RoomBossJupiter(DungeonConfiguration configuration, Random rand, int blockPosX, int blockPosZ, int sizeX, int sizeY, int sizeZ, EnumFacing entranceDir) {
	...
	public boolean addComponentParts(World worldIn, Random random, StructureBoundingBox boundingBox) {
		...
		this.setBlockState(worldIn, ExtraPlanets_Blocks.JUIPTER_SPAWNER.getDefaultState(), spawnerX, spawnerY, spawnerZ, boundingBox);
		...
		if (spawner == null) {
			spawner = new TileEntityDungeonSpawnerJupiter();
