...
public class StructureVillageStartJupiter extends StructureStart {
	...
	final ArrayList<StructureVillagePieceWeightJupiter> var6 = StructureVillagePiecesJupiter.getStructureVillageWeightedPieceList(par2Random, par5);
	final StructureComponentJupiterVillageStartPiece var7 = new StructureComponentJupiterVillageStartPiece(par1World.getWorldChunkManager(), 0, par2Random, (par3 << 4) + 2, (par4 << 4) + 2, var6, par5);
	...
	while (var13.hasNext()) {
	    ...
	    if (!(var12 instanceof StructureComponentJupiterVillageRoadPiece)) {
		++var10;
	    }
	}
    }
