...
{
	private Block grassblock = ExtraPlanets_Blocks.jupiterBlocks;
	private Block dirtblock = ExtraPlanets_Blocks.jupiterBlocks;
	private Block stoneblock = ExtraPlanets_Blocks.jupiterBlocks;
