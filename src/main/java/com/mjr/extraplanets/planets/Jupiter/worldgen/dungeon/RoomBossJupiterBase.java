...
public class RoomBossJupiterBase extends SizedPieceJupiter
{
    ...
    public RoomBossJupiterBase()
    {
    }

    public RoomBossJupiterBase(DungeonConfiguration configuration, Random rand, int blockPosX, int blockPosZ, EnumFacing entranceDir)
    {
