...
public class RoomEmptyJupiter extends DungeonRoom
{
    int sizeX;
    int sizeY;
    int sizeZ;

    public RoomEmptyJupiter(MapGenDungeon dungeon, int posX, int posY, int posZ, ForgeDirection entranceDir)
    {
    ...
    {
	return new RoomEmptyJupiter(dungeon, x, y, z, dir);
    }
