...
public class StructureComponentJupiterVillageWell extends StructureComponentJupiterVillage {
	private int averageGroundLevel = -1;

	public StructureComponentJupiterVillageWell() {
	}

	public StructureComponentJupiterVillageWell(StructureComponentJupiterVillageStartPiece par1ComponentVillageStartPiece, int par2, Random par3Random, int par4, int par5) {
	...
	public void buildComponent(StructureComponent par1StructureComponent, List par2List, Random par3Random) {
		StructureVillagePiecesJupiter.getNextStructureComponentVillagePath((StructureComponentJupiterVillageStartPiece) par1StructureComponent, par2List, par3Random, this.boundingBox.minX - 1, this.boundingBox.maxY - 4, this.boundingBox.minZ + 1, 1, this.getComponentType());
		StructureVillagePiecesJupiter.getNextStructureComponentVillagePath((StructureComponentJupiterVillageStartPiece) par1StructureComponent, par2List, par3Random, this.boundingBox.maxX + 1, this.boundingBox.maxY - 4, this.boundingBox.minZ + 1, 3, this.getComponentType());
		StructureVillagePiecesJupiter.getNextStructureComponentVillagePath((StructureComponentJupiterVillageStartPiece) par1StructureComponent, par2List, par3Random, this.boundingBox.minX + 1, this.boundingBox.maxY - 4, this.boundingBox.minZ - 1, 2, this.getComponentType());
		StructureVillagePiecesJupiter.getNextStructureComponentVillagePath((StructureComponentJupiterVillageStartPiece) par1StructureComponent, par2List, par3Random, this.boundingBox.minX + 1, this.boundingBox.maxY - 4, this.boundingBox.maxZ + 1, 0, this.getComponentType());
	}
	...
	public boolean addComponentParts(World par1World, Random par2Random, StructureBoundingBox par3StructureBoundingBox) {
		...
		this.fillWithMetadataBlocks(par1World, par3StructureBoundingBox, 1, 0, 1, 4, 12, 4, ExtraPlanets_Blocks.jupiterBlocks, 2, Blocks.flowing_water, 0, false);
		...
		this.fillWithMetadataBlocks(par1World, par3StructureBoundingBox, 1, 15, 1, 4, 15, 4, ExtraPlanets_Blocks.jupiterBlocks, 2, ExtraPlanets_Blocks.jupiterBlocks, 2, false);
