...
public class RoomBossJupiter extends DungeonRoom {
	public int sizeX;
	public int sizeY;
	public int sizeZ;
	Random rand;
	...
	public RoomBossJupiter(MapGenDungeon dungeon, int posX, int posY, int posZ, ForgeDirection entranceDir) {
	...
	protected DungeonRoom makeRoom(MapGenDungeon dungeon, int x, int y, int z, ForgeDirection dir) {
		return new RoomBossJupiter(dungeon, x, y, z, dir);
	}
	...
	protected void handleTileEntities(Random rand) {
		...
		if (tile == null || !(tile instanceof TileEntityDungeonSpawnerJupiter)) {
			TileEntityDungeonSpawnerJupiter spawner = new TileEntityDungeonSpawnerJupiter();
