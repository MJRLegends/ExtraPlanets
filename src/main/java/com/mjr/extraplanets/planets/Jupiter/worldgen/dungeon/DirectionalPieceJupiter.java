...
public abstract class DirectionalPieceJupiter extends PieceJupiter
{
    ...
    public DirectionalPieceJupiter(DungeonConfiguration configuration, EnumFacing direction)
    {
        super(configuration);
    ...
    public PieceJupiter getCorridor(Random rand, DungeonStartJupiter startPiece, int maxAttempts, boolean small)
    {
        ...
        return new CorridorJupiter(this.configuration, rand, blockX, blockZ, sizeX, small ? 3 : this.configuration.getHallwayHeight(), sizeZ, randomDir);
    }
}
