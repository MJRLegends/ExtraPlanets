...
public class WorldProviderJupiterOrbit extends WorldProviderSpace implements IOrbitDimension, ISolarLevel, IExitHeight
{
    public int spaceStationDimensionID;

    private static final float GFORCE = 9.81F / 400F; //gravity in metres per tick squared

    private OrbitSpinSaveDataJupiter savefile;
    ...
    {
        return PlanetsMain.jupiterSpaceStation;
    }
    ...
    public void updateWeather()
    {
        ...
        if (!this.worldObj.isRemote)
        {
            ...
            {
                this.savefile = OrbitSpinSaveDataJupiter.initWorldData(this.worldObj);
