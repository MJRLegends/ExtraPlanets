...
public class SkyProviderJupiter extends IRenderHandler {
	...
	private static final ResourceLocation overworldTexture2 = new ResourceLocation(Constants.ASSET_PREFIX, "textures/gui/celestialbodies/saturn.png");
	private static final ResourceLocation overworldTexture3 = new ResourceLocation(Constants.ASSET_PREFIX, "textures/gui/celestialbodies/io.png");
	private static final ResourceLocation overworldTexture4 = new ResourceLocation(Constants.ASSET_PREFIX, "textures/gui/celestialbodies/europa.png");
	private static final ResourceLocation overworldTexture5 = new ResourceLocation(Constants.ASSET_PREFIX, "textures/gui/celestialbodies/ganymede.png");
	private static final ResourceLocation overworldTexture6 = new ResourceLocation(Constants.ASSET_PREFIX, "textures/gui/celestialbodies/callisto.png");
	...
	public SkyProviderJupiter(IGalacticraftWorldProvider marsProvider) {
	...
	public void render(float partialTicks, WorldClient world, Minecraft mc) {
		...
		f10 = this.sunSize;
		mc.renderEngine.bindTexture(SkyProviderJupiter.sunTexture);
	...
	public float getSkyBrightness(float par1) {
		...
		float var3 = 1.0F - (MathHelper.sin(var2 * com.mjr.extraplanets.Constants.floatPI * 2.0F) * 2.0F + 0.25F);
