...
public class StructureComponentJupiterVillageField2 extends StructureComponentJupiterVillage {
	...
	public static StructureComponentJupiterVillageField2 func_74900_a(StructureComponentJupiterVillageStartPiece par0ComponentVillageStartPiece, List par1List, Random par2Random, int par3, int par4, int par5, int par6, int par7) {
		...
		return StructureComponentJupiterVillage.canVillageGoDeeper(structureboundingbox) && StructureComponent.findIntersecting(par1List, structureboundingbox) == null
				? new StructureComponentJupiterVillageField2(par0ComponentVillageStartPiece, par7, par2Random, structureboundingbox, par6)
				: null;
	}
