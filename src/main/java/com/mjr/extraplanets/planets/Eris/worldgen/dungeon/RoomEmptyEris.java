...
public class RoomEmptyEris extends DungeonRoom {
	int sizeX;
	int sizeY;
	int sizeZ;

	public RoomEmptyEris(MapGenDungeon dungeon, int posX, int posY, int posZ, ForgeDirection entranceDir) {
	...
	protected DungeonRoom makeRoom(MapGenDungeon dungeon, int x, int y, int z, ForgeDirection dir) {
		return new RoomEmptyEris(dungeon, x, y, z, dir);
	}
