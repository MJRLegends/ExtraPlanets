...
public class RoomTreasureEris extends DungeonRoom
{
	...
	public RoomTreasureEris(MapGenDungeon dungeon, int posX, int posY, int posZ, ForgeDirection entranceDir)
	{
	...
	{
		return new RoomTreasureEris(dungeon, x, y, z, dir);
	}
	...
	protected void handleTileEntities(Random rand)
	{
		if (!this.chests.isEmpty())
		{
			...
			{
				this.worldObj.setBlock(coords.posX, coords.posY, coords.posZ, ExtraPlanets_Blocks.treasureChestTier10, 0, 3);
				this.worldObj.setTileEntity(coords.posX, coords.posY, coords.posZ, new TileEntityT10TreasureChest(10));
