...
public class MapGenCaveEris extends MapGenBaseMeta
{
	private Block grassblock = ExtraPlanets_Blocks.erisBlocks;
	private Block dirtblock = ExtraPlanets_Blocks.erisBlocks;
	private Block stoneblock = ExtraPlanets_Blocks.erisBlocks;
