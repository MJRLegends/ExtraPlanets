...
public class StructureVillageStartEris extends StructureStart {
	...
	public StructureVillageStartEris(World par1World, Random rand, int par3, int par4, int par5) {
		super(par3, par4);

		final ArrayList<StructureVillagePieceWeightEris> var6 = StructureVillagePiecesEris.getStructureVillageWeightedPieceList(rand, par5);
