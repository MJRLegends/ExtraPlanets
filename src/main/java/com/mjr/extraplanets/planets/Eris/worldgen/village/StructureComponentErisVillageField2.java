...
public class StructureComponentErisVillageField2 extends StructureComponentErisVillage {
	...
	public static StructureComponentErisVillageField2 func_74900_a(StructureComponentErisVillageStartPiece par0ComponentVillageStartPiece, List par1List, Random par2Random, int par3, int par4, int par5, int par6, int par7) {
		...
		return StructureComponentErisVillage.canVillageGoDeeper(structureboundingbox) && StructureComponent.findIntersecting(par1List, structureboundingbox) == null
				? new StructureComponentErisVillageField2(par0ComponentVillageStartPiece, par7, par2Random, structureboundingbox, par6)
				: null;
	}
