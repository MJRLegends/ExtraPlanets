...
public class Constants {
	...
	public static final String DEPENDENCIES_MODS = "required-after:mjrlegendslib@[1.8.9-1.1.3,); required-after:GalacticraftCore@[4.0.1.184,); required-after:GalacticraftPlanets@[4.0.1.184,); before:planetprogression@[1.8.9-0.2.7,];";
