...
public class Constants {
	...
	public static final String DEPENDENCIES_MODS = "required-after:mjrlegendslib@[1.11.2-1.1.5,); required-after:galacticraftcore@[4.0.1.178,); required-after:galacticraftplanets@[4.0.1.178,); after:planetprogression@[1.11.2-0.3.7,];";
