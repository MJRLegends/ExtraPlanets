...
public class Constants {
	...
	public static final String DEPENDENCIES_MODS = "required-after:mjrlegendslib@[1.12.2-1.0.3,); required-after:galacticraftcore; required-after:galacticraftplanets;";
