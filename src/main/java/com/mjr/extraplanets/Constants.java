...
public class Constants {
	...
	public static final String DEPENDENCIES_MODS = "required-after:mjrlegendslib@[1.10.2-1.0.8,); required-after:galacticraftcore@[4.0.1.152,); required-after:galacticraftplanets@[4.0.1.152,);";
