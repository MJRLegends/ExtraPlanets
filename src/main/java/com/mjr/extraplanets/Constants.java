...
public class Constants {
	...
	public static final String DEPENDENCIES_MODS = "required-after:mjrlegendslib@[1.10.2-1.1.3,); required-after:galacticraftcore@[4.0.1.178,); required-after:galacticraftplanets@[4.0.1.178,);";
