...
public class Constants {
	...
	public static final String DEPENDENCIES_MODS = "required-after:mjrlegendslib@[1.10.2-1.0.7,); required-after:galacticraftcore@[4.0.1.139,); required-after:galacticraftplanets@[4.0.1.139,);";
