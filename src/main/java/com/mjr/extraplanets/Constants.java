...
public class Constants {
	...
	public static final String DEPENDENCIES_MODS = "required-after:mjrlegendslib@[1.11.2-1.0.8,); required-after:galacticraftcore@[4.0.1.174,); required-after:galacticraftplanets@[4.0.1.174,);";
