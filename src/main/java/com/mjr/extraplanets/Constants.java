...
public class Constants {
	...
	public static final String DEPENDENCIES_MODS = "required-after:mjrlegendslib@[1.12.2-1.1.8,); required-after:galacticraftcore@[4.0.2.211,); required-after:galacticraftplanets@[4.0.2.211,); after:crafttweaker@[3.0.25.,); before:planetprogression@[1.12.2-0.3.8,];";
