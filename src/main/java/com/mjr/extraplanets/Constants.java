...
public class Constants {
	...
	public static final String DEPENDENCIES_MODS = "required-after:mjrlegendslib@[1.8.9-1.0.9,); required-after:GalacticraftCore@[4.0.1.178,); required-after:GalacticraftPlanets@[4.0.1.178,);";
