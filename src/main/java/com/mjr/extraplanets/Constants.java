...
public class Constants {
	...
	public static final String DEPENDENCIES_MODS = "required-after:mjrlegendslib@[1.11.2-1.1.6,); required-after:galacticraftcore@[4.0.1.184,); required-after:galacticraftplanets@[4.0.1.184,); before:planetprogression@[1.11.2-0.3.7,];";
