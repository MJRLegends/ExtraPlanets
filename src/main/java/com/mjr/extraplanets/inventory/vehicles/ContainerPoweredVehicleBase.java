...
public class ContainerPoweredVehicleBase extends Container {
	private final IInventory lowerChestInventory;
	private final IInventory spaceshipInv;

	public ContainerPoweredVehicleBase(IInventory par1IInventory, IInventory par2IInventory, int type, EntityPlayer player) {
