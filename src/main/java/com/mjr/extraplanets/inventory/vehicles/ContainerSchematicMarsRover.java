...
public class ContainerSchematicMarsRover extends Container {
	...
	public ContainerSchematicMarsRover(InventoryPlayer par1InventoryPlayer, int x, int y, int z) {
		final int change = 27;
		...
		for (var6 = 0; var6 < 5; ++var6) {
			for (var7 = 0; var7 < 3; ++var7) {
				this.addSlotToContainer(new SlotMarsRover(this.craftMatrix, var7 * 5 + var6 + 1, 39 + var7 * 18, 6 + var6 * 18 + change, x, y, z, par1InventoryPlayer.player));
			}
		}
