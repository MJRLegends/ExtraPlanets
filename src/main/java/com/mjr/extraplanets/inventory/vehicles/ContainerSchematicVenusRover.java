...
public class ContainerSchematicVenusRover extends Container {
	...
	public ContainerSchematicVenusRover(InventoryPlayer inventoryPlayer, BlockPos pos) {
		final int change = 27;
		...
		for (var6 = 0; var6 < 5; ++var6) {
			for (var7 = 0; var7 < 3; ++var7) {
				this.addSlotToContainer(new SlotVenusRover(this.craftMatrix, var7 * 5 + var6 + 1, 39 + var7 * 18, 6 + var6 * 18 + change, pos, inventoryPlayer.player));
			}
		}

		for (var6 = 0; var6 < 3; ++var6) {
			for (var7 = 0; var7 < 2; ++var7) {
				this.addSlotToContainer(new SlotVenusRover(this.craftMatrix, var7 * 3 + var6 + 16, 21 + var7 * 72, 6 + var6 * 36 + change, pos, inventoryPlayer.player));
			}
		}

		// Addons
		for (int var8 = 0; var8 < 3; var8++) {
			this.addSlotToContainer(new SlotVenusRover(this.craftMatrix, 22 + var8, 93 + var8 * 26, -15 + change, pos, inventoryPlayer.player));
		}
