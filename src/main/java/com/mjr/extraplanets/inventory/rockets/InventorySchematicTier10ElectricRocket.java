...
public class InventorySchematicTier10ElectricRocket implements IInventoryDefaults {
	public NonNullList<ItemStack> stacks;
	private final Container eventHandler;

	public InventorySchematicTier10ElectricRocket(Container par1Container) {
