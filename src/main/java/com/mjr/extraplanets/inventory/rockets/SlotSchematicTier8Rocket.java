...
public class SlotSchematicTier8Rocket extends Slot
{
	...
	public boolean isItemValid(ItemStack par1ItemStack)
	{
		...
		{
		case 1:
			return par1ItemStack.getItem() == ExtraPlanets_Items.noseConeTier8;
		case 2:
			return par1ItemStack.getItem() == ExtraPlanets_Items.tier8Items && par1ItemStack.getItemDamage() == 3;
		case 3:
			return par1ItemStack.getItem() == ExtraPlanets_Items.tier8Items && par1ItemStack.getItemDamage() == 3;
		case 4:
			return par1ItemStack.getItem() == ExtraPlanets_Items.tier8Items && par1ItemStack.getItemDamage() == 3;
		...
		case 11:
			return par1ItemStack.getItem() == ExtraPlanets_Items.tier8Items && par1ItemStack.getItemDamage() == 3;
		case 12:
			return par1ItemStack.getItem() == ExtraPlanets_Items.tier8Items && par1ItemStack.getItemDamage() == 1;
		case 13:
			return par1ItemStack.getItem() == ExtraPlanets_Items.tier8Items && par1ItemStack.getItemDamage() == 2;
		case 14:
			return par1ItemStack.getItem() == ExtraPlanets_Items.tier8Items && par1ItemStack.getItemDamage() == 2;
		case 15:
			return par1ItemStack.getItem() == ExtraPlanets_Items.tier8Items && par1ItemStack.getItemDamage() == 0;
		case 16:
			return par1ItemStack.getItem() == ExtraPlanets_Items.tier8Items && par1ItemStack.getItemDamage() == 1;
		case 17:
			return par1ItemStack.getItem() == ExtraPlanets_Items.tier8Items && par1ItemStack.getItemDamage() == 2;
