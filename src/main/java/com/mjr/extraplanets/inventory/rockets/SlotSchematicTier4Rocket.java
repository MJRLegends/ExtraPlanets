...
public class SlotSchematicTier4Rocket extends Slot {
	...
	public boolean isItemValid(ItemStack par1ItemStack) {
		switch (this.index) {
		case 1:
			return par1ItemStack.getItem() == ExtraPlanets_Items.TIER_4_NOSE_CONE;
		case 2:
		...
		case 11:
			return par1ItemStack.getItem() == ExtraPlanets_Items.TIER_4_ITEMS && par1ItemStack.getItemDamage() == 3;
		case 12:
			return par1ItemStack.getItem() == ExtraPlanets_Items.TIER_4_ITEMS && par1ItemStack.getItemDamage() == 1;
		case 13:
			return par1ItemStack.getItem() == ExtraPlanets_Items.TIER_4_ITEMS && par1ItemStack.getItemDamage() == 2;
		case 14:
			return par1ItemStack.getItem() == ExtraPlanets_Items.TIER_4_ITEMS && par1ItemStack.getItemDamage() == 2;
		case 15:
			return par1ItemStack.getItem() == ExtraPlanets_Items.TIER_4_ITEMS && par1ItemStack.getItemDamage() == 0;
		case 16:
			return par1ItemStack.getItem() == ExtraPlanets_Items.TIER_4_ITEMS && par1ItemStack.getItemDamage() == 1;
		case 17:
			return par1ItemStack.getItem() == ExtraPlanets_Items.TIER_4_ITEMS && par1ItemStack.getItemDamage() == 2;
