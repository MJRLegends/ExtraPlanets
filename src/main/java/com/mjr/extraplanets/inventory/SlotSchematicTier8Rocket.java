...
public class SlotSchematicTier8Rocket extends Slot
{
	...
	{
	case 1:
	    return par1ItemStack.getItem() == ExtraPlanetsItems.noseConeTier8;
	case 2:
	    return par1ItemStack.getItem() == ExtraPlanetsItems.heavyDutyPlateTier8 && par1ItemStack.getItemDamage() == 0;
	case 3:
	    return par1ItemStack.getItem() == ExtraPlanetsItems.heavyDutyPlateTier8 && par1ItemStack.getItemDamage() == 0;
	case 4:
	    return par1ItemStack.getItem() == ExtraPlanetsItems.heavyDutyPlateTier8 && par1ItemStack.getItemDamage() == 0;
	...
	case 11:
	    return par1ItemStack.getItem() == ExtraPlanetsItems.heavyDutyPlateTier8 && par1ItemStack.getItemDamage() == 0;
	case 12:
	    return par1ItemStack.getItem() == ExtraPlanetsItems.engineTier8 && par1ItemStack.getItemDamage() == 1;
	case 13:
	    return par1ItemStack.getItem() == ExtraPlanetsItems.finTier8 && par1ItemStack.getItemDamage() == 0;
	case 14:
	    return par1ItemStack.getItem() == ExtraPlanetsItems.finTier8 && par1ItemStack.getItemDamage() == 0;
	case 15:
	    return par1ItemStack.getItem() == ExtraPlanetsItems.engineTier8 && par1ItemStack.getItemDamage() == 0;
	case 16:
	    return par1ItemStack.getItem() == ExtraPlanetsItems.engineTier8 && par1ItemStack.getItemDamage() == 1;
	case 17:
	    return par1ItemStack.getItem() == ExtraPlanetsItems.finTier8 && par1ItemStack.getItemDamage() == 0;
