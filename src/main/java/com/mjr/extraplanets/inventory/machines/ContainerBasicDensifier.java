...
public class ContainerBasicDensifier extends Container {
	private final TileEntityBasicDensifier tileEntity;

	public ContainerBasicDensifier(InventoryPlayer par1InventoryPlayer, TileEntityBasicDensifier tileEntity, EntityPlayer player) {
