...
public class ContainerAdvancedFuelLoader extends Container
{
    private TileBaseElectricBlock tileEntity;

    public ContainerAdvancedFuelLoader(InventoryPlayer par1InventoryPlayer, TileEntityAdvancedFuelLoader fuelLoader)
    {
