...
public class TileEntityAdvancedOxygenDecompressor extends TileEntityOxygen implements IInventoryDefaults, ISidedInventory {
	...
	public ForgeDirection getElectricInputDirection() {
		return ForgeDirection.getOrientation(this.getBlockMetadata() - AdvancedOxygenCompressor.OXYGEN_DECOMPRESSOR_METADATA + 2);
	}
	...
	public float getOxygenProvide(ForgeDirection direction) {
		return this.getOxygenOutputDirections().contains(direction) ? Math.min(TileEntityAdvancedOxygenDecompressor.OUTPUT_PER_TICK, this.getOxygenStored()) : 0.0F;
	}
}