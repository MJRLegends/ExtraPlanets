...
public class TileEntityUltimateOxygenDecompressor extends TileEntityOxygen implements IInventoryDefaults, ISidedInventory {
	...
	public String getInventoryName() {
		return GCCoreUtil.translate("container.ultimate.oxygendecompressor.name");
	}
	...
	public ForgeDirection getElectricInputDirection() {
		return ForgeDirection.getOrientation(this.getBlockMetadata() - UltimateOxygenCompressor.OXYGEN_DECOMPRESSOR_METADATA + 2);
	}
	...
	public float getOxygenProvide(ForgeDirection direction) {
		return this.getOxygenOutputDirections().contains(direction) ? Math.min(TileEntityUltimateOxygenDecompressor.OUTPUT_PER_TICK, this.getOxygenStored()) : 0.0F;
	}
}