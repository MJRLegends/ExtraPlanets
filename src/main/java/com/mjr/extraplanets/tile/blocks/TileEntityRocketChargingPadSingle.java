	...
	public void update() {
		if (!this.world.isRemote) {
			...
			if (attachedLaunchPads.size() == 25) {
				...
				this.world.setBlockState(this.getPos(), ExtraPlanets_Blocks.ADVANCED_LAUCHPAD_FULL.getStateFromMeta(BlockCustomLandingPadFull.EnumLandingPadFullType.ROCKET_POWER_CHARGING_PAD.getMeta()), 2);
			}
		}
	}
