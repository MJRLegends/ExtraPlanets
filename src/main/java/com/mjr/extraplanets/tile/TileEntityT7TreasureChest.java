...
public class TileEntityT7TreasureChest extends TileEntityAdvanced implements IInventory, IKeyable, IPacketReceiver
{
    ...
    private void func_90009_a(TileEntityT7TreasureChest par1TileEntityChest, int par2)
    {
	...
	if (!this.adjacentChestChecked)
	{
	    ...
	    {
		this.adjacentChestXNeg = (TileEntityT7TreasureChest) this.worldObj.getTileEntity(this.xCoord - 1, this.yCoord, this.zCoord);
	    }

	    if (this.func_94044_a(this.xCoord + 1, this.yCoord, this.zCoord))
	    {
		this.adjacentChestXPos = (TileEntityT7TreasureChest) this.worldObj.getTileEntity(this.xCoord + 1, this.yCoord, this.zCoord);
	    }

	    if (this.func_94044_a(this.xCoord, this.yCoord, this.zCoord - 1))
	    {
		this.adjacentChestZNeg = (TileEntityT7TreasureChest) this.worldObj.getTileEntity(this.xCoord, this.yCoord, this.zCoord - 1);
	    }

	    if (this.func_94044_a(this.xCoord, this.yCoord, this.zCoord + 1))
	    {
		this.adjacentChestZPos = (TileEntityT7TreasureChest) this.worldObj.getTileEntity(this.xCoord, this.yCoord, this.zCoord + 1);
	    }
	...
	return block != null && block instanceof T7TreasureChest;
    }
    ...
    {
	if (this.getBlockType() != null && this.getBlockType() instanceof T7TreasureChest)
	{
	    --this.numUsingPlayers;
	    this.worldObj.addBlockEvent(this.xCoord, this.yCoord, this.zCoord, this.getBlockType(), 1, this.numUsingPlayers);
	    this.worldObj.notifyBlocksOfNeighborChange(this.xCoord, this.yCoord, this.zCoord, this.getBlockType());
